...
/* loaded from: jfxrt.jar:javafx/animation/FillTransition.class */
public final class FillTransition extends Transition {
    ...
    public final ObjectProperty<Duration> durationProperty() {
        if (this.duration == null) {
            this.duration = new ObjectPropertyBase<Duration>(DEFAULT_DURATION) { // from class: javafx.animation.FillTransition.1
                ...
                public void invalidated() {
                    try {
                        ...
                        set(FillTransition.this.getCycleDuration());
                        throw e2;
                    }
                }
    ...
    boolean impl_startable(boolean forceSync) {
        ...
        return shape != null && (getFromValue() != null || (shape.getFill() instanceof Color)) && getToValue() != null;
    }
