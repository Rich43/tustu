...
@Deprecated
/* loaded from: jfxrt.jar:javafx/animation/FillTransitionBuilder.class */
public final class FillTransitionBuilder extends TransitionBuilder<FillTransitionBuilder> implements Builder<FillTransition> {
    ...
    public void applyTo(FillTransition x2) {
    ...
    public FillTransitionBuilder duration(Duration x2) {
        this.duration = x2;
        this.__set |= 1;
        return this;
    }

    public FillTransitionBuilder fromValue(Color x2) {
        this.fromValue = x2;
        this.__set |= 2;
        return this;
    }

    public FillTransitionBuilder shape(Shape x2) {
        this.shape = x2;
        this.__set |= 4;
        return this;
    }

    public FillTransitionBuilder toValue(Color x2) {
        this.toValue = x2;
        this.__set |= 8;
        return this;
    }
    ...
    public FillTransition build2() {
        FillTransition x2 = new FillTransition();
        applyTo(x2);
        return x2;
    }
}
