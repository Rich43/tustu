...
/* loaded from: jfxrt.jar:javafx/scene/AccessibleAttribute.class */
public enum AccessibleAttribute {
    ...
    /* loaded from: jfxrt.jar:javafx/scene/AccessibleAttribute$ToggleState.class */
