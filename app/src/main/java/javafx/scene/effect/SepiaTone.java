...
/* loaded from: jfxrt.jar:javafx/scene/effect/SepiaTone.class */
public class SepiaTone extends Effect {
    ...
    public com.sun.scenario.effect.SepiaTone impl_createImpl() {
    ...
    public final DoubleProperty levelProperty() {
        if (this.level == null) {
            this.level = new DoublePropertyBase(1.0d) { // from class: javafx.scene.effect.SepiaTone.1
    ...
    void impl_update() {
        ...
        com.sun.scenario.effect.SepiaTone peer = (com.sun.scenario.effect.SepiaTone) impl_getImpl();
    ...
    public Effect impl_copy() {
        SepiaTone st = new SepiaTone(getLevel());
        st.setInput(getInput());
        return st;
    }
}
