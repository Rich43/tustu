...
@Deprecated
/* loaded from: jfxrt.jar:javafx/scene/effect/InnerShadowBuilder.class */
public class InnerShadowBuilder<B extends InnerShadowBuilder<B>> implements Builder<InnerShadow> {
    ...
    public void applyTo(InnerShadow x2) {
        int set = this.__set;
        while (set != 0) {
    ...
    /* renamed from: build */
    public InnerShadow build2() {
        InnerShadow x2 = new InnerShadow();
        applyTo(x2);
        return x2;
    }
}
