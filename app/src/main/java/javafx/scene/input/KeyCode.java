...
/* loaded from: jfxrt.jar:javafx/scene/input/KeyCode.class */
public enum KeyCode {
    ENTER(10, "Enter", 128),
    ...
    EQUALS(61, "Equals"),
    A(65, "A", 16),
    B(66, PdfOps.B_TOKEN, 16),
    C(67, "C", 16),
    D(68, PdfOps.D_TOKEN, 16),
    E(69, "E", 16),
    F(70, PdfOps.F_TOKEN, 16),
    G(71, "G", 16),
    H(72, PdfOps.H_TOKEN, 16),
    I(73, "I", 16),
    J(74, "J", 16),
    K(75, PdfOps.K_TOKEN, 16),
    L(76, "L", 16),
    M(77, PdfOps.M_TOKEN, 16),
    N(78, "N", 16),
    O(79, "O", 16),
    P(80, Constants._TAG_P, 16),
    Q(81, "Q", 16),
    R(82, "R", 16),
    S(83, PdfOps.S_TOKEN, 16),
    T(84, "T", 16),
    U(85, "U", 16),
    V(86, "V", 16),
    W(87, PdfOps.W_TOKEN, 16),
    X(88, "X", 16),
    Y(89, Constants._TAG_Y, 16),
    Z(90, com.sun.org.apache.xalan.internal.xsltc.compiler.Constants.HASIDCALL_INDEX_SIG, 16),
    ...
    ACCEPT(30, XIncludeHandler.HTTP_ACCEPT),
    ...
    INPUT_METHOD_ON_OFF(java.awt.event.KeyEvent.VK_INPUT_METHOD_ON_OFF, "Input Method On/Off"),
    CUT(java.awt.event.KeyEvent.VK_CUT, "Cut"),
    COPY(java.awt.event.KeyEvent.VK_COPY, "Copy"),
    PASTE(java.awt.event.KeyEvent.VK_PASTE, "Paste"),
    UNDO(java.awt.event.KeyEvent.VK_UNDO, "Undo"),
    AGAIN(java.awt.event.KeyEvent.VK_AGAIN, "Again"),
    FIND(java.awt.event.KeyEvent.VK_FIND, "Find"),
    PROPS(java.awt.event.KeyEvent.VK_PROPS, "Properties"),
    STOP(java.awt.event.KeyEvent.VK_STOP, "Stop"),
    COMPOSE(java.awt.event.KeyEvent.VK_COMPOSE, "Compose"),
    ALT_GRAPH(65406, "Alt Graph", 8),
    BEGIN(java.awt.event.KeyEvent.VK_BEGIN, "Begin"),
    UNDEFINED(0, "Undefined"),
    SOFTKEY_0(4096, "Softkey 0"),
    SOFTKEY_1(4097, "Softkey 1"),
    SOFTKEY_2(SocketOptions.SO_RCVBUF, "Softkey 2"),
    SOFTKEY_3(SocketOptions.SO_OOBINLINE, "Softkey 3"),
    SOFTKEY_4(4100, "Softkey 4"),
    SOFTKEY_5(4101, "Softkey 5"),
    SOFTKEY_6(SocketOptions.SO_TIMEOUT, "Softkey 6"),
    ...
    TRACK_NEXT(FTPReply.CANNOT_OPEN_DATA_CONNECTION, "Next Track", 256),
    ...
    final String name;
    private int mask;
    private static final Map<String, KeyCode> nameMap = new HashMap(values().length);

    static {
        for (KeyCode c2 : values()) {
            nameMap.put(c2.name, c2);
        }
    }

    /* loaded from: jfxrt.jar:javafx/scene/input/KeyCode$KeyCodeClass.class */
