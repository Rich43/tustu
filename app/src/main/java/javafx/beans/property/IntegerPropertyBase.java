...
/* loaded from: jfxrt.jar:javafx/beans/property/IntegerPropertyBase.class */
public abstract class IntegerPropertyBase extends IntegerProperty {
    ...
    public void bind(final ObservableValue<? extends Number> rawObservable) {
        ...
        if (rawObservable instanceof ObservableIntegerValue) {
            ...
            newObservable = new IntegerBinding() { // from class: javafx.beans.property.IntegerPropertyBase.1
                {
            ...
            newObservable = new IntegerBinding() { // from class: javafx.beans.property.IntegerPropertyBase.2
                {
                    super.bind(rawObservable);
                }
    ...
    /* loaded from: jfxrt.jar:javafx/beans/property/IntegerPropertyBase$Listener.class */
    private static class Listener implements InvalidationListener {
        ...
        public void invalidated(Observable observable) {
            IntegerPropertyBase ref = this.wref.get();
            if (ref != null) {
                ref.markInvalid();
            } else {
