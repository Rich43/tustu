...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/JavaBeanDoubleProperty.class */
public final class JavaBeanDoubleProperty extends DoubleProperty implements JavaBeanProperty<Number> {
    ...
    JavaBeanDoubleProperty(PropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
    ...
    @Override // javafx.beans.value.WritableDoubleValue
    public void set(double value) {
        ...
        AccessController.doPrivileged(() -> {
            try {
                MethodUtil.invoke(this.descriptor.getSetter(), getBean(), new Object[]{Double.valueOf(value)});
    ...
    public void bind(ObservableValue<? extends Number> observable) {
        ...
        if (!observable.equals(this.observable)) {
            unbind();
            set(observable.getValue2().doubleValue());
