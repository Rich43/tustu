...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/ReadOnlyJavaBeanFloatProperty.class */
public final class ReadOnlyJavaBeanFloatProperty extends ReadOnlyFloatPropertyBase implements ReadOnlyJavaBeanProperty<Number> {
    ...
    ReadOnlyJavaBeanFloatProperty(ReadOnlyPropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
