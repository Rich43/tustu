...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/ReadOnlyJavaBeanStringProperty.class */
public final class ReadOnlyJavaBeanStringProperty extends ReadOnlyStringPropertyBase implements ReadOnlyJavaBeanProperty<String> {
    ...
    ReadOnlyJavaBeanStringProperty(ReadOnlyPropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
    ...
    public String get() {
        return (String) AccessController.doPrivileged(() -> {
            try {
                return (String) MethodUtil.invoke(this.descriptor.getGetter(), getBean(), (Object[]) null);
    ...
    @Override // javafx.beans.property.ReadOnlyStringPropertyBase, javafx.beans.property.adapter.ReadOnlyJavaBeanProperty
