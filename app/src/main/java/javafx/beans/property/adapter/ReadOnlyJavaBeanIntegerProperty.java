...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/ReadOnlyJavaBeanIntegerProperty.class */
public final class ReadOnlyJavaBeanIntegerProperty extends ReadOnlyIntegerPropertyBase implements ReadOnlyJavaBeanProperty<Number> {
    ...
    ReadOnlyJavaBeanIntegerProperty(ReadOnlyPropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
