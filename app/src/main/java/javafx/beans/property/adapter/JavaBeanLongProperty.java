...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/JavaBeanLongProperty.class */
public final class JavaBeanLongProperty extends LongProperty implements JavaBeanProperty<Number> {
    ...
    JavaBeanLongProperty(PropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
    ...
    public void set(long value) {
        ...
        AccessController.doPrivileged(() -> {
            try {
                MethodUtil.invoke(this.descriptor.getSetter(), getBean(), new Object[]{Long.valueOf(value)});
    ...
    public void bind(ObservableValue<? extends Number> observable) {
        ...
        if (!observable.equals(this.observable)) {
            unbind();
            set(observable.getValue2().longValue());
