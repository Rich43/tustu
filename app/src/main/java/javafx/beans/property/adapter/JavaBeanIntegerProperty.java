...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/JavaBeanIntegerProperty.class */
public final class JavaBeanIntegerProperty extends IntegerProperty implements JavaBeanProperty<Number> {
    ...
    JavaBeanIntegerProperty(PropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
    ...
    public int get() {
        return ((Integer) AccessController.doPrivileged(() -> {
            try {
                return Integer.valueOf(((Number) MethodUtil.invoke(this.descriptor.getGetter(), getBean(), (Object[]) null)).intValue());
    ...
    public void set(int value) {
        ...
        AccessController.doPrivileged(() -> {
            try {
                MethodUtil.invoke(this.descriptor.getSetter(), getBean(), new Object[]{Integer.valueOf(value)});
