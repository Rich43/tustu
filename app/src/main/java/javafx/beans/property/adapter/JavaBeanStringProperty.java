...
/* loaded from: jfxrt.jar:javafx/beans/property/adapter/JavaBeanStringProperty.class */
public final class JavaBeanStringProperty extends StringProperty implements JavaBeanProperty<String> {
    ...
    JavaBeanStringProperty(PropertyDescriptor descriptor, Object bean) throws IllegalArgumentException {
