...
/* loaded from: jfxrt.jar:javafx/beans/binding/LongBinding.class */
public abstract class LongBinding extends LongExpression implements NumberBinding {
    ...
    @Override // javafx.beans.binding.LongExpression, javafx.beans.value.ObservableValue
    /* renamed from: getValue */
    public /* bridge */ /* synthetic */ Number getValue2() {
        return super.getValue2();
    }

    @Override // javafx.beans.binding.LongExpression, javafx.beans.binding.NumberExpression
    ...
    public String toString() {
        return this.valid ? "LongBinding [value: " + get() + "]" : "LongBinding [invalid]";
    }
}
