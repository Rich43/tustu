...
/* loaded from: jfxrt.jar:javafx/css/SimpleStyleableIntegerProperty.class */
public class SimpleStyleableIntegerProperty extends StyleableIntegerProperty {
    ...
    public SimpleStyleableIntegerProperty(@NamedArg("cssMetaData") CssMetaData<? extends Styleable, Number> cssMetaData, @NamedArg(JOptionPane.INITIAL_VALUE_PROPERTY) Integer initialValue) {
    ...
    public SimpleStyleableIntegerProperty(@NamedArg("cssMetaData") CssMetaData<? extends Styleable, Number> cssMetaData, @NamedArg("bean") Object bean, @NamedArg("name") String name, @NamedArg(JOptionPane.INITIAL_VALUE_PROPERTY) Integer initialValue) {
        super(initialValue.intValue());
        this.bean = bean;
        this.name = name == null ? "" : name;
        this.cssMetaData = cssMetaData;
    }
