...
/* loaded from: jfxrt.jar:javafx/css/SimpleStyleableFloatProperty.class */
public class SimpleStyleableFloatProperty extends StyleableFloatProperty {
    ...
    public SimpleStyleableFloatProperty(@NamedArg("cssMetaData") CssMetaData<? extends Styleable, Number> cssMetaData, @NamedArg(JOptionPane.INITIAL_VALUE_PROPERTY) Float initialValue) {
    ...
    public SimpleStyleableFloatProperty(@NamedArg("cssMetaData") CssMetaData<? extends Styleable, Number> cssMetaData, @NamedArg("bean") Object bean, @NamedArg("name") String name, @NamedArg(JOptionPane.INITIAL_VALUE_PROPERTY) Float initialValue) {
        super(initialValue.floatValue());
        this.bean = bean;
        this.name = name == null ? "" : name;
        this.cssMetaData = cssMetaData;
    }
