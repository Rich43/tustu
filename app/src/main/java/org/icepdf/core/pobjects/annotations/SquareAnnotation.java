...
/* loaded from: icepdf-core.jar:org/icepdf/core/pobjects/annotations/SquareAnnotation.class */
public class SquareAnnotation extends MarkupAnnotation {
    ...
    public SquareAnnotation(Library l2, HashMap h2) {
        super(l2, h2);
    }
    ...
    public static SquareAnnotation getInstance(Library library, Rectangle rect) {
    ...
    public void resetAppearanceStream(double dx, double dy, AffineTransform pageTransform) {
        ...
        this.shapes.add(new ShapeDrawCmd(rectangleToDraw));
        if (this.isFillColor) {
