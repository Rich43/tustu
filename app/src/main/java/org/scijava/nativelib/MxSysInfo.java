...
/* loaded from: jssc.jar:org/scijava/nativelib/MxSysInfo.class */
public class MxSysInfo {
    ...
    public static String guessMxSysInfo() throws IOException, NumberFormatException {
        String cxxver;
        ...
        if ("Linux".equals(os)) {
            try {
                ...
                extra = PdfOps.c_TOKEN + libc_m.group(1) + libc_m.group(2) + "cxx" + cxxver;
            } catch (IOException e2) {
                extra = "unknown";
            }
        }
        return arch + LanguageTag.SEP + os + LanguageTag.SEP + extra;
    }
}
