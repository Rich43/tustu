...
/* loaded from: rt.jar:org/omg/PortableServer/ServantLocatorHelper.class */
public abstract class ServantLocatorHelper {
    private static String _id = "IDL:omg.org/PortableServer/ServantLocator:1.0";
    private static TypeCode __typeCode = null;

    public static void insert(Any any, ServantLocator servantLocator) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, servantLocator);
    ...
    public static ServantLocator narrow(Object object) {
        ...
        _servantlocatorstub._set_delegate(delegate_get_delegate);
