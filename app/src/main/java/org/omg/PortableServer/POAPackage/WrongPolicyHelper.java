...
/* loaded from: rt.jar:org/omg/PortableServer/POAPackage/WrongPolicyHelper.class */
public abstract class WrongPolicyHelper {
    ...
    public static void insert(Any any, WrongPolicy wrongPolicy) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, wrongPolicy);
        ...
        if (__typeCode == null) {
            synchronized (TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __active = true;
                    __typeCode = ORB.init().create_exception_tc(id(), "WrongPolicy", new StructMember[0]);
                    __active = false;
                }
            }
        }
