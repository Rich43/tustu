...
/* loaded from: rt.jar:org/omg/PortableServer/POAPackage/ObjectNotActiveHelper.class */
public abstract class ObjectNotActiveHelper {
    ...
    public static void insert(Any any, ObjectNotActive objectNotActive) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, objectNotActive);
