...
/* loaded from: rt.jar:org/omg/PortableServer/POAPackage/ServantAlreadyActiveHelper.class */
public abstract class ServantAlreadyActiveHelper {
    ...
    public static void insert(Any any, ServantAlreadyActive servantAlreadyActive) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, servantAlreadyActive);
