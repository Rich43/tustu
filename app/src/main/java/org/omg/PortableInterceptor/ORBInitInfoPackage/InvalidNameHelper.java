...
/* loaded from: rt.jar:org/omg/PortableInterceptor/ORBInitInfoPackage/InvalidNameHelper.class */
public abstract class InvalidNameHelper {
    ...
    public static void insert(Any any, InvalidName invalidName) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, invalidName);
        ...
        if (__typeCode == null) {
            synchronized (TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __active = true;
                    __typeCode = ORB.init().create_exception_tc(id(), "InvalidName", new StructMember[0]);
                    __active = false;
                }
            }
        }
