...
/* loaded from: rt.jar:org/omg/CosNaming/BindingIteratorHelper.class */
public abstract class BindingIteratorHelper {
    private static String _id = "IDL:omg.org/CosNaming/BindingIterator:1.0";
    private static TypeCode __typeCode = null;

    public static void insert(Any any, BindingIterator bindingIterator) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, bindingIterator);
    ...
    public static BindingIterator narrow(Object object) {
        ...
        _bindingiteratorstub._set_delegate(delegate_get_delegate);
