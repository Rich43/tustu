...
/* loaded from: rt.jar:org/omg/CosNaming/NamingContextPackage/NotEmptyHelper.class */
public abstract class NotEmptyHelper {
    ...
    public static void insert(Any any, NotEmpty notEmpty) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, notEmpty);
        ...
        if (__typeCode == null) {
            synchronized (TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __active = true;
                    __typeCode = ORB.init().create_exception_tc(id(), "NotEmpty", new StructMember[0]);
                    __active = false;
                }
            }
        }
