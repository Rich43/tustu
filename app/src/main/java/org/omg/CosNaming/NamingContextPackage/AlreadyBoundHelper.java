...
/* loaded from: rt.jar:org/omg/CosNaming/NamingContextPackage/AlreadyBoundHelper.class */
public abstract class AlreadyBoundHelper {
    ...
    public static void insert(Any any, AlreadyBound alreadyBound) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, alreadyBound);
        ...
        if (__typeCode == null) {
            synchronized (TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __active = true;
                    __typeCode = ORB.init().create_exception_tc(id(), "AlreadyBound", new StructMember[0]);
                    __active = false;
                }
            }
        }
