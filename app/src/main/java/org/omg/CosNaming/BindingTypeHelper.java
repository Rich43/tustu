...
/* loaded from: rt.jar:org/omg/CosNaming/BindingTypeHelper.class */
public abstract class BindingTypeHelper {
    private static String _id = "IDL:omg.org/CosNaming/BindingType:1.0";
    private static TypeCode __typeCode = null;

    public static void insert(Any any, BindingType bindingType) throws MARSHAL {
        OutputStream outputStreamCreate_output_stream = any.create_output_stream();
        any.type(type());
        write(outputStreamCreate_output_stream, bindingType);
