...
/* loaded from: commons-net-3.6.jar:org/apache/commons/net/ftp/FTPClientConfig.class */
public class FTPClientConfig {
    ...
    static {
        ...
        LANGUAGE_CODE_MAP.put(PdfOps.sh_TOKEN, new Locale(PdfOps.sh_TOKEN, "", ""));
    ...
    private static String[] splitShortMonthString(String shortmonths) {
        StringTokenizer st = new StringTokenizer(shortmonths, CallSiteDescriptor.OPERATOR_DELIMITER);
