...
@Deprecated
/* loaded from: commons-net-3.6.jar:org/apache/commons/net/ftp/FTPCommand.class */
public final class FTPCommand {
    ...
    private static final String[] _commands = {"USER", "PASS", "ACCT", "CWD", "CDUP", "SMNT", "REIN", "QUIT", "PORT", "PASV", "TYPE", "STRU", "MODE", "RETR", "STOR", "STOU", "APPE", "ALLO", "REST", "RNFR", "RNTO", "ABOR", "DELE", "RMD", "MKD", ScriptingFunctions.PWD_NAME, "LIST", "NLST", "SITE", "SYST", "STAT", "HELP", "NOOP", "MDTM", "FEAT", "MFMT", "EPSV", "EPRT", "MLSD", "MLST"};
