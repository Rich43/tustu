...
/* loaded from: commons-net-3.6.jar:org/apache/commons/net/time/TimeUDPClient.class */
public final class TimeUDPClient extends DatagramSocketClient {
    ...
    public long getTime(InetAddress host, int port) throws IOException {
        ...
        long time = 0 | (((this.__timeData[0] & 255) << 24) & 4294967295L);
        return time | (((this.__timeData[1] & 255) << 16) & 4294967295L) | (((this.__timeData[2] & 255) << 8) & 4294967295L) | (this.__timeData[3] & 255 & 4294967295L);
    }
