...
/* loaded from: commons-net-3.6.jar:org/apache/commons/net/imap/IMAPClient.class */
public class IMAPClient extends IMAP {
    private static final char DQUOTE = '\"';
    private static final String DQUOTE_S = "\"";

    /* loaded from: commons-net-3.6.jar:org/apache/commons/net/imap/IMAPClient$FETCH_ITEM_NAMES.class */
    ...
    /* loaded from: commons-net-3.6.jar:org/apache/commons/net/imap/IMAPClient$SEARCH_CRITERIA.class */
    ...
    /* loaded from: commons-net-3.6.jar:org/apache/commons/net/imap/IMAPClient$STATUS_DATA_ITEMS.class */
