...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/ode/nonstiff/GillIntegrator.class */
public class GillIntegrator extends RungeKuttaIntegrator {
    private static final double[] STATIC_C = {0.5d, 0.5d, 1.0d};
    private static final double[][] STATIC_A = {new double[]{0.5d}, new double[]{(FastMath.sqrt(2.0d) - 1.0d) / 2.0d, (2.0d - FastMath.sqrt(2.0d)) / 2.0d}, new double[]{0.0d, (-FastMath.sqrt(2.0d)) / 2.0d, (2.0d + FastMath.sqrt(2.0d)) / 2.0d}};
