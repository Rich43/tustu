...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/random/Well44497b.class */
public class Well44497b extends AbstractWell {
    private static final long serialVersionUID = 4032007538246675492L;

    /* renamed from: K, reason: collision with root package name */
    private static final int f13091K = 44497;
    private static final int M1 = 23;
    private static final int M2 = 481;
    private static final int M3 = 229;

    public Well44497b() {
        super(f13091K, 23, M2, 229);
    }

    public Well44497b(int seed) {
        super(f13091K, 23, M2, 229, seed);
    }
