...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/random/Well19937a.class */
public class Well19937a extends AbstractWell {
    private static final long serialVersionUID = -7462102162223815419L;

    /* renamed from: K, reason: collision with root package name */
    private static final int f13088K = 19937;
    private static final int M1 = 70;
    private static final int M2 = 179;
    private static final int M3 = 449;

    public Well19937a() {
        super(f13088K, 70, 179, M3);
    }

    public Well19937a(int seed) {
        super(f13088K, 70, 179, M3, seed);
    }
