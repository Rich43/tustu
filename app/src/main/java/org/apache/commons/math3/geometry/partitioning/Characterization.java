...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/geometry/partitioning/Characterization.class */
class Characterization<S extends Space> {
    ...
    private void characterize(BSPTree<S> node, SubHyperplane<S> sub, List<BSPTree<S>> splitters) {
        if (node.getCut() == null) {
            boolean inside = ((Boolean) node.getAttribute()).booleanValue();
            if (inside) {
