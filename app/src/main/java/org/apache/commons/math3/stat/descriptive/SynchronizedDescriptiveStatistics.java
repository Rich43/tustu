...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/stat/descriptive/SynchronizedDescriptiveStatistics.class */
public class SynchronizedDescriptiveStatistics extends DescriptiveStatistics {
    ...
    public synchronized void addValue(double v2) {
        super.addValue(v2);
    }
    ...
    @Override // org.apache.commons.math3.stat.descriptive.DescriptiveStatistics
    public synchronized SynchronizedDescriptiveStatistics copy() throws NullArgumentException {
