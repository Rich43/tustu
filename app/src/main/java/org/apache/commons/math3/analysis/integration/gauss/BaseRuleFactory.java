...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/analysis/integration/gauss/BaseRuleFactory.class */
public abstract class BaseRuleFactory<T extends Number> {
    ...
    protected abstract Pair<T[], T[]> computeRule(int i2) throws DimensionMismatchException;
    ...
    private static <T extends Number> Pair<double[], double[]> convertToDouble(Pair<T[], T[]> rule) {
        ...
        for (int i2 = 0; i2 < len; i2++) {
            pD[i2] = pT[i2].doubleValue();
            wD[i2] = wT[i2].doubleValue();
        }
