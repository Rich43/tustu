...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/fraction/ProperFractionFormat.class */
    ...
    public Fraction parse(String source, ParsePosition pos) {
        ...
        switch (c2) {
            ...
            case '/':
                ...
                int w2 = whole.intValue();
                int n2 = num.intValue();
                int d2 = den.intValue();
                return new Fraction(((FastMath.abs(w2) * d2) + n2) * MathUtils.copySign(1, w2), d2);
            default:
                pos.setIndex(initialIndex);
