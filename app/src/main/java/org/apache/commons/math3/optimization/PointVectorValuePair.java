...
@Deprecated
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/optimization/PointVectorValuePair.class */
public class PointVectorValuePair extends Pair<double[], double[]> implements Serializable {
    ...
    /* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/optimization/PointVectorValuePair$DataTransferObject.class */
