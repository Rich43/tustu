...
@Deprecated
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/optimization/univariate/BaseAbstractUnivariateOptimizer.class */
public abstract class BaseAbstractUnivariateOptimizer implements UnivariateOptimizer {
    ...
    public UnivariatePointValuePair optimize(int maxEval, UnivariateFunction f2, GoalType goalType, double min, double max, double startValue) {
        if (f2 == null) {
    ...
    @Override // org.apache.commons.math3.optimization.univariate.BaseUnivariateOptimizer
    public UnivariatePointValuePair optimize(int maxEval, UnivariateFunction f2, GoalType goalType, double min, double max) {
        return optimize(maxEval, f2, goalType, min, max, min + (0.5d * (max - min)));
    }
