...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/distribution/NormalDistribution.class */
public class NormalDistribution extends AbstractRealDistribution {
    ...
    public double inverseCumulativeProbability(double p2) throws OutOfRangeException {
        ...
        return this.mean + (this.standardDeviation * SQRT2 * Erf.erfInv((2.0d * p2) - 1.0d));
    }
    ...
    public double getNumericalVariance() {
        double s2 = getStandardDeviation();
        return s2 * s2;
    }
