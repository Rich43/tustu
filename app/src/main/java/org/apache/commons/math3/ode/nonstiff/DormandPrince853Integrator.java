...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/ode/nonstiff/DormandPrince853Integrator.class */
public class DormandPrince853Integrator extends EmbeddedRungeKuttaIntegrator {
    ...
    protected double estimateError(double[][] yDotK, double[] y0, double[] y1, double h2) {
        ...
        for (int j2 = 0; j2 < this.mainSetDimension; j2++) {
            double errSum1 = (E1_01 * yDotK[0][j2]) + (E1_06 * yDotK[5][j2]) + (E1_07 * yDotK[6][j2]) + (E1_08 * yDotK[7][j2]) + (E1_09 * yDotK[8][j2]) + (E1_10 * yDotK[9][j2]) + (E1_11 * yDotK[10][j2]) + (E1_12 * yDotK[11][j2]);
            double errSum2 = (E2_01 * yDotK[0][j2]) + (E2_06 * yDotK[5][j2]) + (E2_07 * yDotK[6][j2]) + (E2_08 * yDotK[7][j2]) + (E2_09 * yDotK[8][j2]) + (E2_10 * yDotK[9][j2]) + (E2_11 * yDotK[10][j2]) + (E2_12 * yDotK[11][j2]);
        ...
        return (FastMath.abs(h2) * error1) / FastMath.sqrt(this.mainSetDimension * den);
    }
}
