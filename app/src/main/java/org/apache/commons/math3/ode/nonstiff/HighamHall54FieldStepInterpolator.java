...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/ode/nonstiff/HighamHall54FieldStepInterpolator.class */
class HighamHall54FieldStepInterpolator<T extends RealFieldElement<T>> extends RungeKuttaFieldStepInterpolator<T> {
    ...
    protected FieldODEStateAndDerivative<T> computeInterpolatedStateAndDerivatives(FieldEquationsMapper<T> mapper, T time, T theta, T thetaH, T oneMinusThetaH) {
        ...
        RealFieldElement realFieldElement6 = (RealFieldElement) ((RealFieldElement) theta.multiply(0.625d)).multiply((RealFieldElement) ((RealFieldElement) theta.multiply(2)).subtract(1.0d));
