...
@Deprecated
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/fitting/GaussianFitter.class */
public class GaussianFitter extends CurveFitter<Gaussian.Parametric> {
    ...
    public double[] fit(double[] initialGuess) {
        Gaussian.Parametric f2 = new Gaussian.Parametric() { // from class: org.apache.commons.math3.fitting.GaussianFitter.1
    ...
    /* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/fitting/GaussianFitter$ParameterGuesser.class */
    public static class ParameterGuesser {
        ...
        private WeightedObservedPoint[] sortObservations(WeightedObservedPoint[] unsorted) {
            ...
            Comparator<WeightedObservedPoint> cmp = new Comparator<WeightedObservedPoint>() { // from class: org.apache.commons.math3.fitting.GaussianFitter.ParameterGuesser.1
