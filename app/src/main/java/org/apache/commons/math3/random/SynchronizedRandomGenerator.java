...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/random/SynchronizedRandomGenerator.class */
public class SynchronizedRandomGenerator implements RandomGenerator {
    ...
    @Override // org.apache.commons.math3.random.RandomGenerator
    public synchronized int nextInt(int n2) {
        return this.wrapped.nextInt(n2);
    }
