...
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/geometry/partitioning/AbstractSubHyperplane.class */
public abstract class AbstractSubHyperplane<S extends Space, T extends Space> implements SubHyperplane<S> {
    ...
    public AbstractSubHyperplane<S, T> reunite(SubHyperplane<S> other) {
        AbstractSubHyperplane<S, T> o2 = (AbstractSubHyperplane) other;
        return buildNew(this.hyperplane, new RegionFactory().union(this.remainingRegion, o2.remainingRegion));
    }
