...
@Deprecated
/* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/fitting/HarmonicFitter.class */
public class HarmonicFitter extends CurveFitter<HarmonicOscillator.Parametric> {
    ...
    /* loaded from: commons-math3-3.6.1.jar:org/apache/commons/math3/fitting/HarmonicFitter$ParameterGuesser.class */
    public static class ParameterGuesser {

        /* renamed from: a, reason: collision with root package name */
        private final double f12997a;
        ...
        public ParameterGuesser(WeightedObservedPoint[] observations) {
            ...
            this.f12997a = aOmega[0];
            this.omega = aOmega[1];
            this.phi = guessPhi(sorted);
        }

        public double[] guess() {
            return new double[]{this.f12997a, this.omega, this.phi};
        }
