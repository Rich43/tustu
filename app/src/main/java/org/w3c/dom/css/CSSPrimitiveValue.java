...
/* loaded from: rt.jar:org/w3c/dom/css/CSSPrimitiveValue.class */
public interface CSSPrimitiveValue extends CSSValue {
    ...
    void setFloatValue(short s2, float f2) throws DOMException;

    float getFloatValue(short s2) throws DOMException;

    void setStringValue(short s2, String str) throws DOMException;
