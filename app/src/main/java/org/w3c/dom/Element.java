...
/* loaded from: rt.jar:org/w3c/dom/Element.class */
public interface Element extends Node {
    ...
    void setIdAttribute(String str, boolean z2) throws DOMException;

    void setIdAttributeNS(String str, String str2, boolean z2) throws DOMException;

    void setIdAttributeNode(Attr attr, boolean z2) throws DOMException;
}
