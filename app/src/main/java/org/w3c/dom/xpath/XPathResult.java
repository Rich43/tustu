...
/* loaded from: rt.jar:org/w3c/dom/xpath/XPathResult.class */
public interface XPathResult {
    ...
    Node iterateNext() throws DOMException, XPathException;

    Node snapshotItem(int i2) throws XPathException;
}
