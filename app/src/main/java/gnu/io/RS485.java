...
/* loaded from: RXTXcomm.jar:gnu/io/RS485.class */
final class RS485 extends RS485Port {
    private int fd;
    static boolean dsrFlag;
    private RS485PortEventListener SPEventListener;
    private MonitorThread monThread;
    private final RS485OutputStream out = new RS485OutputStream(this);
    private final RS485InputStream in = new RS485InputStream(this);
    ...
    private native void nativeSetRS485PortParams(int i2, int i3, int i4, int i5) throws UnsupportedCommOperationException;
    ...
    public RS485(String str) throws PortInUseException {
        this.fd = open(str);
    }
    ...
    @Override // gnu.io.RS485Port
    public void setRS485PortParams(int i2, int i3, int i4, int i5) throws UnsupportedCommOperationException {
        nativeSetRS485PortParams(i2, i3, i4, i5);
        this.speed = i2;
        this.dataBits = i3;
        this.stopBits = i4;
        this.parity = i5;
    ...
    public void sendEvent(int i2, boolean z2) {
        ...
        RS485PortEvent rS485PortEvent = new RS485PortEvent(this, i2, !z2, z2);
    ...
    /* loaded from: RXTXcomm.jar:gnu/io/RS485$RS485OutputStream.class */
    class RS485OutputStream extends OutputStream {
        private final RS485 this$0;

        RS485OutputStream(RS485 rs485) {
            this.this$0 = rs485;
        }
    ...
    /* loaded from: RXTXcomm.jar:gnu/io/RS485$RS485InputStream.class */
    class RS485InputStream extends InputStream {
        private final RS485 this$0;

        RS485InputStream(RS485 rs485) {
            this.this$0 = rs485;
        }
    ...
    /* loaded from: RXTXcomm.jar:gnu/io/RS485$MonitorThread.class */
