...
/* loaded from: RXTXcomm.jar:gnu/io/ParallelPort.class */
public abstract class ParallelPort extends CommPort {
    ...
    public abstract int setMode(int i2) throws UnsupportedCommOperationException;
    ...
    public abstract void addEventListener(ParallelPortEventListener parallelPortEventListener) throws TooManyListenersException;

    public abstract void removeEventListener();

    public abstract void notifyOnError(boolean z2);

    public abstract void notifyOnBuffer(boolean z2);
}
