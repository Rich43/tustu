...
/* loaded from: TunerStudioMS.jar:af/k.class */
public class k implements s, InterfaceC0504a {

    /* renamed from: e, reason: collision with root package name */
    n f4487e;

    /* renamed from: d, reason: collision with root package name */
    List f4486d = new ArrayList();
    ...
    public C0500d a(ae.k kVar, p pVar, u uVar) throws IOException {
        ...
        if (!a(iA)) {
            c0500d.a(C0500d.f4347b);
            c0500d.a("Warning!! Wrong ECU TYPE found. MS2 expected, found MS3");
            return c0500d;
        }
        if ((iA & ae.o.f4409y) > 0) {
            uVar.a("The firmware on your ECU does not support jumperless reflash.");
            ...
            iA = 0;
            for (int i2 = 0; i2 < 2 && iA == 0; i2++) {
                j.a(pVar);
                iA = a(pVar);
                if (iA == 0 && !uVar.b("ECU does not appear to be on, Turn on Megasquirt/Microsquirt.")) {
                    c0500d.a(C0500d.f4347b);
                    c0500d.a("Cancelled by user.");
                    return c0500d;
                }
            }
            if ((iA & ae.o.f4406v) != ae.o.f4406v && (iA & ae.o.f4407w) != ae.o.f4407w) {
                c0500d.a(C0500d.f4347b);
                c0500d.a("ECU not found, cannot continue.");
                return c0500d;
            }
        }
        if (j.b(pVar)) {
            if ((iA & 512) == 0) {
                try {
                    C0500d c0500dB = b(pVar, uVar);
                    if (c0500dB.a() == C0500d.f4347b) {
                        return c0500dB;
                    }
                    while (uVar.b("Turn off Megasquirt/Microsquirt.")) {
                        if (!uVar.b("Please remove the boot jumper or disconnect the boot wire from ground.")) {
                            c0500dB.a(C0500d.f4347b);
                            c0500dB.a("Cancelled by user.");
                            return c0500dB;
                        }
                        if (!uVar.b("Turn on Megasquirt/Microsquirt.")) {
                            c0500dB.a(C0500d.f4347b);
                        ...
                        if (!j.b(pVar)) {
                            C.c("Bootstrap found ok!");
                            C0500d c0500dA = j.a(pVar, false);
                    ...
                    e2.printStackTrace();
                    c0500d.a(C0500d.f4347b);
                    c0500d.a("Protocol Exception, should be no Envelope.");
                    return c0500d;
                }
            }
        } else if ((iA & ae.o.f4409y) != 0) {
            try {
                c0500d = b(pVar, uVar);
            ...
            try {
                this.f4487e.j();
                this.f4487e.i();
                c0500d = j.a(pVar, j.a(pVar, this.f4487e));
            } catch (v e4) {
                c0500d.a(C0500d.f4347b);
    ...
    public C0500d a(p pVar, u uVar) {
        ...
        if (this.f4488f) {
            ...
            if (!uVar.b("Please remove the boot jumper or disconnect the boot wire from ground if fitted.")) {
                c0500d.a(C0500d.f4347b);
                c0500d.a("Cancelled by user.");
                return c0500d;
            }
    ...
    public int c(p pVar) throws IOException {
        ...
        if (bArrA[0] == 77 && bArrA[1] == 83 && bArrA[2] == 104 && bArrA[3] == 105 && bArrA[4] == 102) {
            return 9;
        }
        if (bArrA[0] == 81) {
            return 0;
