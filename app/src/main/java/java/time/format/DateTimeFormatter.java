...
/* loaded from: rt.jar:java/time/format/DateTimeFormatter.class */
public final class DateTimeFormatter {
    ...
    static {
        ...
        PARSED_LEAP_SECOND = temporalAccessor2 -> {
            if (temporalAccessor2 instanceof Parsed) {
                return Boolean.valueOf(((Parsed) temporalAccessor2).leapSecond);
            }
    ...
    public TemporalAccessor parse(CharSequence charSequence, ParsePosition parsePosition) {
        Objects.requireNonNull(charSequence, "text");
        Objects.requireNonNull(parsePosition, Keywords.FUNC_POSITION_STRING);
        try {
    ...
    public DateTimeParseContext parseUnresolved0(CharSequence charSequence, ParsePosition parsePosition) {
        ...
        int i2 = this.printerParser.parse(dateTimeParseContext, charSequence, parsePosition.getIndex());
        if (i2 < 0) {
            parsePosition.setErrorIndex(i2 ^ (-1));
            return null;
        }
    ...
    DateTimeFormatterBuilder.CompositePrinterParser toPrinterParser(boolean z2) {
    ...
    /* loaded from: rt.jar:java/time/format/DateTimeFormatter$ClassicFormat.class */
