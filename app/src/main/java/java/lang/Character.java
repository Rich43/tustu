...
/* loaded from: rt.jar:java/lang/Character.class */
public final class Character implements Serializable, Comparable<Character> {
    ...
    /* loaded from: rt.jar:java/lang/Character$Subset.class */
    ...
    /* loaded from: rt.jar:java/lang/Character$UnicodeBlock.class */
    public static final class UnicodeBlock extends Subset {
        ...
        private static final int[] blockStarts = {0, 128, 256, 384, 592, 688, 768, 880, 1024, 1280, 1328, 1424, 1536, 1792, 1872, 1920, 1984, 2048, 2112, 2144, 2208, 2304, 2432, StackType.VOID, 2688, 2816, 2944, 3072, 3200, 3328, 3456, 3584, 3712, WalkerFactory.BITS_RESERVED, 4096, 4256, NormalizerImpl.JAMO_L_BASE, 4608, 4992, 5024, 5120, 5760, 5792, 5888, 5920, 5952, 5984, 6016, 6144, 6320, 6400, 6480, 6528, 6624, 6656, 6688, 6832, 6912, 7040, 7104, 7168, 7248, 7296, 7360, 7376, 7424, 7552, 7616, 7680, 7936, 8192, 8304, 8352, 8400, 8448, 8528, 8592, 8704, 8960, 9216, 9280, 9312, 9472, SerialPort.BAUDRATE_9600, 9632, 9728, 9984, 10176, 10224, 10240, 10496, 10624, 10752, 11008, 11264, 11360, 11392, 11520, 11568, 11648, 11744, 11776, 11904, 12032, 12256, 12272, StackType.NULL_CHECK_START, 12352, 12448, 12544, 12592, 12688, 12704, 12736, 12784, 12800, 13056, 13312, 19904, 19968, 40960, 42128, 42192, 42240, 42560, 42656, 42752, 42784, 43008, 43056, 43072, 43136, 43232, 43264, 43312, 43360, 43392, 43488, 43520, 43616, 43648, 43744, 43776, 43824, 43968, NormalizerImpl.HANGUL_BASE, 55216, 55296, 56192, 56320, 57344, 63744, 64256, 64336, 65024, 65040, 65056, 65072, 65104, 65136, NormalizerImpl.CC_MASK, 65520, 65536, 65664, OSFCodeSetRegistry.UCS_2_VALUE, 65856, 65936, 66000, 66048, 66176, 66208, 66272, 66304, 66352, 66384, 66432, 66464, 66528, 66560, 66640, 66688, 66736, 67584, 67648, 67680, 67840, 67872, 67904, 67968, 68000, 68096, 68192, 68224, 68352, 68416, 68448, 68480, 68608, 68688, 69216, 69248, 69632, 69760, 69840, 69888, 69968, 70016, 70112, 71296, 71376, 73728, 74752, 74880, 77824, 78896, 92160, 92736, 93952, 94112, 110592, 110848, 118784, 119040, 119296, 119376, 119552, 119648, 119680, 119808, 120832, 126464, 126720, 126976, 127024, 127136, 127232, 127488, 127744, 128512, 128592, 128640, 128768, 128896, 131072, 173792, 173824, 177984, 178208, 183984, 194560, 195104, 917504, 917632, 917760, 918000, 983040, 1048576};
    ...
    /* loaded from: rt.jar:java/lang/Character$UnicodeScript.class */
    public enum UnicodeScript {
        ...
        public static UnicodeScript of(int i2) {
            if (!Character.isValidCodePoint(i2)) {
                throw new IllegalArgumentException();
            }
            ...
            int iBinarySearch = Arrays.binarySearch(scriptStarts, i2);
            if (iBinarySearch < 0) {
                iBinarySearch = (-iBinarySearch) - 2;
            }
            return scripts[iBinarySearch];
        }
    ...
    /* loaded from: rt.jar:java/lang/Character$CharacterCache.class */
    private static class CharacterCache {
        ...
        static {
            for (int i2 = 0; i2 < cache.length; i2++) {
                cache[i2] = new Character((char) i2);
            }
        }
    }
    ...
    public static Character valueOf(char c2) {
        if (c2 <= 127) {
            return CharacterCache.cache[c2];
        }
    ...
    public static boolean isValidCodePoint(int i2) {
        return (i2 >>> 16) < 17;
    }
    ...
    public static boolean isSupplementaryCodePoint(int i2) {
        return i2 >= 65536 && i2 < 1114112;
    }
    ...
    public static int codePointAt(CharSequence charSequence, int i2) {
        int i3;
        char cCharAt = charSequence.charAt(i2);
        if (isHighSurrogate(cCharAt) && (i3 = i2 + 1) < charSequence.length()) {
            char cCharAt2 = charSequence.charAt(i3);
            if (isLowSurrogate(cCharAt2)) {
                return toCodePoint(cCharAt, cCharAt2);
            }
        }
        return cCharAt;
    }

    public static int codePointAt(char[] cArr, int i2) {
        return codePointAtImpl(cArr, i2, cArr.length);
    }

    public static int codePointAt(char[] cArr, int i2, int i3) {
        if (i2 >= i3 || i3 < 0 || i3 > cArr.length) {
            throw new IndexOutOfBoundsException();
        }
        return codePointAtImpl(cArr, i2, i3);
    }

    static int codePointAtImpl(char[] cArr, int i2, int i3) {
        int i4;
        char c2 = cArr[i2];
        if (isHighSurrogate(c2) && (i4 = i2 + 1) < i3) {
            char c3 = cArr[i4];
    ...
    public static int codePointBefore(CharSequence charSequence, int i2) {
        int i3 = i2 - 1;
        char cCharAt = charSequence.charAt(i3);
        if (isLowSurrogate(cCharAt) && i3 > 0) {
            char cCharAt2 = charSequence.charAt(i3 - 1);
            if (isHighSurrogate(cCharAt2)) {
                return toCodePoint(cCharAt2, cCharAt);
            }
        }
        return cCharAt;
    }

    public static int codePointBefore(char[] cArr, int i2) {
        return codePointBeforeImpl(cArr, i2, 0);
    }

    public static int codePointBefore(char[] cArr, int i2, int i3) {
        if (i2 <= i3 || i3 < 0 || i3 >= cArr.length) {
            throw new IndexOutOfBoundsException();
        }
        return codePointBeforeImpl(cArr, i2, i3);
    }

    static int codePointBeforeImpl(char[] cArr, int i2, int i3) {
        int i4 = i2 - 1;
        char c2 = cArr[i4];
    ...
    public static int toChars(int i2, char[] cArr, int i3) {
        if (isBmpCodePoint(i2)) {
            cArr[i3] = (char) i2;
            return 1;
        }
        if (isValidCodePoint(i2)) {
            toSurrogates(i2, cArr, i3);
            return 2;
        }
        throw new IllegalArgumentException();
    }

    public static char[] toChars(int i2) {
        if (isBmpCodePoint(i2)) {
            return new char[]{(char) i2};
        }
        if (isValidCodePoint(i2)) {
            char[] cArr = new char[2];
            toSurrogates(i2, cArr, 0);
            return cArr;
        }
        throw new IllegalArgumentException();
    }

    static void toSurrogates(int i2, char[] cArr, int i3) {
        cArr[i3 + 1] = lowSurrogate(i2);
        cArr[i3] = highSurrogate(i2);
    }

    public static int codePointCount(CharSequence charSequence, int i2, int i3) {
        ...
        while (i5 < i3) {
            int i6 = i5;
            i5++;
            if (isHighSurrogate(charSequence.charAt(i6)) && i5 < i3 && isLowSurrogate(charSequence.charAt(i5))) {
                i4--;
                i5++;
            }
        }
    ...
    public static int codePointCount(char[] cArr, int i2, int i3) {
        if (i3 > cArr.length - i2 || i2 < 0 || i3 < 0) {
            throw new IndexOutOfBoundsException();
        }
        return codePointCountImpl(cArr, i2, i3);
    }

    static int codePointCountImpl(char[] cArr, int i2, int i3) {
        int i4 = i2 + i3;
        int i5 = i3;
        int i6 = i2;
        while (i6 < i4) {
            int i7 = i6;
            i6++;
            if (isHighSurrogate(cArr[i7]) && i6 < i4 && isLowSurrogate(cArr[i6])) {
                i5--;
                i6++;
            }
        }
    ...
    public static int offsetByCodePoints(CharSequence charSequence, int i2, int i3) {
        int length = charSequence.length();
        if (i2 < 0 || i2 > length) {
            throw new IndexOutOfBoundsException();
        }
        ...
        if (i3 >= 0) {
            ...
            while (i4 < length && i5 < i3) {
                int i6 = i4;
                i4++;
                if (isHighSurrogate(charSequence.charAt(i6)) && i4 < length && isLowSurrogate(charSequence.charAt(i4))) {
                    i4++;
                }
                i5++;
            }
            ...
            while (i4 > 0 && i7 < 0) {
                i4--;
                if (isLowSurrogate(charSequence.charAt(i4)) && i4 > 0 && isHighSurrogate(charSequence.charAt(i4 - 1))) {
                    i4--;
                }
                i7++;
            }
    ...
    public static int offsetByCodePoints(char[] cArr, int i2, int i3, int i4, int i5) {
        if (i3 > cArr.length - i2 || i2 < 0 || i3 < 0 || i4 < i2 || i4 > i2 + i3) {
            throw new IndexOutOfBoundsException();
        }
        return offsetByCodePointsImpl(cArr, i2, i3, i4, i5);
    }

    static int offsetByCodePointsImpl(char[] cArr, int i2, int i3, int i4, int i5) {
        int i6 = i4;
        if (i5 >= 0) {
            int i7 = i2 + i3;
            int i8 = 0;
            while (i6 < i7 && i8 < i5) {
                int i9 = i6;
                i6++;
                if (isHighSurrogate(cArr[i9]) && i6 < i7 && isLowSurrogate(cArr[i6])) {
                    i6++;
                }
                i8++;
            }
            ...
            while (i6 > i2 && i10 < 0) {
                i6--;
                if (isLowSurrogate(cArr[i6]) && i6 > i2 && isHighSurrogate(cArr[i6 - 1])) {
                    i6--;
                }
                i10++;
            }
    ...
    public static boolean isLowerCase(int i2) {
        return getType(i2) == 2 || CharacterData.of(i2).isOtherLowercase(i2);
    }
    ...
    public static boolean isUpperCase(int i2) {
        return getType(i2) == 1 || CharacterData.of(i2).isOtherUppercase(i2);
    }

    public static boolean isTitleCase(char c2) {
        return isTitleCase((int) c2);
    }
    ...
    public static boolean isAlphabetic(int i2) {
        return ((1086 >> getType(i2)) & 1) != 0 || CharacterData.of(i2).isOtherAlphabetic(i2);
    }

    public static boolean isIdeographic(int i2) {
        return CharacterData.of(i2).isIdeographic(i2);
    }
    ...
    public static boolean isJavaIdentifierStart(int i2) {
        return CharacterData.of(i2).isJavaIdentifierStart(i2);
    }
    ...
    public static boolean isJavaIdentifierPart(int i2) {
        return CharacterData.of(i2).isJavaIdentifierPart(i2);
    }

    public static boolean isUnicodeIdentifierStart(char c2) {
        return isUnicodeIdentifierStart((int) c2);
    }

    public static boolean isUnicodeIdentifierStart(int i2) {
        return CharacterData.of(i2).isUnicodeIdentifierStart(i2);
    }

    public static boolean isUnicodeIdentifierPart(char c2) {
        return isUnicodeIdentifierPart((int) c2);
    }

    public static boolean isUnicodeIdentifierPart(int i2) {
        return CharacterData.of(i2).isUnicodeIdentifierPart(i2);
    }
    ...
    public static boolean isIdentifierIgnorable(int i2) {
        return CharacterData.of(i2).isIdentifierIgnorable(i2);
    }
    ...
    public static int toLowerCase(int i2) {
        return CharacterData.of(i2).toLowerCase(i2);
    }
    ...
    public static int toUpperCase(int i2) {
        return CharacterData.of(i2).toUpperCase(i2);
    }

    public static char toTitleCase(char c2) {
        return (char) toTitleCase((int) c2);
    }

    public static int toTitleCase(int i2) {
        return CharacterData.of(i2).toTitleCase(i2);
    }

    public static int digit(char c2, int i2) {
        return digit((int) c2, i2);
    }

    public static int digit(int i2, int i3) {
        return CharacterData.of(i2).digit(i2, i3);
    }
    ...
    public static int getNumericValue(int i2) {
        return CharacterData.of(i2).getNumericValue(i2);
    }
    ...
    public static boolean isSpaceChar(int i2) {
        return ((CharacterType.SPACE_MASK >> getType(i2)) & 1) != 0;
    }
    ...
    public static boolean isWhitespace(int i2) {
        return CharacterData.of(i2).isWhitespace(i2);
    }
    ...
    public static int getType(int i2) {
        return CharacterData.of(i2).getType(i2);
    }
    ...
    public static byte getDirectionality(int i2) {
        return CharacterData.of(i2).getDirectionality(i2);
    }
    ...
    public static boolean isMirrored(int i2) {
        return CharacterData.of(i2).isMirrored(i2);
    }
    ...
    static int toUpperCaseEx(int i2) {
        if ($assertionsDisabled || isValidCodePoint(i2)) {
            return CharacterData.of(i2).toUpperCaseEx(i2);
        }
        throw new AssertionError();
    }

    static char[] toUpperCaseCharArray(int i2) {
        if ($assertionsDisabled || isBmpCodePoint(i2)) {
            return CharacterData.of(i2).toUpperCaseCharArray(i2);
        }
        throw new AssertionError();
    }

    public static char reverseBytes(char c2) {
        return (char) (((c2 & 65280) >> 8) | (c2 << '\b'));
    }
    ...
    public static String getName(int i2) {
        ...
        String str = CharacterName.get(i2);
        if (str != null) {
            return str;
        }
        if (getType(i2) == 0) {
        ...
        UnicodeBlock unicodeBlockOf = UnicodeBlock.of(i2);
        if (unicodeBlockOf != null) {
            return unicodeBlockOf.toString().replace('_', ' ') + " " + Integer.toHexString(i2).toUpperCase(Locale.ENGLISH);
        }
