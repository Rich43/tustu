...
/* loaded from: rt.jar:java/nio/DirectDoubleBufferS.class */
class DirectDoubleBufferS extends DoubleBuffer implements DirectBuffer {
    ...
    DirectDoubleBufferS(DirectBuffer directBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
    ...
    public DoubleBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new DirectDoubleBufferS(this, -1, 0, i2, i2, i3);
        }
    ...
    public double get(int i2) {
        return Double.longBitsToDouble(Bits.swap(unsafe.getLong(ix(checkIndex(i2)))));
    }
    ...
    public DoubleBuffer put(double d2) {
        unsafe.putLong(ix(nextPutIndex()), Bits.swap(Double.doubleToRawLongBits(d2)));
        return this;
    }

    @Override // java.nio.DoubleBuffer
    public DoubleBuffer put(int i2, double d2) {
        unsafe.putLong(ix(checkIndex(i2)), Bits.swap(Double.doubleToRawLongBits(d2)));
        return this;
    }
    ...
    public DoubleBuffer put(DoubleBuffer doubleBuffer) {
        if (doubleBuffer instanceof DirectDoubleBufferS) {
            ...
            int iPosition = directDoubleBufferS.position();
            int iLimit = directDoubleBufferS.limit();
            if (!$assertionsDisabled && iPosition > iLimit) {
                throw new AssertionError();
            }
            int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
            ...
            unsafe.copyMemory(directDoubleBufferS.ix(iPosition), ix(iPosition2), i2 << 3);
            directDoubleBufferS.position(iPosition + i2);
