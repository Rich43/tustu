...
/* loaded from: rt.jar:java/nio/DirectShortBufferS.class */
class DirectShortBufferS extends ShortBuffer implements DirectBuffer {
    ...
    static {
        $assertionsDisabled = !DirectShortBufferS.class.desiredAssertionStatus();
        unsafe = Bits.unsafe();
    ...
    DirectShortBufferS(DirectBuffer directBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
    ...
    public ShortBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new DirectShortBufferS(this, -1, 0, i2, i2, i3);
        }
    ...
    public short get(int i2) {
        return Bits.swap(unsafe.getShort(ix(checkIndex(i2))));
    }
    ...
    public ShortBuffer put(short s2) {
        unsafe.putShort(ix(nextPutIndex()), Bits.swap(s2));
        return this;
    }

    @Override // java.nio.ShortBuffer
    public ShortBuffer put(int i2, short s2) {
        unsafe.putShort(ix(checkIndex(i2)), Bits.swap(s2));
        return this;
    }
    ...
    public ShortBuffer put(ShortBuffer shortBuffer) {
        if (shortBuffer instanceof DirectShortBufferS) {
            ...
            int iPosition = directShortBufferS.position();
            int iLimit = directShortBufferS.limit();
            if (!$assertionsDisabled && iPosition > iLimit) {
                throw new AssertionError();
            }
            int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
            ...
            unsafe.copyMemory(directShortBufferS.ix(iPosition), ix(iPosition2), i2 << 1);
            directShortBufferS.position(iPosition + i2);
