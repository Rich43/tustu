...
/* loaded from: rt.jar:java/nio/ByteBufferAsDoubleBufferL.class */
class ByteBufferAsDoubleBufferL extends DoubleBuffer {

    /* renamed from: bb, reason: collision with root package name */
    protected final ByteBuffer f12453bb;
    protected final int offset;
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !ByteBufferAsDoubleBufferL.class.desiredAssertionStatus();
    }

    ByteBufferAsDoubleBufferL(ByteBuffer byteBuffer) {
        super(-1, 0, byteBuffer.remaining() >> 3, byteBuffer.remaining() >> 3);
        this.f12453bb = byteBuffer;
    ...
    ByteBufferAsDoubleBufferL(ByteBuffer byteBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
        this.f12453bb = byteBuffer;
        this.offset = i6;
    }
    ...
    public DoubleBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new ByteBufferAsDoubleBufferL(this.f12453bb, -1, 0, i2, i2, i3);
        }
        throw new AssertionError();
    }
    ...
    public DoubleBuffer duplicate() {
        return new ByteBufferAsDoubleBufferL(this.f12453bb, markValue(), position(), limit(), capacity(), this.offset);
    }
    ...
    @Override // java.nio.DoubleBuffer
    public double get() {
        return Bits.getDoubleL(this.f12453bb, ix(nextGetIndex()));
    }

    @Override // java.nio.DoubleBuffer
    public double get(int i2) {
        return Bits.getDoubleL(this.f12453bb, ix(checkIndex(i2)));
    }

    @Override // java.nio.DoubleBuffer
    public DoubleBuffer put(double d2) {
        Bits.putDoubleL(this.f12453bb, ix(nextPutIndex()), d2);
        return this;
    }

    @Override // java.nio.DoubleBuffer
    public DoubleBuffer put(int i2, double d2) {
        Bits.putDoubleL(this.f12453bb, ix(checkIndex(i2)), d2);
        return this;
    }
    ...
    public DoubleBuffer compact() {
        ...
        int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
        ByteBuffer byteBufferDuplicate = this.f12453bb.duplicate();
