...
/* loaded from: rt.jar:java/nio/DirectIntBufferS.class */
class DirectIntBufferS extends IntBuffer implements DirectBuffer {
    ...
    DirectIntBufferS(DirectBuffer directBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
    ...
    public IntBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new DirectIntBufferS(this, -1, 0, i2, i2, i3);
        }
    ...
    public int get(int i2) {
        return Bits.swap(unsafe.getInt(ix(checkIndex(i2))));
    }
    ...
    public IntBuffer put(int i2) {
        unsafe.putInt(ix(nextPutIndex()), Bits.swap(i2));
        return this;
    }

    @Override // java.nio.IntBuffer
    public IntBuffer put(int i2, int i3) {
        unsafe.putInt(ix(checkIndex(i2)), Bits.swap(i3));
        return this;
    }
    ...
    public IntBuffer put(IntBuffer intBuffer) {
        if (intBuffer instanceof DirectIntBufferS) {
            ...
            int iPosition = directIntBufferS.position();
            int iLimit = directIntBufferS.limit();
            if (!$assertionsDisabled && iPosition > iLimit) {
                throw new AssertionError();
            }
            int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
            ...
            unsafe.copyMemory(directIntBufferS.ix(iPosition), ix(iPosition2), i2 << 2);
            directIntBufferS.position(iPosition + i2);
