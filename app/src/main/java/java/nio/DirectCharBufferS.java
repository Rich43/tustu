...
/* loaded from: rt.jar:java/nio/DirectCharBufferS.class */
class DirectCharBufferS extends CharBuffer implements DirectBuffer {
    ...
    DirectCharBufferS(DirectBuffer directBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
    ...
    public CharBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new DirectCharBufferS(this, -1, 0, i2, i2, i3);
        }
    ...
    public char get(int i2) {
        return Bits.swap(unsafe.getChar(ix(checkIndex(i2))));
    }

    @Override // java.nio.CharBuffer
    char getUnchecked(int i2) {
        return Bits.swap(unsafe.getChar(ix(i2)));
    }
    ...
    public CharBuffer put(char c2) {
        unsafe.putChar(ix(nextPutIndex()), Bits.swap(c2));
        return this;
    }

    @Override // java.nio.CharBuffer
    public CharBuffer put(int i2, char c2) {
        unsafe.putChar(ix(checkIndex(i2)), Bits.swap(c2));
        return this;
    }
    ...
    public CharBuffer put(CharBuffer charBuffer) {
        if (charBuffer instanceof DirectCharBufferS) {
            ...
            int iPosition = directCharBufferS.position();
            int iLimit = directCharBufferS.limit();
            if (!$assertionsDisabled && iPosition > iLimit) {
                throw new AssertionError();
            }
            int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
            ...
            unsafe.copyMemory(directCharBufferS.ix(iPosition), ix(iPosition2), i2 << 1);
            directCharBufferS.position(iPosition + i2);
    ...
    public CharBuffer subSequence(int i2, int i3) {
        ...
        return new DirectCharBufferS(this, -1, i4 + i2, i4 + i3, capacity(), this.offset);
    }
