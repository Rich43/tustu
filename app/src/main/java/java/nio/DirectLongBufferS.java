...
/* loaded from: rt.jar:java/nio/DirectLongBufferS.class */
class DirectLongBufferS extends LongBuffer implements DirectBuffer {
    ...
    DirectLongBufferS(DirectBuffer directBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
    ...
    public LongBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new DirectLongBufferS(this, -1, 0, i2, i2, i3);
        }
    ...
    public long get(int i2) {
        return Bits.swap(unsafe.getLong(ix(checkIndex(i2))));
    }
    ...
    public LongBuffer put(long j2) {
        unsafe.putLong(ix(nextPutIndex()), Bits.swap(j2));
        return this;
    }

    @Override // java.nio.LongBuffer
    public LongBuffer put(int i2, long j2) {
        unsafe.putLong(ix(checkIndex(i2)), Bits.swap(j2));
        return this;
    }
    ...
    public LongBuffer put(LongBuffer longBuffer) {
        if (longBuffer instanceof DirectLongBufferS) {
            ...
            int iPosition = directLongBufferS.position();
            int iLimit = directLongBufferS.limit();
            if (!$assertionsDisabled && iPosition > iLimit) {
                throw new AssertionError();
            }
            int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
            ...
            unsafe.copyMemory(directLongBufferS.ix(iPosition), ix(iPosition2), i2 << 3);
            directLongBufferS.position(iPosition + i2);
