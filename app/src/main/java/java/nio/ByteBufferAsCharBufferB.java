...
/* loaded from: rt.jar:java/nio/ByteBufferAsCharBufferB.class */
class ByteBufferAsCharBufferB extends CharBuffer {

    /* renamed from: bb, reason: collision with root package name */
    protected final ByteBuffer f12450bb;
    protected final int offset;
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !ByteBufferAsCharBufferB.class.desiredAssertionStatus();
    }

    ByteBufferAsCharBufferB(ByteBuffer byteBuffer) {
        super(-1, 0, byteBuffer.remaining() >> 1, byteBuffer.remaining() >> 1);
        this.f12450bb = byteBuffer;
    ...
    ByteBufferAsCharBufferB(ByteBuffer byteBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
        this.f12450bb = byteBuffer;
        this.offset = i6;
    }
    ...
    public CharBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new ByteBufferAsCharBufferB(this.f12450bb, -1, 0, i2, i2, i3);
        }
        throw new AssertionError();
    }
    ...
    public CharBuffer duplicate() {
        return new ByteBufferAsCharBufferB(this.f12450bb, markValue(), position(), limit(), capacity(), this.offset);
    }
    ...
    @Override // java.nio.CharBuffer
    public char get() {
        return Bits.getCharB(this.f12450bb, ix(nextGetIndex()));
    }

    @Override // java.nio.CharBuffer
    public char get(int i2) {
        return Bits.getCharB(this.f12450bb, ix(checkIndex(i2)));
    }

    @Override // java.nio.CharBuffer
    char getUnchecked(int i2) {
        return Bits.getCharB(this.f12450bb, ix(i2));
    }

    @Override // java.nio.CharBuffer
    public CharBuffer put(char c2) {
        Bits.putCharB(this.f12450bb, ix(nextPutIndex()), c2);
        return this;
    }

    @Override // java.nio.CharBuffer
    public CharBuffer put(int i2, char c2) {
        Bits.putCharB(this.f12450bb, ix(checkIndex(i2)), c2);
        return this;
    }
    ...
    public CharBuffer compact() {
        ...
        int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
        ByteBuffer byteBufferDuplicate = this.f12450bb.duplicate();
    ...
    public CharBuffer subSequence(int i2, int i3) {
        ...
        return new ByteBufferAsCharBufferB(this.f12450bb, -1, i4 + i2, i4 + i3, capacity(), this.offset);
    }
