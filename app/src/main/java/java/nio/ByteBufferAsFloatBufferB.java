...
/* loaded from: rt.jar:java/nio/ByteBufferAsFloatBufferB.class */
class ByteBufferAsFloatBufferB extends FloatBuffer {

    /* renamed from: bb, reason: collision with root package name */
    protected final ByteBuffer f12454bb;
    protected final int offset;
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !ByteBufferAsFloatBufferB.class.desiredAssertionStatus();
    }

    ByteBufferAsFloatBufferB(ByteBuffer byteBuffer) {
        super(-1, 0, byteBuffer.remaining() >> 2, byteBuffer.remaining() >> 2);
        this.f12454bb = byteBuffer;
    ...
    ByteBufferAsFloatBufferB(ByteBuffer byteBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
        this.f12454bb = byteBuffer;
        this.offset = i6;
    }
    ...
    public FloatBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new ByteBufferAsFloatBufferB(this.f12454bb, -1, 0, i2, i2, i3);
        }
        throw new AssertionError();
    }
    ...
    public FloatBuffer duplicate() {
        return new ByteBufferAsFloatBufferB(this.f12454bb, markValue(), position(), limit(), capacity(), this.offset);
    }
    ...
    @Override // java.nio.FloatBuffer
    public float get() {
        return Bits.getFloatB(this.f12454bb, ix(nextGetIndex()));
    }

    @Override // java.nio.FloatBuffer
    public float get(int i2) {
        return Bits.getFloatB(this.f12454bb, ix(checkIndex(i2)));
    }

    @Override // java.nio.FloatBuffer
    public FloatBuffer put(float f2) {
        Bits.putFloatB(this.f12454bb, ix(nextPutIndex()), f2);
        return this;
    }

    @Override // java.nio.FloatBuffer
    public FloatBuffer put(int i2, float f2) {
        Bits.putFloatB(this.f12454bb, ix(checkIndex(i2)), f2);
        return this;
    }
    ...
    public FloatBuffer compact() {
        ...
        int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
        ByteBuffer byteBufferDuplicate = this.f12454bb.duplicate();
