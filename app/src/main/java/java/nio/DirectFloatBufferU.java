...
/* loaded from: rt.jar:java/nio/DirectFloatBufferU.class */
class DirectFloatBufferU extends FloatBuffer implements DirectBuffer {
    ...
    static {
        $assertionsDisabled = !DirectFloatBufferU.class.desiredAssertionStatus();
        unsafe = Bits.unsafe();
    ...
    DirectFloatBufferU(DirectBuffer directBuffer, int i2, int i3, int i4, int i5, int i6) {
        super(i2, i3, i4, i5);
    ...
    public FloatBuffer slice() {
        ...
        if ($assertionsDisabled || i3 >= 0) {
            return new DirectFloatBufferU(this, -1, 0, i2, i2, i3);
        }
    ...
    public float get(int i2) {
        return unsafe.getFloat(ix(checkIndex(i2)));
    }
    ...
    public FloatBuffer put(float f2) {
        unsafe.putFloat(ix(nextPutIndex()), f2);
        return this;
    }

    @Override // java.nio.FloatBuffer
    public FloatBuffer put(int i2, float f2) {
        unsafe.putFloat(ix(checkIndex(i2)), f2);
        return this;
    }
    ...
    public FloatBuffer put(FloatBuffer floatBuffer) {
        if (floatBuffer instanceof DirectFloatBufferU) {
            ...
            int iPosition = directFloatBufferU.position();
            int iLimit = directFloatBufferU.limit();
            if (!$assertionsDisabled && iPosition > iLimit) {
                throw new AssertionError();
            }
            int i2 = iPosition <= iLimit ? iLimit - iPosition : 0;
            ...
            unsafe.copyMemory(directFloatBufferU.ix(iPosition), ix(iPosition2), i2 << 2);
            directFloatBufferU.position(iPosition + i2);
