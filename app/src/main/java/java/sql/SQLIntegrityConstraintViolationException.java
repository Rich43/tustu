...
/* loaded from: rt.jar:java/sql/SQLIntegrityConstraintViolationException.class */
public class SQLIntegrityConstraintViolationException extends SQLNonTransientException {
    ...
    public SQLIntegrityConstraintViolationException(String str, String str2, int i2) {
        super(str, str2, i2);
    }
    ...
    public SQLIntegrityConstraintViolationException(String str, String str2, int i2, Throwable th) {
