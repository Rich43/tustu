...
/* loaded from: rt.jar:java/sql/SQLTransactionRollbackException.class */
public class SQLTransactionRollbackException extends SQLTransientException {
    ...
    public SQLTransactionRollbackException(String str, String str2, int i2) {
        super(str, str2, i2);
    }
    ...
    public SQLTransactionRollbackException(String str, String str2, int i2, Throwable th) {
