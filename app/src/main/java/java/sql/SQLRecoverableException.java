...
/* loaded from: rt.jar:java/sql/SQLRecoverableException.class */
public class SQLRecoverableException extends SQLException {
    ...
    public SQLRecoverableException(String str, String str2, int i2) {
        super(str, str2, i2);
    }
    ...
    public SQLRecoverableException(String str, String str2, int i2, Throwable th) {
