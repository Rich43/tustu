...
/* loaded from: rt.jar:java/sql/DatabaseMetaData.class */
public interface DatabaseMetaData extends Wrapper {
    ...
    boolean supportsConvert(int i2, int i3) throws SQLException;
    ...
    boolean supportsTransactionIsolationLevel(int i2) throws SQLException;
    ...
    ResultSet getBestRowIdentifier(String str, String str2, String str3, int i2, boolean z2) throws SQLException;
    ...
    ResultSet getIndexInfo(String str, String str2, String str3, boolean z2, boolean z3) throws SQLException;

    boolean supportsResultSetType(int i2) throws SQLException;

    boolean supportsResultSetConcurrency(int i2, int i3) throws SQLException;

    boolean ownUpdatesAreVisible(int i2) throws SQLException;

    boolean ownDeletesAreVisible(int i2) throws SQLException;

    boolean ownInsertsAreVisible(int i2) throws SQLException;

    boolean othersUpdatesAreVisible(int i2) throws SQLException;

    boolean othersDeletesAreVisible(int i2) throws SQLException;

    boolean othersInsertsAreVisible(int i2) throws SQLException;

    boolean updatesAreDetected(int i2) throws SQLException;

    boolean deletesAreDetected(int i2) throws SQLException;

    boolean insertsAreDetected(int i2) throws SQLException;
    ...
    boolean supportsResultSetHoldability(int i2) throws SQLException;
