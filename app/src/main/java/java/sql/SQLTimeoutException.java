...
/* loaded from: rt.jar:java/sql/SQLTimeoutException.class */
public class SQLTimeoutException extends SQLTransientException {
    ...
    public SQLTimeoutException(String str, String str2, int i2) {
        super(str, str2, i2);
    }
    ...
    public SQLTimeoutException(String str, String str2, int i2, Throwable th) {
