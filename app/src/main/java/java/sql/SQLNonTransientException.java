...
/* loaded from: rt.jar:java/sql/SQLNonTransientException.class */
public class SQLNonTransientException extends SQLException {
    ...
    public SQLNonTransientException(String str, String str2, int i2) {
        super(str, str2, i2);
    }
    ...
    public SQLNonTransientException(String str, String str2, int i2, Throwable th) {
