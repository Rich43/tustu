...
/* loaded from: rt.jar:java/sql/SQLTransientConnectionException.class */
public class SQLTransientConnectionException extends SQLTransientException {
    ...
    public SQLTransientConnectionException(String str, String str2, int i2) {
        super(str, str2, i2);
    }
    ...
    public SQLTransientConnectionException(String str, String str2, int i2, Throwable th) {
