...
/* loaded from: rt.jar:java/awt/GridBagConstraints.class */
public class GridBagConstraints implements Cloneable, Serializable {
    ...
    public GridBagConstraints(int i2, int i3, int i4, int i5, double d2, double d3, int i6, int i7, Insets insets, int i8, int i9) {
        this.gridx = i2;
        this.gridy = i3;
        this.gridwidth = i4;
        this.gridheight = i5;
