...
/*  JADX ERROR: NullPointerException in pass: ClassModifier
    ...
    */
/* loaded from: rt.jar:java/awt/event/KeyEvent.class */
public class KeyEvent extends InputEvent {
    ...
    /*  JADX ERROR: Failed to decode insn: 0x0002: MOVE_MULTI
        ...
        */
    static /* synthetic */ long access$002(java.awt.event.KeyEvent r6, long r7) {
        /*
            r0 = r6
            r1 = r7
            ...
            return r-1
        */
        throw new UnsupportedOperationException("Method not decompiled: java.awt.event.KeyEvent.access$002(java.awt.event.KeyEvent, long):long");
    }
    ...
    /*  JADX ERROR: Failed to decode insn: 0x0002: MOVE_MULTI
        java.lang.ArrayIndexOutOfBoundsException: arraycopy: source index -1 out of bounds for object array[6]
        	...
        	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
        */
    static /* synthetic */ long access$102(java.awt.event.KeyEvent r6, long r7) {
        /*
            r0 = r6
            r1 = r7
            // decode failed: arraycopy: source index -1 out of bounds for object array[6]
            r0.primaryLevelUnicode = r1
            return r-1
        */
        throw new UnsupportedOperationException("Method not decompiled: java.awt.event.KeyEvent.access$102(java.awt.event.KeyEvent, long):long");
    }
    ...
    /*  JADX ERROR: Failed to decode insn: 0x0002: MOVE_MULTI
        java.lang.ArrayIndexOutOfBoundsException: arraycopy: source index -1 out of bounds for object array[6]
        	...
        	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
        */
    static /* synthetic */ long access$202(java.awt.event.KeyEvent r6, long r7) {
        /*
            r0 = r6
            r1 = r7
            // decode failed: arraycopy: source index -1 out of bounds for object array[6]
            r0.extendedKeyCode = r1
            return r-1
        */
        throw new UnsupportedOperationException("Method not decompiled: java.awt.event.KeyEvent.access$202(java.awt.event.KeyEvent, long):long");
    }
    ...
    static {
        ...
        AWTAccessor.setKeyEventAccessor(new AWTAccessor.KeyEventAccessor() { // from class: java.awt.event.KeyEvent.1
            /* JADX WARN: Failed to check method for inline after forced processjava.awt.event.KeyEvent.access$002(java.awt.event.KeyEvent, long):long */
            @Override // sun.awt.AWTAccessor.KeyEventAccessor
            public void setRawCode(KeyEvent keyEvent, long j2) {
                KeyEvent.access$002(keyEvent, j2);
            }

            /* JADX WARN: Failed to check method for inline after forced processjava.awt.event.KeyEvent.access$102(java.awt.event.KeyEvent, long):long */
            @Override // sun.awt.AWTAccessor.KeyEventAccessor
            public void setPrimaryLevelUnicode(KeyEvent keyEvent, long j2) {
                KeyEvent.access$102(keyEvent, j2);
            }

            /* JADX WARN: Failed to check method for inline after forced processjava.awt.event.KeyEvent.access$202(java.awt.event.KeyEvent, long):long */
            @Override // sun.awt.AWTAccessor.KeyEventAccessor
            public void setExtendedKeyCode(KeyEvent keyEvent, long j2) {
                KeyEvent.access$202(keyEvent, j2);
            }

            @Override // sun.awt.AWTAccessor.KeyEventAccessor
            public Component getOriginalSource(KeyEvent keyEvent) {
                return keyEvent.originalSource;
            }
        });
    }

    private KeyEvent(Component component, int i2, long j2, int i3, int i4, char c2, int i5, boolean z2) {
        this(component, i2, j2, i3, i4, c2, i5);
        this.isProxyActive = z2;
    }

    public KeyEvent(Component component, int i2, long j2, int i3, int i4, char c2, int i5) {
    ...
    public KeyEvent(Component component, int i2, long j2, int i3, int i4, char c2) {
        this(component, i2, j2, i3, i4, c2, 0);
    }

    @Deprecated
    public KeyEvent(Component component, int i2, long j2, int i3, int i4) {
        this(component, i2, j2, i3, i4, (char) i4);
    }
    ...
    public void setKeyChar(char c2) {
        this.keyChar = c2;
    }
    ...
    public static String getKeyText(int i2) {
        if ((i2 >= 48 && i2 <= 57) || (i2 >= 65 && i2 <= 90)) {
        ...
        switch (i2) {
            ...
            case 30:
                return Toolkit.getProperty("AWT.accept", XIncludeHandler.HTTP_ACCEPT);
            case 31:
            ...
            case VK_INPUT_METHOD_ON_OFF /* 263 */:
            ...
            default:
                if (i2 >= 96 && i2 <= 105) {
                    return Toolkit.getProperty("AWT.numpad", "NumPad") + LanguageTag.SEP + ((char) ((i2 - 96) + 48));
                }
                if ((i2 & 16777216) != 0) {
                    return String.valueOf((char) (i2 ^ 16777216));
                }
                return Toolkit.getProperty("AWT.unknown", "Unknown") + " keyCode: 0x" + Integer.toString(i2, 16);
        }
    }

    public static String getKeyModifiersText(int i2) {
    ...
    public String paramString() {
        ...
        switch (this.keyChar) {
            ...
            case 65535:
                ...
                break;
            default:
                sb.append(PdfOps.SINGLE_QUOTE_TOKEN).append(this.keyChar).append(PdfOps.SINGLE_QUOTE_TOKEN);
                break;
        }
        if (getModifiers() != 0) {
        ...
        if (getModifiersEx() != 0) {
            sb.append(",extModifiers=").append(getModifiersExText(this.modifiers));
        }
    ...
    public static int getExtendedKeyCodeForChar(int i2) {
        return ExtendedKeyCodes.getExtendedKeyCodeForChar(i2);
    }
