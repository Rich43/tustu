...
/* loaded from: rt.jar:java/awt/geom/Arc2D.class */
public abstract class Arc2D extends RectangularShape {
    ...
    public abstract void setArc(double d2, double d3, double d4, double d5, double d6, double d7, int i2);

    public abstract void setAngleStart(double d2);

    public abstract void setAngleExtent(double d2);

    protected abstract Rectangle2D makeBounds(double d2, double d3, double d4, double d5);

    /* loaded from: rt.jar:java/awt/geom/Arc2D$Float.class */
    public static class Float extends Arc2D implements Serializable {

        /* renamed from: x, reason: collision with root package name */
        public float f12380x;

        /* renamed from: y, reason: collision with root package name */
        public float f12381y;
        public float width;
        public float height;
        public float start;
        public float extent;
        ...
        public Float(Rectangle2D rectangle2D, float f2, float f3, int i2) {
            super(i2);
            this.f12380x = (float) rectangle2D.getX();
            this.f12381y = (float) rectangle2D.getY();
        ...
        @Override // java.awt.geom.Arc2D
        public void setArc(double d2, double d3, double d4, double d5, double d6, double d7, int i2) {
            setArcType(i2);
            this.f12380x = (float) d2;
            this.f12381y = (float) d3;
            this.width = (float) d4;
    ...
    /* loaded from: rt.jar:java/awt/geom/Arc2D$Double.class */
    public static class Double extends Arc2D implements Serializable {

        /* renamed from: x, reason: collision with root package name */
        public double f12378x;

        /* renamed from: y, reason: collision with root package name */
        public double f12379y;
        public double width;
        ...
        public Double(double d2, double d3, double d4, double d5, double d6, double d7, int i2) {
            super(i2);
            this.f12378x = d2;
            this.f12379y = d3;
            this.width = d4;
        ...
        public Double(Rectangle2D rectangle2D, double d2, double d3, int i2) {
            super(i2);
            this.f12378x = rectangle2D.getX();
            this.f12379y = rectangle2D.getY();
    ...
    public void setArc(Point2D point2D, Dimension2D dimension2D, double d2, double d3, int i2) {
        setArc(point2D.getX(), point2D.getY(), dimension2D.getWidth(), dimension2D.getHeight(), d2, d3, i2);
    }

    public void setArc(Rectangle2D rectangle2D, double d2, double d3, int i2) {
        setArc(rectangle2D.getX(), rectangle2D.getY(), rectangle2D.getWidth(), rectangle2D.getHeight(), d2, d3, i2);
    }
    ...
    public void setArcByCenter(double d2, double d3, double d4, double d5, double d6, int i2) {
        setArc(d2 - d4, d3 - d4, d4 * 2.0d, d4 * 2.0d, d5, d6, i2);
    }
    ...
    public void setArcByTangent(Point2D point2D, Point2D point2D2, Point2D point2D3, double d2) {
        ...
        double d4;
        double d5;
        double dAtan2 = Math.atan2(point2D.getY() - point2D2.getY(), point2D.getX() - point2D2.getX());
        double dAtan22 = Math.atan2(point2D3.getY() - point2D2.getY(), point2D3.getX() - point2D2.getX());
        double d6 = dAtan22 - dAtan2;
        if (d6 > 3.141592653589793d) {
            dAtan22 -= 6.283185307179586d;
        } else if (d6 < -3.141592653589793d) {
            dAtan22 += 6.283185307179586d;
        }
        double d7 = (dAtan2 + dAtan22) / 2.0d;
        double dSin = d2 / Math.sin(Math.abs(dAtan22 - d7));
        double x2 = point2D2.getX() + (dSin * Math.cos(d7));
        double y2 = point2D2.getY() + (dSin * Math.sin(d7));
        if (dAtan2 < dAtan22) {
            d3 = dAtan2 - 1.5707963267948966d;
            d4 = dAtan22 + 1.5707963267948966d;
        } else {
            d3 = dAtan2 + 1.5707963267948966d;
            d4 = dAtan22 - 1.5707963267948966d;
        }
        double degrees = Math.toDegrees(-d3);
        double degrees2 = Math.toDegrees(-d4) - degrees;
        if (degrees2 < 0.0d) {
            d5 = degrees2 + 360.0d;
        } else {
            d5 = degrees2 - 360.0d;
        }
        setArcByCenter(x2, y2, d2, degrees, d5, this.type);
    }
    ...
    public void setAngles(double d2, double d3, double d4, double d5) {
        ...
        double dAtan2 = Math.atan2(width * (centerY - d3), height * (d2 - centerX));
        double dAtan22 = Math.atan2(width * (centerY - d5), height * (d4 - centerX)) - dAtan2;
        if (dAtan22 <= 0.0d) {
            dAtan22 += 6.283185307179586d;
        }
        setAngleStart(Math.toDegrees(dAtan2));
        setAngleExtent(Math.toDegrees(dAtan22));
    }
    ...
    public void setFrame(double d2, double d3, double d4, double d5) {
        setArc(d2, d3, d4, d5, getAngleStart(), getAngleExtent(), this.type);
    }
    ...
    java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "changeArg" is null
    	...
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.lambda$runTypePropagation$0(TypeInferenceVisitor.java:100)
    	at java.base/java.util.ArrayList.forEach(Unknown Source)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.runTypePropagation(TypeInferenceVisitor.java:100)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.visit(TypeInferenceVisitor.java:75)
     */
    /* JADX WARN: Not initialized variable reg: 2, insn: MOVE (r0 I:??) = (r2 I:??), block:B:8:0x0024 */
    /* JADX WARN: Not initialized variable reg: 2, insn: MOVE (r0 I:??) = (r2 I:??), block:B:9:0x0031 */
    ...
    public java.awt.geom.Rectangle2D getBounds2D() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: java.awt.geom.Arc2D.getBounds2D():java.awt.geom.Rectangle2D");
    }
    ...
    static double normalizeDegrees(double d2) {
        if (d2 > 180.0d) {
            if (d2 <= 540.0d) {
                ...
                d2 = Math.IEEEremainder(d2, 360.0d);
                if (d2 == -180.0d) {
                    d2 = 180.0d;
                }
            }
    ...
    public boolean containsAngle(double d2) {
        ...
        double dNormalizeDegrees = normalizeDegrees(d2) - normalizeDegrees(getAngleStart());
        if (z2) {
            dNormalizeDegrees = -dNormalizeDegrees;
        }
        if (dNormalizeDegrees < 0.0d) {
            dNormalizeDegrees += 360.0d;
        }
        return dNormalizeDegrees >= 0.0d && dNormalizeDegrees < angleExtent;
    }
    ...
    public boolean contains(double d2, double d3) {
        ...
        if ((x2 * x2) + (y2 * y2) >= 0.25d) {
            return false;
        }
        double dAbs = Math.abs(getAngleExtent());
        if (dAbs >= 360.0d) {
            return true;
        }
        boolean zContainsAngle = containsAngle(-Math.toDegrees(Math.atan2(y2, x2)));
        if (this.type == 2) {
            return zContainsAngle;
        }
        if (zContainsAngle) {
            if (dAbs >= 180.0d) {
                return true;
        ...
        boolean z2 = Line2D.relativeCCW(dCos, dSin, dCos2, dSin2, 2.0d * x2, 2.0d * y2) * Line2D.relativeCCW(dCos, dSin, dCos2, dSin2, 0.0d, 0.0d) >= 0;
        return zContainsAngle ? !z2 : z2;
    }
    ...
    public boolean intersects(double d2, double d3, double d4, double d5) {
        double width = getWidth();
        double height = getHeight();
        if (d4 <= 0.0d || d5 <= 0.0d || width <= 0.0d || height <= 0.0d) {
            return false;
        }
        double angleExtent = getAngleExtent();
        if (angleExtent == 0.0d) {
        ...
        double y3 = startPoint.getY();
        double x4 = endPoint.getX();
        double y4 = endPoint.getY();
        if (centerY >= d3 && centerY <= d9) {
            if (x3 >= d8 || x4 >= d8 || centerX >= d8 || d6 <= d2 || !containsAngle(0.0d)) {
                if (x3 > d2 && x4 > d2 && centerX > d2 && x2 < d8 && containsAngle(180.0d)) {
                    return true;
                }
            } else {
                return true;
        ...
        if (centerX >= d2 && centerX <= d8) {
            if (y3 <= d3 || y4 <= d3 || centerY <= d3 || y2 >= d9 || !containsAngle(90.0d)) {
                if (y3 < d9 && y4 < d9 && centerY < d9 && d7 > d3 && containsAngle(270.0d)) {
                    return true;
                }
            } else {
                return true;
        ...
        Rectangle2D.Double r0 = new Rectangle2D.Double(d2, d3, d4, d5);
        if (this.type == 2 || Math.abs(angleExtent) > 180.0d) {
            if (r0.intersectsLine(centerX, centerY, x3, y3) || r0.intersectsLine(centerX, centerY, x4, y4)) {
                return true;
            }
        } else if (r0.intersectsLine(x3, y3, x4, y4)) {
            return true;
        }
    ...
    public boolean contains(double d2, double d3, double d4, double d5) {
        return contains(d2, d3, d4, d5, null);
    }
    ...
    private boolean contains(double d2, double d3, double d4, double d5, Rectangle2D rectangle2D) {
        ...
        double x2 = getX() + width;
        double y2 = getY() + height;
        double radians = Math.toRadians(-getAngleStart());
        if (rectangle2D.intersectsLine(x2, y2, x2 + (width * Math.cos(radians)), y2 + (height * Math.sin(radians)))) {
            return false;
        }
        double radians2 = radians + Math.toRadians(-getAngleExtent());
        return !rectangle2D.intersectsLine(x2, y2, x2 + (width * Math.cos(radians2)), y2 + (height * Math.sin(radians2)));
    }
    ...
    public int hashCode() {
        long jDoubleToLongBits = java.lang.Double.doubleToLongBits(getX()) + (java.lang.Double.doubleToLongBits(getY()) * 37) + (java.lang.Double.doubleToLongBits(getWidth()) * 43) + (java.lang.Double.doubleToLongBits(getHeight()) * 47) + (java.lang.Double.doubleToLongBits(getAngleStart()) * 53) + (java.lang.Double.doubleToLongBits(getAngleExtent()) * 59) + (getArcType() * 61);
