...
/* loaded from: rt.jar:java/awt/font/OpenType.class */
public interface OpenType {
    ...
    byte[] getFontTable(int i2);

    byte[] getFontTable(String str);

    byte[] getFontTable(int i2, int i3, int i4);

    byte[] getFontTable(String str, int i2, int i3);

    int getFontTableSize(int i2);
