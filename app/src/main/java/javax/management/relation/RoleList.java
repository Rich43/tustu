...
/* loaded from: rt.jar:javax/management/relation/RoleList.class */
public class RoleList extends ArrayList<Object> {
    ...
    public void add(int i2, Role role) throws IndexOutOfBoundsException, IllegalArgumentException {
        if (role == null) {
            throw new IllegalArgumentException("Invalid parameter");
        }
        super.add(i2, (int) role);
    }

    public void set(int i2, Role role) throws IndexOutOfBoundsException, IllegalArgumentException {
        if (role == null) {
            throw new IllegalArgumentException("Invalid parameter.");
        }
        super.set(i2, (int) role);
    }
    ...
    public boolean addAll(int i2, RoleList roleList) throws IndexOutOfBoundsException, IllegalArgumentException {
        if (roleList == null) {
            throw new IllegalArgumentException("Invalid parameter.");
        }
        return super.addAll(i2, (Collection) roleList);
    }
