...
/* loaded from: rt.jar:javax/print/attribute/standard/PrinterInfo.class */
public final class PrinterInfo extends TextSyntax implements PrintServiceAttribute {
    ...
    public PrinterInfo(String str, Locale locale) {
        super(str, locale);
    }

    @Override // javax.print.attribute.TextSyntax
    public boolean equals(Object obj) {
        return super.equals(obj) && (obj instanceof PrinterInfo);
    }
