...
/* loaded from: rt.jar:javax/print/ServiceUIFactory.class */
public abstract class ServiceUIFactory {
    ...
    public abstract Object getUI(int i2, String str);

    public abstract String[] getUIClassNamesForRole(int i2);
}
