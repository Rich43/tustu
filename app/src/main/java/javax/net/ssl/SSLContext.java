...
/* loaded from: rt.jar:javax/net/ssl/SSLContext.class */
public class SSLContext {
    ...
    public static synchronized SSLContext getDefault() throws NoSuchAlgorithmException {
        if (defaultContext == null) {
            defaultContext = getInstance(Action.DEFAULT);
        }
    ...
    public final SSLEngine createSSLEngine(String str, int i2) {
        try {
            return this.contextSpi.engineCreateSSLEngine(str, i2);
        } catch (AbstractMethodError e2) {
