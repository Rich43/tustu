...
/* loaded from: rt.jar:javax/rmi/CORBA/GetORBPropertiesFileAction.class */
class GetORBPropertiesFileAction implements PrivilegedAction {
    private boolean debug = false;

    private String getSystemProperty(final String str) {
        return (String) AccessController.doPrivileged(new PrivilegedAction() { // from class: javax.rmi.CORBA.GetORBPropertiesFileAction.1
