...
/* loaded from: rt.jar:javax/swing/plaf/synth/SynthRadioButtonUI.class */
public class SynthRadioButtonUI extends SynthToggleButtonUI {
    ...
    @Override // javax.swing.plaf.synth.SynthToggleButtonUI, javax.swing.plaf.synth.SynthButtonUI, javax.swing.plaf.synth.SynthUI
    public void paintBorder(SynthContext synthContext, Graphics graphics, int i2, int i3, int i4, int i5) {
        synthContext.getPainter().paintRadioButtonBorder(synthContext, graphics, i2, i3, i4, i5);
    }
}
