...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/DesktopPanePainter.class */
final class DesktopPanePainter extends AbstractRegionPainter {
    ...
    public DesktopPanePainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    private Paint decodeGradient1(Shape shape) {
        ...
        return decodeGradient((0.25f * width) + x2, (0.0f * height) + y2, (0.75f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color1, decodeColor(this.color1, this.color2, 0.5f), this.color2});
    }
    ...
    private Paint decodeGradient2(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.9567308f * width) + x2, (0.06835443f * height) + y2, (0.75f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color3, decodeColor(this.color3, this.color4, 0.5f), this.color4});
    }
    ...
    private Paint decodeGradient3(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.25f * width) + x2, (0.0f * height) + y2, (0.83536583f * width) + x2, (0.9522059f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color6, decodeColor(this.color6, this.color7, 0.5f), this.color7});
    }
    ...
    private Paint decodeGradient4(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.8659696f * width) + x2, (0.011049724f * height) + y2, (0.24809887f * width) + x2, (0.95027626f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color6, decodeColor(this.color6, this.color8, 0.5f), this.color8});
    }
    ...
    private Paint decodeGradient5(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.3511236f * width) + x2, (0.09326425f * height) + y2, (0.33426967f * width) + x2, (0.9846154f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color9, decodeColor(this.color9, this.color10, 0.5f), this.color10});
    }
    ...
    private Paint decodeGradient6(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.3548387f * width) + x2, (0.114285715f * height) + y2, (0.48387095f * width) + x2, (0.9809524f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color11, decodeColor(this.color11, this.color4, 0.5f), this.color4});
    }
    ...
    private Paint decodeGradient7(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.25f * width) + x2, (0.0f * height) + y2, (0.75f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color1, decodeColor(this.color1, this.color12, 0.5f), this.color12});
    }
    ...
    private Paint decodeGradient8(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.25f * width) + x2, (0.0f * height) + y2, (0.75f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color13, decodeColor(this.color13, this.color14, 0.5f), this.color14});
    }
}
