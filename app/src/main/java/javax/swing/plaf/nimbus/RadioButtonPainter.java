...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/RadioButtonPainter.class */
final class RadioButtonPainter extends AbstractRegionPainter {
    ...
    private Color color7 = decodeColor("nimbusBlueGrey", 0.0f, 0.0f, 0.0f, ClassFileConstants.opc_d2f);
    ...
    public RadioButtonPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    private void painticonSelected(Graphics2D graphics2D) {
        ...
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse1();
        graphics2D.setPaint(decodeGradient9(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse2();
        graphics2D.setPaint(decodeGradient10(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse5();
        graphics2D.setPaint(decodeGradient11(this.ellipse));
        graphics2D.fill(this.ellipse);
    }
    ...
    private void painticonPressedAndSelected(Graphics2D graphics2D) {
        ...
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse1();
        graphics2D.setPaint(decodeGradient12(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse2();
        graphics2D.setPaint(decodeGradient13(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse5();
        graphics2D.setPaint(decodeGradient14(this.ellipse));
        graphics2D.fill(this.ellipse);
    }
    ...
    private void painticonMouseOverAndSelected(Graphics2D graphics2D) {
        ...
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse1();
        graphics2D.setPaint(decodeGradient15(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse2();
        graphics2D.setPaint(decodeGradient16(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse5();
        graphics2D.setPaint(decodeGradient11(this.ellipse));
        graphics2D.fill(this.ellipse);
    ...
    private void painticonDisabledAndSelected(Graphics2D graphics2D) {
        this.ellipse = decodeEllipse1();
        graphics2D.setPaint(decodeGradient17(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse2();
        graphics2D.setPaint(decodeGradient18(this.ellipse));
        graphics2D.fill(this.ellipse);
        this.ellipse = decodeEllipse5();
        graphics2D.setPaint(decodeGradient19(this.ellipse));
        graphics2D.fill(this.ellipse);
    }
    ...
    private Paint decodeGradient1(Shape shape) {
        ...
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color1, decodeColor(this.color1, this.color2, 0.5f), this.color2});
    }
    ...
    private Paint decodeGradient3(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color8, decodeColor(this.color8, this.color9, 0.5f), this.color9});
    }
    ...
    private Paint decodeGradient4(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49754903f * width) + x2, (0.004901961f * height) + y2, (0.50735295f * width) + x2, (1.0f * height) + y2, new float[]{0.06344411f, 0.25009555f, 0.43674698f, 0.48042166f, 0.52409637f, 0.70481926f, 0.88554215f}, new Color[]{this.color10, decodeColor(this.color10, this.color4, 0.5f), this.color4, decodeColor(this.color4, this.color4, 0.5f), this.color4, decodeColor(this.color4, this.color11, 0.5f), this.color11});
    }
    ...
    private Paint decodeGradient5(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color13, decodeColor(this.color13, this.color14, 0.5f), this.color14});
    }
    ...
    private Paint decodeGradient7(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color20, decodeColor(this.color20, this.color21, 0.5f), this.color21});
    }
    ...
    private Paint decodeGradient8(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49754903f * width) + x2, (0.004901961f * height) + y2, (0.50735295f * width) + x2, (1.0f * height) + y2, new float[]{0.06344411f, 0.20792687f, 0.35240963f, 0.45030123f, 0.5481928f, 0.748494f, 0.9487952f}, new Color[]{this.color22, decodeColor(this.color22, this.color23, 0.5f), this.color23, decodeColor(this.color23, this.color23, 0.5f), this.color23, decodeColor(this.color23, this.color24, 0.5f), this.color24});
    }
    ...
    private Paint decodeGradient9(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color25, decodeColor(this.color25, this.color26, 0.5f), this.color26});
    }
    ...
    private Paint decodeGradient11(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.50490195f * width) + x2, (0.0f * height) + y2, (0.49509802f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.23192771f, 0.46385542f, 0.73192775f, 1.0f}, new Color[]{this.color31, decodeColor(this.color31, this.color32, 0.5f), this.color32, decodeColor(this.color32, this.color33, 0.5f), this.color33});
    }
    ...
    private Paint decodeGradient12(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color34, decodeColor(this.color34, this.color26, 0.5f), this.color26});
    }
    ...
    private Paint decodeGradient14(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.50490195f * width) + x2, (0.0f * height) + y2, (0.49509802f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.23192771f, 0.46385542f, 0.73192775f, 1.0f}, new Color[]{this.color40, decodeColor(this.color40, this.color32, 0.5f), this.color32, decodeColor(this.color32, this.color33, 0.5f), this.color33});
    }
    ...
    private Paint decodeGradient15(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color41, decodeColor(this.color41, this.color42, 0.5f), this.color42});
    }
    ...
    private Paint decodeGradient16(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49754903f * width) + x2, (0.004901961f * height) + y2, (0.50735295f * width) + x2, (1.0f * height) + y2, new float[]{0.0813253f, 0.100903615f, 0.12048193f, 0.20180723f, 0.28313252f, 0.49246985f, 0.7018072f, 0.7560241f, 0.810241f, 0.84789157f, 0.88554215f}, new Color[]{this.color43, decodeColor(this.color43, this.color44, 0.5f), this.color44, decodeColor(this.color44, this.color45, 0.5f), this.color45, decodeColor(this.color45, this.color45, 0.5f), this.color45, decodeColor(this.color45, this.color46, 0.5f), this.color46, decodeColor(this.color46, this.color47, 0.5f), this.color47});
    }
    ...
    private Paint decodeGradient17(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49789914f * width) + x2, ((-0.004201681f) * height) + y2, (0.5f * width) + x2, (0.9978992f * height) + y2, new float[]{0.0f, 0.5f, 1.0f}, new Color[]{this.color48, decodeColor(this.color48, this.color49, 0.5f), this.color49});
    }
    ...
    private Paint decodeGradient18(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.49754903f * width) + x2, (0.004901961f * height) + y2, (0.50735295f * width) + x2, (1.0f * height) + y2, new float[]{0.0813253f, 0.2695783f, 0.45783132f, 0.67168677f, 0.88554215f}, new Color[]{this.color50, decodeColor(this.color50, this.color51, 0.5f), this.color51, decodeColor(this.color51, this.color52, 0.5f), this.color52});
    }
    ...
    private Paint decodeGradient19(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.50490195f * width) + x2, (0.0f * height) + y2, (0.49509802f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.23192771f, 0.46385542f, 0.73192775f, 1.0f}, new Color[]{this.color53, decodeColor(this.color53, this.color54, 0.5f), this.color54, decodeColor(this.color54, this.color55, 0.5f), this.color55});
    }
}
