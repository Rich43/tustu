...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/PasswordFieldPainter.class */
final class PasswordFieldPainter extends AbstractRegionPainter {
    ...
    public PasswordFieldPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
