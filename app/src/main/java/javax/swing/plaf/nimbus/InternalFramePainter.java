...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/InternalFramePainter.class */
final class InternalFramePainter extends AbstractRegionPainter {
    ...
    public InternalFramePainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    private Paint decodeGradient1(Shape shape) {
        ...
        return decodeGradient((0.5f * width) + x2, (0.0f * height) + y2, (0.5f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.3203593f, 1.0f}, new Color[]{this.color2, decodeColor(this.color2, this.color3, 0.5f), this.color3});
    }
    ...
    private Paint decodeGradient3(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.5f * width) + x2, (0.0f * height) + y2, (0.5f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.24251497f, 1.0f}, new Color[]{this.color16, decodeColor(this.color16, this.color17, 0.5f), this.color17});
    }
}
