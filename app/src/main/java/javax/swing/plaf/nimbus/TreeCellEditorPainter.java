...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/TreeCellEditorPainter.class */
final class TreeCellEditorPainter extends AbstractRegionPainter {
    ...
    public TreeCellEditorPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
