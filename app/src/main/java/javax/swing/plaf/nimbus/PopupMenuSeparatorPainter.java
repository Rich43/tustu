...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/PopupMenuSeparatorPainter.class */
final class PopupMenuSeparatorPainter extends AbstractRegionPainter {
    ...
    public PopupMenuSeparatorPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    private Rectangle2D decodeRect1() {
        this.rect.setRect(decodeX(0.0f), decodeY(1.0f), decodeX(3.0f) - decodeX(0.0f), decodeY(2.0f) - decodeY(1.0f));
        return this.rect;
    }
}
