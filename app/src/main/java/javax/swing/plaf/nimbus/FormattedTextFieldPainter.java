...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/FormattedTextFieldPainter.class */
final class FormattedTextFieldPainter extends AbstractRegionPainter {
    ...
    public FormattedTextFieldPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    protected void doPaint(Graphics2D graphics2D, JComponent jComponent, int i2, int i3, Object[] objArr) {
        ...
        switch (this.state) {
            ...
            case 3:
                ...
                break;
            case 4:
                paintBorderDisabled(graphics2D);
                break;
            case 5:
                paintBorderFocused(graphics2D);
                break;
            case 6:
    ...
    private void paintBorderDisabled(Graphics2D graphics2D) {
    ...
    private void paintBorderFocused(Graphics2D graphics2D) {
