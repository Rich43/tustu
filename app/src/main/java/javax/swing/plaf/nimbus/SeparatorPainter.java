...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/SeparatorPainter.class */
final class SeparatorPainter extends AbstractRegionPainter {
    ...
    public SeparatorPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    private Rectangle2D decodeRect1() {
        this.rect.setRect(decodeX(0.0f), decodeY(1.3333334f), decodeX(3.0f) - decodeX(0.0f), decodeY(1.6666667f) - decodeY(1.3333334f));
        return this.rect;
    }
}
