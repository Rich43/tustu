...
/* loaded from: rt.jar:javax/swing/plaf/nimbus/SpinnerPanelSpinnerFormattedTextFieldPainter.class */
final class SpinnerPanelSpinnerFormattedTextFieldPainter extends AbstractRegionPainter {
    ...
    public SpinnerPanelSpinnerFormattedTextFieldPainter(AbstractRegionPainter.PaintContext paintContext, int i2) {
        this.state = i2;
    ...
    private Paint decodeGradient4(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.5f * width) + x2, (0.0f * height) + y2, (0.5f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.1684492f, 1.0f}, new Color[]{this.color10, decodeColor(this.color10, this.color11, 0.5f), this.color11});
    }
    ...
    private Paint decodeGradient5(Shape shape) {
        ...
        float width = (float) bounds2D.getWidth();
        float height = (float) bounds2D.getHeight();
        return decodeGradient((0.5f * width) + x2, (0.0f * height) + y2, (0.5f * width) + x2, (1.0f * height) + y2, new float[]{0.0f, 0.49573863f, 0.99147725f}, new Color[]{this.color8, decodeColor(this.color8, this.color15, 0.5f), this.color15});
    }
}
