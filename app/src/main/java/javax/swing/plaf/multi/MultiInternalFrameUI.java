...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiInternalFrameUI.class */
public class MultiInternalFrameUI extends InternalFrameUI {
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        MultiInternalFrameUI multiInternalFrameUI = new MultiInternalFrameUI();
        return MultiLookAndFeel.createUIs(multiInternalFrameUI, multiInternalFrameUI.uis, jComponent);
    }
