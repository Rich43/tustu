...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiColorChooserUI.class */
public class MultiColorChooserUI extends ColorChooserUI {
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiColorChooserUI, multiColorChooserUI.uis, jComponent);
    }
