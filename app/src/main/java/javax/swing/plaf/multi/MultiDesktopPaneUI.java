...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiDesktopPaneUI.class */
public class MultiDesktopPaneUI extends DesktopPaneUI {
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiDesktopPaneUI, multiDesktopPaneUI.uis, jComponent);
    }
