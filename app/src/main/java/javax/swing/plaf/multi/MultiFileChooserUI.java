...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiFileChooserUI.class */
public class MultiFileChooserUI extends FileChooserUI {
    ...
    public FileFilter getAcceptAllFileFilter(JFileChooser jFileChooser) {
        FileFilter acceptAllFileFilter = ((FileChooserUI) this.uis.elementAt(0)).getAcceptAllFileFilter(jFileChooser);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((FileChooserUI) this.uis.elementAt(i2)).getAcceptAllFileFilter(jFileChooser);
        }
    ...
    public FileView getFileView(JFileChooser jFileChooser) {
        FileView fileView = ((FileChooserUI) this.uis.elementAt(0)).getFileView(jFileChooser);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((FileChooserUI) this.uis.elementAt(i2)).getFileView(jFileChooser);
        }
        return fileView;
    }
    ...
    public String getApproveButtonText(JFileChooser jFileChooser) {
        String approveButtonText = ((FileChooserUI) this.uis.elementAt(0)).getApproveButtonText(jFileChooser);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((FileChooserUI) this.uis.elementAt(i2)).getApproveButtonText(jFileChooser);
        }
    ...
    public String getDialogTitle(JFileChooser jFileChooser) {
        String dialogTitle = ((FileChooserUI) this.uis.elementAt(0)).getDialogTitle(jFileChooser);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((FileChooserUI) this.uis.elementAt(i2)).getDialogTitle(jFileChooser);
        }
        return dialogTitle;
    }
    ...
    public void rescanCurrentDirectory(JFileChooser jFileChooser) {
        for (int i2 = 0; i2 < this.uis.size(); i2++) {
            ((FileChooserUI) this.uis.elementAt(i2)).rescanCurrentDirectory(jFileChooser);
        }
    }
    ...
    public void ensureFileIsVisible(JFileChooser jFileChooser, File file) {
        for (int i2 = 0; i2 < this.uis.size(); i2++) {
            ((FileChooserUI) this.uis.elementAt(i2)).ensureFileIsVisible(jFileChooser, file);
        }
    }
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiFileChooserUI, multiFileChooserUI.uis, jComponent);
    }
