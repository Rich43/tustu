...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiScrollBarUI.class */
public class MultiScrollBarUI extends ScrollBarUI {
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        MultiScrollBarUI multiScrollBarUI = new MultiScrollBarUI();
        return MultiLookAndFeel.createUIs(multiScrollBarUI, multiScrollBarUI.uis, jComponent);
    }
