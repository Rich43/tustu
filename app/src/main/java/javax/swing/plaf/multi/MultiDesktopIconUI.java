...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiDesktopIconUI.class */
public class MultiDesktopIconUI extends DesktopIconUI {
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiDesktopIconUI, multiDesktopIconUI.uis, jComponent);
    }
