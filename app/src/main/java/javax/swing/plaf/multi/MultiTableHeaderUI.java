...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiTableHeaderUI.class */
public class MultiTableHeaderUI extends TableHeaderUI {
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiTableHeaderUI, multiTableHeaderUI.uis, jComponent);
    }
