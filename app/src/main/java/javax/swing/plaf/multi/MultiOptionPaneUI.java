...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiOptionPaneUI.class */
public class MultiOptionPaneUI extends OptionPaneUI {
    ...
    public void selectInitialValue(JOptionPane jOptionPane) {
        for (int i2 = 0; i2 < this.uis.size(); i2++) {
            ((OptionPaneUI) this.uis.elementAt(i2)).selectInitialValue(jOptionPane);
        }
    }

    @Override // javax.swing.plaf.OptionPaneUI
    public boolean containsCustomComponents(JOptionPane jOptionPane) {
        boolean zContainsCustomComponents = ((OptionPaneUI) this.uis.elementAt(0)).containsCustomComponents(jOptionPane);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((OptionPaneUI) this.uis.elementAt(i2)).containsCustomComponents(jOptionPane);
        }
        return zContainsCustomComponents;
    }
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiOptionPaneUI, multiOptionPaneUI.uis, jComponent);
    }
