...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiComboBoxUI.class */
public class MultiComboBoxUI extends ComboBoxUI {
    ...
    public boolean isFocusTraversable(JComboBox jComboBox) {
        boolean zIsFocusTraversable = ((ComboBoxUI) this.uis.elementAt(0)).isFocusTraversable(jComboBox);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((ComboBoxUI) this.uis.elementAt(i2)).isFocusTraversable(jComboBox);
        }
        return zIsFocusTraversable;
    }

    @Override // javax.swing.plaf.ComboBoxUI
    public void setPopupVisible(JComboBox jComboBox, boolean z2) {
        for (int i2 = 0; i2 < this.uis.size(); i2++) {
            ((ComboBoxUI) this.uis.elementAt(i2)).setPopupVisible(jComboBox, z2);
        }
    }

    @Override // javax.swing.plaf.ComboBoxUI
    public boolean isPopupVisible(JComboBox jComboBox) {
        boolean zIsPopupVisible = ((ComboBoxUI) this.uis.elementAt(0)).isPopupVisible(jComboBox);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((ComboBoxUI) this.uis.elementAt(i2)).isPopupVisible(jComboBox);
        }
        return zIsPopupVisible;
    }
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiComboBoxUI, multiComboBoxUI.uis, jComponent);
    }
