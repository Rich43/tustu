...
/* loaded from: rt.jar:javax/swing/plaf/multi/MultiTabbedPaneUI.class */
public class MultiTabbedPaneUI extends TabbedPaneUI {
    ...
    public int tabForCoordinate(JTabbedPane jTabbedPane, int i2, int i3) {
        int iTabForCoordinate = ((TabbedPaneUI) this.uis.elementAt(0)).tabForCoordinate(jTabbedPane, i2, i3);
        for (int i4 = 1; i4 < this.uis.size(); i4++) {
            ((TabbedPaneUI) this.uis.elementAt(i4)).tabForCoordinate(jTabbedPane, i2, i3);
        }
        return iTabForCoordinate;
    }

    @Override // javax.swing.plaf.TabbedPaneUI
    public Rectangle getTabBounds(JTabbedPane jTabbedPane, int i2) {
        Rectangle tabBounds = ((TabbedPaneUI) this.uis.elementAt(0)).getTabBounds(jTabbedPane, i2);
        for (int i3 = 1; i3 < this.uis.size(); i3++) {
            ((TabbedPaneUI) this.uis.elementAt(i3)).getTabBounds(jTabbedPane, i2);
        }
        return tabBounds;
    }
    ...
    public int getTabRunCount(JTabbedPane jTabbedPane) {
        int tabRunCount = ((TabbedPaneUI) this.uis.elementAt(0)).getTabRunCount(jTabbedPane);
        for (int i2 = 1; i2 < this.uis.size(); i2++) {
            ((TabbedPaneUI) this.uis.elementAt(i2)).getTabRunCount(jTabbedPane);
        }
        return tabRunCount;
    }
    ...
    public static ComponentUI createUI(JComponent jComponent) {
        ...
        return MultiLookAndFeel.createUIs(multiTabbedPaneUI, multiTabbedPaneUI.uis, jComponent);
    }
