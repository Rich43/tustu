...
/* loaded from: rt.jar:javax/accessibility/AccessibleRole.class */
public class AccessibleRole extends AccessibleBundle {
    ...
    public static final AccessibleRole LIST = new AccessibleRole(SchemaSymbols.ATTVAL_LIST);
    ...
    public static final AccessibleRole PARAGRAPH = new AccessibleRole(AbstractDocument.ParagraphElementName);
