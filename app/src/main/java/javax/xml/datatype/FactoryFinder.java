...
/* loaded from: rt.jar:javax/xml/datatype/FactoryFinder.class */
class FactoryFinder {
    ...
    static <T> T newInstance(Class<T> cls, String str, ClassLoader classLoader, boolean z2) throws DatatypeConfigurationException {
    ...
    static <T> T newInstance(Class<T> type, String className, ClassLoader cl, boolean doFallback, boolean useBSClsLoader) throws DatatypeConfigurationException {
        ...
        try {
            ...
            throw new DatatypeConfigurationException("Provider " + className + " not found", x2);
        } catch (Exception x3) {
            throw new DatatypeConfigurationException("Provider " + className + " could not be instantiated: " + ((Object) x3), x3);
        }
    }
    ...
    private static <T> T findServiceProvider(final Class<T> cls) throws DatatypeConfigurationException {
        try {
            ...
            throw new DatatypeConfigurationException("Provider for " + ((Object) cls) + " cannot be found", e2);
        }
    }
}
