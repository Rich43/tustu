...
/* loaded from: rt.jar:javax/xml/namespace/QName.class */
public class QName implements Serializable {
    ...
    static {
        ...
        try {
            String valueUseCompatibleSerialVersionUID = (String) AccessController.doPrivileged(new PrivilegedAction() { // from class: javax.xml.namespace.QName.1
