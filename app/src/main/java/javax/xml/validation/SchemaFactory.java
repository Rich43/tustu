...
/* loaded from: rt.jar:javax/xml/validation/SchemaFactory.class */
public abstract class SchemaFactory {
    ...
    public static SchemaFactory newInstance(String schemaLanguage) {
        ...
        SchemaFactory f2 = new SchemaFactoryFinder(cl).newFactory(schemaLanguage);
        if (f2 == null) {
    ...
    public static SchemaFactory newInstance(String schemaLanguage, String factoryClassName, ClassLoader classLoader) {
        ...
        SchemaFactory f2 = new SchemaFactoryFinder(cl).createInstance(factoryClassName);
        if (f2 == null) {
        ...
        if (f2.isSchemaLanguageSupported(schemaLanguage)) {
            return f2;
        }
        throw new IllegalArgumentException("Factory " + f2.getClass().getName() + " does not implement the schema language specified by: " + schemaLanguage);
    }
