...
/* loaded from: rt.jar:javax/xml/bind/helpers/DefaultValidationEventHandler.class */
        ...
        switch (event.getSeverity()) {
            ...
            default:
                if (!$assertionsDisabled) {
                    throw new AssertionError((Object) Messages.format("DefaultValidationEventHandler.UnrecognizedSeverity", Integer.valueOf(event.getSeverity())));
                }
                break;
        }
