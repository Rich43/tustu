...
/* loaded from: rt.jar:javax/xml/bind/helpers/ValidationEventImpl.class */
    ...
    public String toString() {
        ...
        switch (getSeverity()) {
            ...
            case 2:
                ...
                break;
            default:
                s2 = String.valueOf(getSeverity());
                break;
        }
        return MessageFormat.format("[severity={0},message={1},locator={2}]", s2, getMessage(), getLocator());
    }
}
