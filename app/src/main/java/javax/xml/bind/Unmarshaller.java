...
/* loaded from: rt.jar:javax/xml/bind/Unmarshaller.class */
public interface Unmarshaller {
    ...
    void setValidating(boolean z2) throws JAXBException;
    ...
    /* loaded from: rt.jar:javax/xml/bind/Unmarshaller$Listener.class */
