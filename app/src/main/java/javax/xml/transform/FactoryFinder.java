...
/* loaded from: rt.jar:javax/xml/transform/FactoryFinder.class */
class FactoryFinder {
    ...
    static <T> T newInstance(Class<T> type, String className, ClassLoader cl, boolean doFallback) throws TransformerFactoryConfigurationError {
        ...
        try {
            ...
            throw new TransformerFactoryConfigurationError(x2, "Provider " + className + " not found");
        } catch (Exception x3) {
            throw new TransformerFactoryConfigurationError(x3, "Provider " + className + " could not be instantiated: " + ((Object) x3));
        }
    }

    static <T> T find(Class<T> cls, String str) throws TransformerFactoryConfigurationError {
