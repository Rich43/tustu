...
/* loaded from: rt.jar:javax/xml/ws/wsaddressing/W3CEndpointReferenceBuilder.class */
public final class W3CEndpointReferenceBuilder {
    ...
    public W3CEndpointReferenceBuilder endpointName(QName endpointName) {
        if (this.serviceName == null) {
            throw new IllegalStateException("The W3CEndpointReferenceBuilder's serviceName must be set before setting the endpointName: " + ((Object) endpointName));
        }
