...
/* loaded from: nashorn.jar:jdk/internal/dynalink/DynamicLinkerFactory.class */
public class DynamicLinkerFactory {
    ...
    private static void addClasses(Set<Class<? extends GuardingDynamicLinker>> set, List<? extends GuardingDynamicLinker> linkers) {
        for (GuardingDynamicLinker linker : linkers) {
            set.add(linker.getClass());
        }
    }
}
