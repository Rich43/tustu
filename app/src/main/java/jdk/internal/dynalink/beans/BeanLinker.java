...
/* loaded from: nashorn.jar:jdk/internal/dynalink/beans/BeanLinker.class */
class BeanLinker extends AbstractJavaLinker implements TypeBasedGuardingDynamicLinker {
    ...
    /* loaded from: nashorn.jar:jdk/internal/dynalink/beans/BeanLinker$CollectionType.class */
    ...
    static {
        ...
        GET_LIST_ELEMENT = Lookup.PUBLIC.findVirtual(List.class, "get", MethodType.methodType((Class<?>) Object.class, Integer.TYPE));
        GET_MAP_ELEMENT = Lookup.PUBLIC.findVirtual(Map.class, "get", MethodType.methodType((Class<?>) Object.class, (Class<?>) Object.class));
    ...
    private static Object convertKeyToInteger(String fixedKey, LinkerServices linkerServices) throws Exception {
        try {
            if (linkerServices.canConvert(String.class, Number.class)) {
                try {
                    try {
                        Object val = (Object) linkerServices.getTypeConverter(String.class, Number.class).invoke(fixedKey);
                        if (!(val instanceof Number)) {
                            return null;
                        }
                        Number n2 = (Number) val;
                        if (n2 instanceof Integer) {
                            return n2;
                        }
                        int intIndex = n2.intValue();
    ...
    /* loaded from: nashorn.jar:jdk/internal/dynalink/beans/BeanLinker$Binder.class */
    ...
    private static final boolean rangeCheck(Object array, Object index) {
        ...
        throw new ArrayIndexOutOfBoundsException("Array index out of range: " + ((Object) n2));
    }
    ...
    private static final boolean rangeCheck(List<?> list, Object index) {
        ...
        throw new IndexOutOfBoundsException("Index: " + ((Object) n2) + ", Size: " + list.size());
    }
