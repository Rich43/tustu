...
/* loaded from: nashorn.jar:jdk/internal/dynalink/beans/AbstractJavaLinker.class */
abstract class AbstractJavaLinker implements GuardingDynamicLinker {
    ...
    static {
        ...
        IS_METHOD_HANDLE_NOT_NULL = Guards.isNotNull().asType(MethodType.methodType(Boolean.TYPE, (Class<?>) MethodHandle.class));
        ...
        IS_ANNOTATED_METHOD_NOT_NULL = Guards.isNotNull().asType(MethodType.methodType(Boolean.TYPE, (Class<?>) AnnotatedDynamicMethod.class));
        ...
        IS_DYNAMIC_METHOD = Guards.isInstance(DynamicMethod.class, MethodType.methodType(Boolean.TYPE, (Class<?>) Object.class));
        ...
        GET_DYNAMIC_METHOD = MethodHandles.dropArguments(privateLookup.findOwnSpecial("getDynamicMethod", Object.class, Object.class), 1, (Class<?>[]) new Class[]{Object.class});
    }
    ...
    AbstractJavaLinker(Class<?> clazz, MethodHandle classGuard, MethodHandle assignableGuard) {
        ...
        for (Method method : introspector.getMethods()) {
            ...
            } else if (name.startsWith(BeanAdapter.IS_PREFIX) && name.length() > 2 && method.getParameterTypes().length == 0 && method.getReturnType() == Boolean.TYPE) {
    ...
    private static Collection<String> getUnmodifiableKeys(Map<String, ?> m2) {
        return Collections.unmodifiableCollection(m2.keySet());
    }
    ...
    private void addMember(String name, AccessibleObject ao2, Map<String, DynamicMethod> methodMap) {
        addMember(name, createDynamicMethod(ao2), methodMap);
    }
    ...
    private static SingleDynamicMethod createDynamicMethod(AccessibleObject accessibleObject) {
        ...
        try {
            MethodHandle mh = unreflectSafely(accessibleObject);
            Member member = (Member) accessibleObject;
            return new SimpleDynamicMethod(mh, member.getDeclaringClass(), member.getName(), accessibleObject instanceof Constructor);
        } catch (IllegalAccessError e2) {
            return new CallerSensitiveDynamicMethod(accessibleObject);
        }
    }

    private static MethodHandle unreflectSafely(AccessibleObject m2) {
        if (m2 instanceof Method) {
            Method reflMethod = (Method) m2;
        ...
        return StaticClassIntrospector.editConstructorMethodHandle(Lookup.PUBLIC.unreflectConstructor((Constructor) m2));
    }
    ...
    public GuardedInvocation getGuardedInvocation(LinkRequest request, LinkerServices linkerServices) throws Exception {
        ...
        List<String> listPop = CallSiteDescriptorFactory.tokenizeOperators(callSiteDescriptor);
        while (true) {
            List<String> operations = listPop;
    ...
    static final <T> List<T> pop(List<T> l2) {
        return l2.subList(1, l2.size());
    }
    ...
    private GuardedInvocationComponent getPropertySetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List<String> operations) throws Exception {
        ...
        switch (callSiteDescriptor.getNameTokenCount()) {
            case 2:
                ...
                MethodHandle invokeHandleFolded = MethodHandles.dropArguments(invokeHandle, 2, (Class<?>[]) new Class[]{type.parameterType(1)});
                ...
                if (nextComponent == null) {
                    ...
                    fallbackFolded = MethodHandles.dropArguments(nextComponent.getGuardedInvocation().getInvocation(), 0, (Class<?>[]) new Class[]{MethodHandle.class});
                }
    ...
    private GuardedInvocationComponent getPropertyGetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List<String> ops) throws Exception {
        ...
        switch (callSiteDescriptor.getNameTokenCount()) {
            case 2:
                ...
                MethodHandle invokeHandleFolded = MethodHandles.dropArguments(invokeHandleTyped, 2, (Class<?>[]) new Class[]{type.parameterType(1)});
                ...
                if (nextComponent == null) {
                    ...
                    fallbackFolded = MethodHandles.dropArguments(nextInvocation.asType(nextType.changeReturnType(Object.class)), 0, (Class<?>[]) new Class[]{AnnotatedDynamicMethod.class});
                }
    ...
    private GuardedInvocationComponent getMethodGetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List<String> ops) throws Exception {
        ...
        switch (callSiteDescriptor.getNameTokenCount()) {
            case 2:
                ...
                if (!$assertionsDisabled && !nextComponentInvocation.type().changeReturnType(type.returnType()).equals((Object) type)) {
                    throw new AssertionError();
                }
                MethodHandle nextCombinedInvocation = MethodHandles.dropArguments(nextComponentInvocation, 0, (Class<?>[]) new Class[]{Object.class});
            ...
            case 3:
                ...
                return getClassGuardedInvocationComponent(linkerServices.asType(MethodHandles.dropArguments(MethodHandles.constant(Object.class, method), 0, (Class<?>[]) new Class[]{type.parameterType(0)}), type), type);
            default:
                return null;
        }
    }

    /* loaded from: nashorn.jar:jdk/internal/dynalink/beans/AbstractJavaLinker$MethodPair.class */
    ...
    /* loaded from: nashorn.jar:jdk/internal/dynalink/beans/AbstractJavaLinker$AnnotatedDynamicMethod.class */
