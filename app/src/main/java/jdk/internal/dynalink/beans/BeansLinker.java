...
/* loaded from: nashorn.jar:jdk/internal/dynalink/beans/BeansLinker.class */
public class BeansLinker implements GuardingDynamicLinker {
    ...
    public GuardedInvocation getGuardedInvocation(LinkRequest request, LinkerServices linkerServices) throws Exception {
        ...
        int l2 = callSiteDescriptor.getNameTokenCount();
        if (l2 < 2 || "dyn" != callSiteDescriptor.getNameToken(0) || (receiver = request.getReceiver()) == null) {
            return null;
        }
