...
/* loaded from: nashorn.jar:jdk/internal/dynalink/linker/LinkerServices.class */
public interface LinkerServices {
    ...
    /* loaded from: nashorn.jar:jdk/internal/dynalink/linker/LinkerServices$Implementation.class */
