...
/* loaded from: nashorn.jar:jdk/internal/dynalink/ChainedCallSite.class */
public class ChainedCallSite extends AbstractRelinkableCallSite {
    ...
    private MethodHandle relinkInternal(GuardedInvocation invocation, MethodHandle relink, boolean reset, boolean removeCatches) throws RuntimeException {
    ...
    private MethodHandle makePruneAndInvokeMethod(MethodHandle relink, MethodHandle prune) throws RuntimeException {
