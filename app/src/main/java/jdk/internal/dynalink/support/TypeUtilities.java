...
/* loaded from: nashorn.jar:jdk/internal/dynalink/support/TypeUtilities.class */
public class TypeUtilities {
    ...
    private static Set<Class<?>> getAssignables(Class<?> c1, Class<?> c2) {
        Set<Class<?>> s2 = new HashSet<>();
        collectAssignables(c1, c2, s2);
        return s2;
    }

    private static void collectAssignables(Class<?> c1, Class<?> c2, Set<Class<?>> s2) {
        if (c1.isAssignableFrom(c2)) {
            s2.add(c1);
        }
        Class<?> sc = c1.getSuperclass();
        if (sc != null) {
            collectAssignables(sc, c2, s2);
        }
        Class<?>[] itf = c1.getInterfaces();
        for (Class<?> cls : itf) {
            collectAssignables(cls, c2, s2);
        }
    }
    ...
    public static boolean isMethodInvocationConvertible(Class<?> sourceType, Class<?> targetType) {
        ...
        throw new AssertionError((Object) sourceType.getName());
    }
