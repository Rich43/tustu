...
/* loaded from: rt.jar:jdk/xml/internal/XMLSecurityManager.class */
public final class XMLSecurityManager {
    ...
    /* loaded from: rt.jar:jdk/xml/internal/XMLSecurityManager$Processor.class */
    public enum Processor {
        PARSER,
        XPATH
    }

    /* loaded from: rt.jar:jdk/xml/internal/XMLSecurityManager$State.class */
    public enum State {
        DEFAULT("default"),
    ...
    /* loaded from: rt.jar:jdk/xml/internal/XMLSecurityManager$Limit.class */
    public enum Limit {
        ...
        MAX_OCCUR_NODE_LIMIT("MaxOccurLimit", "http://www.oracle.com/xml/jaxp/properties/maxOccurLimit", "jdk.xml.maxOccurLimit", 0, TFTP.DEFAULT_TIMEOUT, Processor.PARSER),
        ...
        XPATH_GROUP_LIMIT("XPathGroupLimit", XalanConstants.XPATH_GROUP_LIMIT, XalanConstants.XPATH_GROUP_LIMIT, 10, 10, Processor.XPATH),
        XPATH_OP_LIMIT("XPathExprOpLimit", XalanConstants.XPATH_OP_LIMIT, XalanConstants.XPATH_OP_LIMIT, 100, 100, Processor.XPATH),
        XPATH_TOTALOP_LIMIT("XPathTotalOpLimit", XalanConstants.XPATH_TOTALOP_LIMIT, XalanConstants.XPATH_TOTALOP_LIMIT, 10000, 10000, Processor.XPATH);
        ...
        Limit(String key, String apiProperty, String systemProperty, int value, int secureValue, Processor processor) {
            this.key = key;
        ...
        public boolean isSupported(Processor p2) {
            return this.processor == p2;
        }
    ...
    /* loaded from: rt.jar:jdk/xml/internal/XMLSecurityManager$NameMap.class */
    public enum NameMap {
