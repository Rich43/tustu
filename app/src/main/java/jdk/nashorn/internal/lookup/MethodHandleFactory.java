...
/* loaded from: nashorn.jar:jdk/nashorn/internal/lookup/MethodHandleFactory.class */
public final class MethodHandleFactory {
    ...
    static {
        ...
        TRACE_RETURN_VOID = FUNC.findStatic(LOOKUP, MethodHandleFactory.class, "traceReturnVoid", MethodType.methodType(Void.TYPE, (Class<?>) DebugLogger.class));
    }

    private MethodHandleFactory() {
    }

    /* loaded from: nashorn.jar:jdk/nashorn/internal/lookup/MethodHandleFactory$LookupException.class */
    public static class LookupException extends RuntimeException {
        public LookupException(Exception e2) {
            super(e2);
        }
    }
    ...
    static Object traceReturn(DebugLogger logger, Object value) {
        ...
        String str2 = sbAppend.append(str).toString();
        if (logger == null) {
            err(str2);
    ...
    static void traceArgs(DebugLogger logger, String tag, int paramStart, Object... args) {
        ...
        sb.append(tag);
        for (int i2 = paramStart; i2 < args.length; i2++) {
            if (i2 == paramStart) {
                sb.append(" => args: ");
            }
            sb.append('\'').append(stripName(argString(args[i2]))).append('\'').append(' ').append('[').append("type=").append(args[i2] == null ? FXMLLoader.NULL_KEYWORD : stripName(args[i2].getClass())).append(']');
            if (i2 + 1 < args.length) {
                sb.append(", ");
            }
        }
    ...
    public static MethodHandle addDebugPrintout(DebugLogger logger, Level level, MethodHandle mh, int paramStart, boolean printReturnValue, Object tag) throws RuntimeException {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/lookup/MethodHandleFactory$StandardMethodHandleFunctionality.class */
    private static class StandardMethodHandleFunctionality implements MethodHandleFunctionality, Loggable {
        ...
        protected static String describe(Object... data) {
            ...
            for (int i2 = 0; i2 < data.length; i2++) {
                ...
                if (d2 == null) {
                    sb.append("<null> ");
                } else if (JSType.isString(d2)) {
                    sb.append(d2.toString());
                    sb.append(' ');
                } else if (d2.getClass().isArray()) {
                    sb.append("[ ");
                    for (Object da : (Object[]) d2) {
                        sb.append(describe(da)).append(' ');
                    }
                    sb.append("] ");
                } else {
                    sb.append(d2).append('{').append(Integer.toHexString(System.identityHashCode(d2))).append('}');
                }
                if (i2 + 1 < data.length) {
                    sb.append(", ");
                }
        ...
        public MethodHandle filterArguments(MethodHandle target, int pos, MethodHandle... filters) throws RuntimeException {
        ...
        @Override // jdk.nashorn.internal.lookup.MethodHandleFunctionality
        public MethodHandle filterReturnValue(MethodHandle target, MethodHandle filter) throws RuntimeException {
        ...
        @Override // jdk.nashorn.internal.lookup.MethodHandleFunctionality
        public MethodHandle insertArguments(MethodHandle target, int pos, Object... values) throws RuntimeException {
        ...
        @Override // jdk.nashorn.internal.lookup.MethodHandleFunctionality
        public MethodHandle bindTo(MethodHandle handle, Object x2) {
            MethodHandle mh = handle.bindTo(x2);
            return debug(mh, "bindTo", handle, x2);
        }
        ...
        @Override // jdk.nashorn.internal.lookup.MethodHandleFunctionality
        public MethodHandle arrayElementGetter(Class<?> type) throws IllegalArgumentException {
            MethodHandle mh = MethodHandles.arrayElementGetter(type);
            return debug(mh, "arrayElementGetter", type);
        }

        @Override // jdk.nashorn.internal.lookup.MethodHandleFunctionality
        public MethodHandle arrayElementSetter(Class<?> type) throws IllegalArgumentException {
        ...
        public MethodHandle constant(Class<?> type, Object value) {
            ...
            return debug(mh, FXMLLoader.FX_CONSTANT_ATTRIBUTE, type, value);
        }
