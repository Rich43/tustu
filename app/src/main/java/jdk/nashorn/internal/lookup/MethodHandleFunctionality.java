...
/* loaded from: nashorn.jar:jdk/nashorn/internal/lookup/MethodHandleFunctionality.class */
public interface MethodHandleFunctionality {
    MethodHandle filterArguments(MethodHandle methodHandle, int i2, MethodHandle... methodHandleArr);
    ...
    MethodHandle insertArguments(MethodHandle methodHandle, int i2, Object... objArr);

    MethodHandle dropArguments(MethodHandle methodHandle, int i2, Class<?>... clsArr);

    MethodHandle dropArguments(MethodHandle methodHandle, int i2, List<Class<?>> list);
    ...
    MethodHandle asCollector(MethodHandle methodHandle, Class<?> cls, int i2);

    MethodHandle asSpreader(MethodHandle methodHandle, Class<?> cls, int i2);
