...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/DataPropertyDescriptor.class */
public final class DataPropertyDescriptor extends ScriptObject implements PropertyDescriptor {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.DataPropertyDescriptor.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/DataPropertyDescriptor.class
    ...
    public static void $clinit$() {
        /*
        // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.DataPropertyDescriptor.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/DataPropertyDescriptor.class
        */
