...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeArrayBuffer.class */
public final class NativeArrayBuffer extends ScriptObject {
    private final ByteBuffer nb;
    private static PropertyMap $nasgenmap$;

    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeArrayBuffer$Constructor.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeArrayBuffer$Prototype.class */
