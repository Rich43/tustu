...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeRegExp.class */
public final class NativeRegExp extends ScriptObject {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeRegExp$Constructor.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeRegExp$Prototype.class */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeRegExp.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeRegExp.class
    ...
    public static void $clinit$() {
        /*
        // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeRegExp.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeRegExp.class
        */
    ...
    private Object[] groups(RegExpMatcher matcher) {
        ...
        for (int i2 = 0; i2 <= groupCount; i2++) {
            int groupStart = matcher.start(i2);
            if (lastGroupStart > groupStart || (groupsInNegativeLookahead != null && groupsInNegativeLookahead.isSet(i2))) {
                groups[i2] = ScriptRuntime.UNDEFINED;
            } else {
                String group = matcher.group(i2);
                groups[i2] = group == null ? ScriptRuntime.UNDEFINED : group;
            ...
            if (nextChar == '$') {
                ...
                if (firstDigit >= 0 && firstDigit <= 9 && firstDigit <= matcher.groupCount()) {
                    ...
                    if (refNum > 0) {
                        ...
                        if (!$assertionsDisabled && refNum != 0) {
                            throw new AssertionError();
                        }
                        sb.append("$0");
                    }
