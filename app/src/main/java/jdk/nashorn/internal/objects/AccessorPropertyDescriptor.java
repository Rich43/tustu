...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/AccessorPropertyDescriptor.class */
public final class AccessorPropertyDescriptor extends ScriptObject implements PropertyDescriptor {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.AccessorPropertyDescriptor.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/AccessorPropertyDescriptor.class
    ...
    public static void $clinit$() {
        /*
        // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.AccessorPropertyDescriptor.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/AccessorPropertyDescriptor.class
        */
    ...
    public boolean hasAndEquals(PropertyDescriptor otherDesc) {
        ...
        return (!has(PropertyDescriptor.CONFIGURABLE) || ScriptRuntime.sameValue(this.configurable, other.configurable)) && (!has(PropertyDescriptor.ENUMERABLE) || ScriptRuntime.sameValue(this.enumerable, other.enumerable)) && ((!has("get") || ScriptRuntime.sameValue(this.get, other.get)) && (!has("set") || ScriptRuntime.sameValue(this.set, other.set)));
    }
