...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/ArrayBufferView.class */
public abstract class ArrayBufferView extends ScriptObject {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/ArrayBufferView$Factory.class */
    protected static abstract class Factory {
        final int bytesPerElement;
        final int maxElementLength;

        public abstract ArrayBufferView construct(NativeArrayBuffer nativeArrayBuffer, int i2, int i3);

        public abstract TypedArrayData<?> createArrayData(ByteBuffer byteBuffer, int i2, int i3);
    ...
    protected static ArrayBufferView constructorImpl(boolean newObj, Object[] args, Factory factory) {
        ...
        if (arg0 instanceof ArrayBufferView) {
            ...
            return factory.construct(lengthToInt(Double.isInfinite(dlen) ? 0L : JSType.toLong(dlen)));
        }
    ...
    private static void copyElements(ArrayBufferView dest, int length, ScriptObject source, int offset) {
        if (!dest.isFloatArray()) {
            ...
            int j2 = offset;
            while (i2 < length) {
                dest.set(j2, source.getInt(i2, -1), 0);
                i2++;
                j2++;
            }
            return;
        ...
        int j3 = offset;
        while (i3 < length) {
            dest.set(j3, source.getDouble(i3, -1), 0);
            i3++;
            j3++;
        }
    }
