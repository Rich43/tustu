...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeNumber.class */
public final class NativeNumber extends ScriptObject {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeNumber$Constructor.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeNumber$Prototype.class */
    final class Prototype extends PrototypeObject {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x0015: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	...
            	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
            */
        /*  JADX ERROR: Failed to decode insn: 0x0024: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	...
            	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
            */
        /*  JADX ERROR: Failed to decode insn: 0x002E: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	...
            	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
            */
        /*  JADX ERROR: Failed to decode insn: 0x0039: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	...
            	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
            */
        /*  JADX ERROR: Failed to decode insn: 0x0048: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	...
            	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
            */
        /*  JADX ERROR: Failed to decode insn: 0x0052: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	...
            	at jadx.core.dex.nodes.ClassNode.getCode(ClassNode.java:339)
            */
        /*  JADX ERROR: Failed to decode insn: 0x005C: CONST
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
    ...
    public static String toFixed(Object self, int fractionDigits) {
        ...
        double x2 = getNumberValue(self);
        if (Double.isNaN(x2)) {
            return "NaN";
        }
        if (Math.abs(x2) >= 1.0E21d) {
            return JSType.toString(x2);
        }
    ...
    public static String toExponential(Object self, Object fractionDigits) {
        ...
        int f2 = trimZeros ? 16 : JSType.toInteger(fractionDigits);
        if (Double.isNaN(x2)) {
            return "NaN";
        }
        if (Double.isInfinite(x2)) {
            return x2 > 0.0d ? Constants.ATTRVAL_INFINITY : "-Infinity";
        }
        if (fractionDigits != ScriptRuntime.UNDEFINED && (f2 < 0 || f2 > 20)) {
            throw ECMAErrors.rangeError("invalid.fraction.digits", "toExponential");
        }
        String res = String.format(Locale.US, "%1." + f2 + "e", Double.valueOf(x2));
    ...
    public static String toPrecision(Object self, Object precision) {
        ...
        return toPrecision(x2, JSType.toInteger(precision));
    }
    ...
    private static String toPrecision(double x2, int p2) {
        if (Double.isNaN(x2)) {
            return "NaN";
        }
        if (Double.isInfinite(x2)) {
        ...
        return (x2 != 0.0d || p2 > 1) ? fixExponent(String.format(Locale.US, "%." + p2 + PdfOps.g_TOKEN, Double.valueOf(x2)), false) : "0";
    }
    ...
    private static String fixExponent(String str, boolean trimZeros) {
        ...
        if (trimZeros) {
            ...
            char cCharAt = str.charAt(fractionOffset - 1);
            while (true) {
                char c2 = cCharAt;
                if (fractionOffset <= 1 || !(c2 == '0' || c2 == '.')) {
                    break;
                }
                fractionOffset--;
                cCharAt = str.charAt(fractionOffset - 1);
            }
        }
