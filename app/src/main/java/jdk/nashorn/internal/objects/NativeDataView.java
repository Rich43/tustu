...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeDataView.class */
public class NativeDataView extends ScriptObject {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeDataView$Constructor.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeDataView$Prototype.class */
    final class Prototype extends PrototypeObject {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeDataView.Prototype.<init>():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeDataView$Prototype.class
        ...
        Prototype() {
            /*
            // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeDataView.Prototype.<init>():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeDataView$Prototype.class
            */
    ...
    public static double getUint32(Object self, Object byteOffset, Object littleEndian) {
        try {
            return 4294967295L & getBuffer(self, littleEndian).getInt(JSType.toInt32(byteOffset));
        } catch (IllegalArgumentException iae) {
            throw ECMAErrors.rangeError(iae, "dataview.offset", new String[0]);
        }
    }
