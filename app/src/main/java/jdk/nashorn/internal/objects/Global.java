...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/Global.class */
public final class Global extends Scope {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: Index 207 out of bounds for length 202 in method: jdk.nashorn.internal.objects.Global.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/Global.class
    ...
    public static void $clinit$() {
        /*
        // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.Global.$clinit$():void, file: nashorn.jar:jdk/nashorn/internal/objects/Global.class
        */
    ...
    public Object G$javafx() {
        return this.f12871javafx;
    }

    public void S$javafx(Object obj) {
        this.f12871javafx = obj;
    }

    public Object G$javax() {
        return this.f12872javax;
    }

    public void S$javax(Object obj) {
        this.f12872javax = obj;
    }

    public Object G$org() {
        return this.f12873org;
    }
    ...
    static {
        ...
        EVAL = findOwnMH_S(Constants.ELEMNAME_EVAL_STRING, Object.class, Object.class, Object.class);
    ...
    public Global(Context context) {
        ...
        this.VALUE_OF = new InvokeByName(BeanAdapter.VALUE_OF_METHOD_NAME, ScriptObject.class);
    ...
    public void initBuiltinObjects(ScriptEngine eng) throws SecurityException {
        ...
        try {
            try {
                if (hint == String.class) {
                    Object toString = (Object) this.TO_STRING.getGetter().invokeExact(sobj);
                    if (Bootstrap.isCallable(toString)) {
                        Object value = (Object) this.TO_STRING.getInvoker().invokeExact(toString, sobj);
                        if (JSType.isPrimitive(value)) {
                            return value;
                        }
                    }
                    Object valueOf = (Object) this.VALUE_OF.getGetter().invokeExact(sobj);
                    if (Bootstrap.isCallable(valueOf)) {
                        Object value2 = (Object) this.VALUE_OF.getInvoker().invokeExact(valueOf, sobj);
                ...
                if (hint == Number.class) {
                    Object valueOf2 = (Object) this.VALUE_OF.getGetter().invokeExact(sobj);
                    if (Bootstrap.isCallable(valueOf2)) {
                        Object value3 = (Object) this.VALUE_OF.getInvoker().invokeExact(valueOf2, sobj);
                        if (JSType.isPrimitive(value3)) {
                            return value3;
                        }
                    }
                    Object toString2 = (Object) this.TO_STRING.getGetter().invokeExact(sobj);
                    if (Bootstrap.isCallable(toString2)) {
                        Object value4 = (Object) this.TO_STRING.getInvoker().invokeExact(toString2, sobj);
    ...
    public PropertyDescriptor newAccessorDescriptor(Object get, Object set, boolean configurable, boolean enumerable) {
        ...
        if (get == null) {
            desc.delete((Object) "get", false);
        }
        if (set == null) {
            desc.delete((Object) "set", false);
        }
        return desc;
    }
    ...
    public static boolean isBuiltinFunctionPrototypeCall() {
        return isBuiltinFunctionProperty(Constants.ELEMNAME_CALL_STRING);
    }
    ...
    private <T extends ScriptObject> T initConstructorAndSwitchPoint(String str, Class<T> cls) {
        T t2 = (T) initConstructor(str, cls);
        tagBuiltinProperties(str, t2);
        return t2;
    }

    private void init(ScriptEngine eng) throws SecurityException {
        boolean debugOkay;
        if (!$assertionsDisabled && Context.getGlobal() != this) {
            throw new AssertionError((Object) "this global is not set as current");
        }
        ScriptEnvironment env = getContext().getEnv();
        initFunctionAndObject();
        setInitialProto(getObjectPrototype());
        ScriptFunction scriptFunctionCreateBuiltin = ScriptFunction.createBuiltin(Constants.ELEMNAME_EVAL_STRING, EVAL);
        this.builtinEval = scriptFunctionCreateBuiltin;
        this.eval = scriptFunctionCreateBuiltin;
        ...
        if (eng != null) {
            addOwnProperty(ScriptEngine.FILENAME, 2, null);
    ...
    private void initScripting(ScriptEnvironment scriptEnv) throws SecurityException {
    ...
    private static void copyOptions(ScriptObject options, ScriptEnvironment scriptEnv) throws SecurityException {
        for (Field f2 : scriptEnv.getClass().getFields()) {
            try {
                options.set(f2.getName(), f2.get(scriptEnv), 0);
    ...
    private void copyBuiltins() {
        ...
        this.f12869com = this.builtinCom;
        this.edu = this.builtinEdu;
        this.f12870java = this.builtinJava;
        this.f12871javafx = this.builtinJavafx;
        this.f12872javax = this.builtinJavax;
        this.f12873org = this.builtinOrg;
    ...
    private void initFunctionAndObject() {
        ...
        Property[] properties2 = getObjectPrototype().getMap().getProperties();
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/Global$LexicalScope.class */
