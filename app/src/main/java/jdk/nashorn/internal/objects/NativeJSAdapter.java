...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeJSAdapter.class */
public final class NativeJSAdapter extends ScriptObject {
    ...
    private static final MethodHandle IS_JSADAPTOR = findOwnMH("isJSAdaptor", Boolean.TYPE, Object.class, Object.class, MethodHandle.class, Object.class, ScriptFunction.class);
    private static PropertyMap $nasgenmap$;

    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeJSAdapter$Constructor.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeJSAdapter$Prototype.class */
    ...
    public int getInt(Object key, int programPoint) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.getInt(key, programPoint) : callAdapteeInt(programPoint, __get__, key);
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public int getInt(double key, int programPoint) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.getInt(key, programPoint) : callAdapteeInt(programPoint, __get__, Double.valueOf(key));
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public int getInt(int key, int programPoint) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.getInt(key, programPoint) : callAdapteeInt(programPoint, __get__, Integer.valueOf(key));
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public double getDouble(Object key, int programPoint) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.getDouble(key, programPoint) : callAdapteeDouble(programPoint, __get__, key);
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public double getDouble(double key, int programPoint) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.getDouble(key, programPoint) : callAdapteeDouble(programPoint, __get__, Double.valueOf(key));
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public double getDouble(int key, int programPoint) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.getDouble(key, programPoint) : callAdapteeDouble(programPoint, __get__, Integer.valueOf(key));
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public Object get(Object key) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.get(key) : callAdaptee(__get__, key);
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public Object get(double key) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.get(key) : callAdaptee(__get__, Double.valueOf(key));
    }

    @Override // jdk.nashorn.internal.runtime.ScriptObject, jdk.nashorn.internal.runtime.PropertyAccess
    public Object get(int key) {
        return (this.overrides && super.hasOwnProperty(key)) ? super.get(key) : callAdaptee(__get__, Integer.valueOf(key));
    }
    ...
    public static NativeJSAdapter construct(boolean isNew, Object self, Object... args) {
        ...
        if (args == null || args.length == 0) {
            throw ECMAErrors.typeError("not.an.object", FXMLLoader.NULL_KEYWORD);
        }
        switch (args.length) {
            case 1:
                adaptee = args[0];
            ...
            case "getMethod":
                ...
                if (find != null) {
                    ...
                    if (value instanceof ScriptFunction) {
                        ...
                        return new GuardedInvocation(Lookup.MH.dropArguments(Lookup.MH.constant(Object.class, func.createBound(this, new Object[]{name})), 0, Object.class), testJSAdaptor(this.adaptee, null, null, null), this.adaptee.getProtoSwitchPoints(__call__, find.getOwner()), (Class<? extends Throwable>) null);
                    }
                }
        ...
        switch (hook) {
            ...
            default:
                if (hook.equals(__put__)) {
                    methodHandle = Lookup.MH.asType(Lookup.EMPTY_SETTER, type);
                } else {
    ...
    private static boolean isJSAdaptor(Object self, Object adaptee, MethodHandle getter, Object where, ScriptFunction func) {
        ...
        if (res && getter != null) {
            try {
                return (Object) getter.invokeExact(where) == func;
