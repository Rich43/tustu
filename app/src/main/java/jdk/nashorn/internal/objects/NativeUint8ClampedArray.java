...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeUint8ClampedArray.class */
public final class NativeUint8ClampedArray extends ArrayBufferView {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeUint8ClampedArray$Constructor.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeUint8ClampedArray$Prototype.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeUint8ClampedArray$Uint8ClampedArrayData.class */
    private static final class Uint8ClampedArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private static long clampLong(long l2) {
            if (l2 < 0) {
                return 0L;
            }
            if (l2 > 255) {
