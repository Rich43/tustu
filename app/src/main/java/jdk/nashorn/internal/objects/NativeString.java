...
/* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeString.class */
public final class NativeString extends ScriptObject implements OptimisticBuiltins {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeString$Constructor.class */
    final class Constructor extends ScriptFunction {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: Index 2807 out of bounds for length 2807 in method: jdk.nashorn.internal.objects.NativeString.Constructor.<init>():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeString$Constructor.class
            ...
            Caused by: java.lang.ArrayIndexOutOfBoundsException: Index 2807 out of bounds for length 2807
        ...
        Constructor() {
            /*
            // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeString.Constructor.<init>():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeString$Constructor.class
            */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeString$Prototype.class */
    final class Prototype extends PrototypeObject {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeString.Prototype.<init>():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeString$Prototype.class
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:168)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:458)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:464)
            	at jadx.core.ProcessClass.process(ProcessClass.java:69)
        ...
        Prototype() {
            /*
            // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.NativeString.Prototype.<init>():void, file: nashorn.jar:jdk/nashorn/internal/objects/NativeString$Prototype.class
            */
    ...
    protected GuardedInvocation findGetIndexMethod(CallSiteDescriptor desc, LinkRequest request) {
        ...
        if (returnType == Object.class && JSType.isString(self)) {
            ...
            } catch (MethodHandleFactory.LookupException e2) {
            }
        }
    ...
    public static String fromCharCode(Object self, Object... args) {
        ...
        for (Object arg : args) {
            int i2 = index;
            index++;
            buf[i2] = (char) JSType.toUint16(arg);
        }
    ...
    public static String fromCharCode(Object self, int value) {
        return Character.toString((char) (value & 65535));
    }

    public static Object fromCharCode(Object self, int ch1, int ch2) {
        return Character.toString((char) (ch1 & 65535)) + Character.toString((char) (ch2 & 65535));
    }

    public static Object fromCharCode(Object self, int ch1, int ch2, int ch3) {
        return Character.toString((char) (ch1 & 65535)) + Character.toString((char) (ch2 & 65535)) + Character.toString((char) (ch3 & 65535));
    }

    public static String fromCharCode(Object self, int ch1, int ch2, int ch3, int ch4) {
        return Character.toString((char) (ch1 & 65535)) + Character.toString((char) (ch2 & 65535)) + Character.toString((char) (ch3 & 65535)) + Character.toString((char) (ch4 & 65535));
    }
    ...
    private static ScriptObject splitString(String str, String separator, long limit) {
        ...
        if (separator.isEmpty()) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                array[i2] = String.valueOf(str.charAt(i2));
            }
        ...
        int pos = 0;
        int n2 = 0;
        while (pos < strLength && n2 < limit && (found = str.indexOf(separator, pos)) != -1) {
            elements.add(str.substring(pos, found));
            n2++;
            pos = found + sepLength;
        }
        if (pos <= strLength && n2 < limit) {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/objects/NativeString$CharCodeAtLinkLogic.class */
