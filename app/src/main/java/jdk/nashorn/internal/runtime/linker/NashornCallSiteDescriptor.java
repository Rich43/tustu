...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/NashornCallSiteDescriptor.class */
public final class NashornCallSiteDescriptor extends AbstractCallSiteDescriptor {
    ...
    static {
        ...
        canonicals = new ClassValue<ConcurrentMap<NashornCallSiteDescriptor, NashornCallSiteDescriptor>>() { // from class: jdk.nashorn.internal.runtime.linker.NashornCallSiteDescriptor.1
            ...
            protected /* bridge */ /* synthetic */ ConcurrentMap<NashornCallSiteDescriptor, NashornCallSiteDescriptor> computeValue(Class cls) {
    ...
    public static String toString(int flags) {
        ...
        if ((flags & 1) != 0) {
            if ((flags & 4) != 0) {
                ...
                if (!$assertionsDisabled && (flags & 4) != 0) {
                    throw new AssertionError((Object) "can't be fastscope without scope");
                }
                sb.append("scope ");
            }
            if ((flags & 32) != 0) {
    ...
    public String getFunctionDescription() {
        if (!$assertionsDisabled && !getFirstOperator().equals(Constants.ELEMNAME_CALL_STRING) && !getFirstOperator().equals("new")) {
            throw new AssertionError();
        }
    ...
    public static int getProgramPoint(CallSiteDescriptor desc) {
        ...
        throw new AssertionError((Object) ("program point requested from non-optimistic descriptor " + ((Object) desc)));
    }
