...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/ScriptingFunctions.class */
public final class ScriptingFunctions {
    ...
    public static Object readFully(Object self, Object file) throws IOException {
        ...
        if (file instanceof File) {
            ...
            f2 = new File(((CharSequence) file).toString());
        }
        if (f2 == null || !f2.isFile()) {
            throw ECMAErrors.typeError("not.a.file", ScriptRuntime.safeToString(file));
        }
        return new String(Source.readFully(f2));
    }

    public static Object exec(Object self, Object... args) throws InterruptedException, IOException {
    ...
    public static List<String> tokenizeString(String str) {
        ...
        while (nextToken(tokenizer) != -1) {
            ...
            if (s2.endsWith(FXMLLoader.ESCAPE_PREFIX)) {
                toAppend.append(s2.substring(0, s2.length() - 1)).append(' ');
            } else {
                tokenList.add(toAppend.append(s2).toString());
