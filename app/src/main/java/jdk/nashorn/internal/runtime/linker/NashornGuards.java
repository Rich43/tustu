...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/NashornGuards.class */
public final class NashornGuards {
    ...
    public static MethodHandle combineGuards(MethodHandle guard1, MethodHandle guard2) {
        ...
        return guard2 == null ? guard1 : Lookup.MH.guardWithTest(guard1, guard2, Lookup.MH.dropArguments(Lookup.MH.constant(Boolean.TYPE, false), 0, Object.class));
    }
