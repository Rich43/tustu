...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/BoundCallable.class */
public final class BoundCallable {
    ...
    private static boolean isEmptyArray(Object[] a2) {
        return a2 == null || a2.length == 0;
    }

    public String toString() {
        StringBuilder b2 = new StringBuilder(this.callable.toString()).append(" on ").append(this.boundThis);
        if (this.boundArgs.length != 0) {
            b2.append(" with ").append(Arrays.toString(this.boundArgs));
        }
        return b2.toString();
    }
}
