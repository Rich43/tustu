...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/NashornLinker.class */
final class NashornLinker implements TypeBasedGuardingDynamicLinker, GuardingTypeConverterFactory, ConversionComparator {
    ...
    static {
        ...
        MethodHandle listAdapterCreate = new jdk.internal.dynalink.support.Lookup(MethodHandles.lookup()).findStatic(ListAdapter.class, "create", MethodType.methodType((Class<?>) ListAdapter.class, (Class<?>) Object.class));
    ...
    public GuardedTypeConversion convertToType(Class<?> sourceType, Class<?> targetType) throws Exception {
        ...
        if (gi2 != null) {
            return new GuardedTypeConversion(gi2.asType(Lookup.MH.type(targetType, sourceType)), false);
        }
        return null;
    }
