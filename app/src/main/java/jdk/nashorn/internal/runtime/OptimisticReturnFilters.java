...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/OptimisticReturnFilters.class */
public final class OptimisticReturnFilters {
    ...
    public static MethodHandle filterOptimisticReturnValue(MethodHandle mh, Class<?> expectedReturnType, int programPoint) {
        ...
        return guard == null ? mh : Lookup.MH.filterReturnValue(mh, Lookup.MH.insertArguments(guard, guard.type().parameterCount() - 1, Integer.valueOf(programPoint)));
    }
    ...
    private static MethodHandle getOptimisticTypeGuard(Class<?> actual, Class<?> provable) {
        ...
        if (actual == Integer.TYPE) {
            ...
            if (!$assertionsDisabled && actual.isPrimitive()) {
                throw new AssertionError((Object) (((Object) actual) + ", " + ((Object) provable)));
            }
        }
    ...
    public static int ensureInt(Object arg, int programPoint) {
        if (isPrimitiveNumberWrapper(arg)) {
            double d2 = ((Number) arg).doubleValue();
            if (JSType.isStrictlyRepresentableAsInt(d2)) {
                return (int) d2;
            }
        }
    ...
    private static boolean isPrimitiveNumberWrapper(Object obj) {
        ...
        return c2 == Integer.class || c2 == Double.class || c2 == Long.class || c2 == Float.class || c2 == Short.class || c2 == Byte.class;
    }
