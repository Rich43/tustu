...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/arrays/SparseArrayData.class */
class SparseArrayData extends ArrayData {
    ...
    public Object[] asObjectArray() {
        ...
        for (int i2 = 0; i2 < underlyingLength; i2++) {
            objArray[i2] = this.underlying.getObject(i2);
        }
    ...
    public ArrayData shiftLeft(int by2) {
        this.underlying = this.underlying.shiftLeft(by2);
        TreeMap<Long, Object> newSparseMap = new TreeMap<>();
        for (Map.Entry<Long, Object> entry : this.sparseMap.entrySet()) {
            long newIndex = entry.getKey().longValue() - by2;
            if (newIndex >= 0) {
        ...
        setLength(Math.max(length() - by2, 0L));
    ...
    public ArrayData shiftRight(int by2) {
        ...
        if (len + by2 > this.maxDenseLength) {
            long tempLength = Math.max(0L, this.maxDenseLength - by2);
            long j2 = tempLength;
            while (true) {
                long i2 = j2;
                if (i2 >= len) {
                ...
                if (this.underlying.has((int) i2)) {
                    newSparseMap.put(Long.valueOf(i2 + by2), this.underlying.getObject((int) i2));
                }
                j2 = i2 + 1;
            }
        ...
        this.underlying = this.underlying.shiftRight(by2);
        for (Map.Entry<Long, Object> entry : this.sparseMap.entrySet()) {
            long newIndex = entry.getKey().longValue() + by2;
            newSparseMap.put(Long.valueOf(newIndex), entry.getValue());
        }
        this.sparseMap = newSparseMap;
        setLength(length() + by2);
        return this;
    }
    ...
    public ArrayData delete(int index) {
        ...
        } else if (index < this.underlying.length()) {
    ...
    public ArrayData slice(long from, long to) {
        ...
        while (true) {
            ...
            if (has((int) i2)) {
                sliced2 = sliced2.set((int) (i2 - start), getObject((int) i2), false);
            }
