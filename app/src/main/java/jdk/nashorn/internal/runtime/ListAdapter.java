...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/ListAdapter.class */
public class ListAdapter extends AbstractList<Object> implements RandomAccess, Deque<Object> {
    ...
    public final void push(Object e2) {
        addFirst(e2);
    }

    @Override // java.util.AbstractList, java.util.AbstractCollection, java.util.Collection, java.util.List
    public final boolean add(Object e2) {
        addLast(e2);
        return true;
    }

    @Override // java.util.Deque
    public final void addFirst(Object e2) {
        try {
            (void) getDynamicInvoker(UNSHIFT, ADD_INVOKER_CREATOR).invokeExact(getFunction("unshift"), this.obj, e2);
    ...
    @Override // java.util.Deque
    public final void addLast(Object e2) {
        try {
            (void) getDynamicInvoker(PUSH, ADD_INVOKER_CREATOR).invokeExact(getFunction("push"), this.obj, e2);
        } catch (Error | RuntimeException ex) {
            throw ex;
        } catch (Throwable t2) {
            throw new RuntimeException(t2);
    ...
    @Override // java.util.AbstractList, java.util.List
    public final void add(int index, Object e2) {
        try {
            if (index < 0) {
                throw invalidIndex(index);
            }
            if (index == 0) {
                ...
                int size = size();
                if (index < size) {
                    (void) getDynamicInvoker(SPLICE_ADD, SPLICE_ADD_INVOKER_CREATOR).invokeExact(this.obj.getMember("splice"), this.obj, index, 0, e2);
                } else if (index == size) {
                    addLast(e2);
                } else {
                    throw invalidIndex(index);
    ...
    @Override // java.util.Deque
    public final boolean offerFirst(Object e2) {
        addFirst(e2);
        return true;
    }

    @Override // java.util.Deque
    public final boolean offerLast(Object e2) {
        addLast(e2);
        return true;
    }
    ...
    private void invokeSpliceRemove(int fromIndex, int count) {
        try {
            (void) getDynamicInvoker(SPLICE_REMOVE, SPLICE_REMOVE_INVOKER_CREATOR).invokeExact(getFunction("splice"), this.obj, fromIndex, count);
        } catch (Error | RuntimeException ex) {
            throw ex;
        } catch (Throwable t2) {
            throw new RuntimeException(t2);
    ...
    @Override // java.util.Deque
    public final boolean removeFirstOccurrence(Object o2) {
        return removeOccurrence(o2, iterator());
    }

    @Override // java.util.Deque
    public final boolean removeLastOccurrence(Object o2) {
        return removeOccurrence(o2, descendingIterator());
    }

    private static boolean removeOccurrence(Object o2, Iterator<Object> it) {
        while (it.hasNext()) {
            if (Objects.equals(o2, it.next())) {
                it.remove();
                return true;
            }
        }
