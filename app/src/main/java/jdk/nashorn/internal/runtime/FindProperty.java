...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/FindProperty.class */
public final class FindProperty {
    ...
    public MethodHandle getGetter(Class<?> type, int programPoint, LinkRequest request) {
        ...
        if (this.property instanceof UserAccessorProperty) {
            MethodHandle getter2 = Lookup.MH.insertArguments(getter, 1, UserAccessorProperty.getINVOKE_UA_GETTER(type, programPoint));
            if (UnwarrantedOptimismException.isValid(programPoint) && type.isPrimitive()) {
                getter2 = Lookup.MH.insertArguments(getter2, 1, Integer.valueOf(programPoint));
            }
    ...
    private MethodHandle insertAccessorsGetter(UserAccessorProperty uap, LinkRequest request, MethodHandle mh) {
        ...
        return Lookup.MH.foldArguments(mh, Lookup.MH.asType(superGetter, superGetter.type().changeParameterType(0, Object.class)));
    }
