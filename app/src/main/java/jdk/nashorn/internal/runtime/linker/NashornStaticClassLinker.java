...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/NashornStaticClassLinker.class */
    ...
    public GuardedInvocation getGuardedInvocation(LinkRequest linkRequest, LinkerServices linkerServices) throws Exception {
        ...
        if ("new".equals(desc.getNameToken(1))) {
            ...
            if (NashornLinker.isAbstractClass(receiverClass)) {
                ...
                args[0] = JavaAdapterFactory.getAdapterClassFor((Class<?>[]) new Class[]{receiverClass}, (ScriptObject) null, linkRequest.getCallSiteDescriptor().getLookup());
