...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/regexp/joni/ast/ConsAltNode.class */
public final class ConsAltNode extends Node {
    ...
    public static ConsAltNode listAdd(ConsAltNode listp, Node x2) {
        ConsAltNode n2 = newListNode(x2, null);
