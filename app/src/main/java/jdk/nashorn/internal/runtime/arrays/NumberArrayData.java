...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/arrays/NumberArrayData.class */
final class NumberArrayData extends ContinuousArrayData implements NumericElements {
    ...
    private Object[] toObjectArray(boolean trim) {
        if (!$assertionsDisabled && length() > this.array.length) {
            throw new AssertionError((Object) "length exceeds internal array size");
        }
        int len = (int) length();
    ...
    public ArrayData shiftLeft(int by2) {
        if (by2 >= length()) {
            ...
            System.arraycopy(this.array, by2, this.array, 0, this.array.length - by2);
        }
        setLength(Math.max(0L, length() - by2));
        return this;
    }

    @Override // jdk.nashorn.internal.runtime.arrays.ArrayData
    public ArrayData shiftRight(int by2) {
        ArrayData newData = ensure((by2 + length()) - 1);
        if (newData != this) {
            newData.shiftRight(by2);
            return newData;
        }
        System.arraycopy(this.array, 0, this.array, by2, this.array.length - by2);
        return this;
    }
    ...
    public MethodHandle getElementSetter(Class<?> elementType) {
        if (elementType.isPrimitive()) {
            return getContinuousElementSetter(Lookup.MH.asType(SET_ELEM, SET_ELEM.type().changeParameterType(2, elementType)), elementType);
        }
        return null;
    }
    ...
    public String toString() {
        ...
        throw new AssertionError((Object) (length() + " > " + this.array.length));
    }
}
