...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/logging/DebugLogger.class */
public final class DebugLogger {
    ...
    private static java.util.logging.Logger instantiateLogger(String name, final Level level) {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() { // from class: jdk.nashorn.internal.runtime.logging.DebugLogger.1
            ...
            public Void run() throws SecurityException {
                ...
                Handler c2 = new ConsoleHandler();
                c2.setFormatter(new Formatter() { // from class: jdk.nashorn.internal.runtime.logging.DebugLogger.1.1
    ...
    public static String quote(String str) {
        ...
        char endQuote = 0;
        char quote = 0;
        if (str.startsWith(FXMLLoader.ESCAPE_PREFIX) || str.startsWith(PdfOps.DOUBLE_QUOTE__TOKEN)) {
            startQuote = str.charAt(0);
        }
        if (str.endsWith(FXMLLoader.ESCAPE_PREFIX) || str.endsWith(PdfOps.DOUBLE_QUOTE__TOKEN)) {
