...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/Bootstrap.class */
public final class Bootstrap {
    ...
    public static CallSite mathBootstrap(MethodHandles.Lookup lookup, String name, MethodType type, int programPoint) {
        ...
        return new ConstantCallSite(MH.insertArguments(mh, mh.type().parameterCount() - 1, Integer.valueOf(programPoint)));
    }
