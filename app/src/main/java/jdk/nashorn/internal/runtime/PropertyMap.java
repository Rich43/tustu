...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/PropertyMap.class */
public class PropertyMap implements Iterable<Object>, Serializable {
    ...
    public final PropertyMap replaceProperty(Property oldProperty, Property newProperty) {
        ...
        if (!$assertionsDisabled && !sameType && (!(oldProperty instanceof AccessorProperty) || !(newProperty instanceof UserAccessorProperty))) {
            throw new AssertionError((Object) ("arbitrary replaceProperty attempted " + sameType + " oldProperty=" + ((Object) oldProperty.getClass()) + " newProperty=" + ((Object) newProperty.getClass()) + " [" + ((Object) oldProperty.getLocalType()) + " => " + ((Object) newProperty.getLocalType()) + "]"));
        }
    ...
    public final PropertyMap addAll(PropertyMap other) {
        if (!$assertionsDisabled && this == other) {
            throw new AssertionError((Object) "adding property map to itself");
        }
    ...
    boolean isInvalidSharedMapFor(ScriptObject prototype) {
        return (this.sharedProtoMap == null || (this.sharedProtoMap.isValidSharedProtoMap() && prototype != null && this.sharedProtoMap == prototype.getMap())) ? false : true;
    }

    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/PropertyMap$PropertyMapIterator.class */
    ...
    public static String diff(PropertyMap map0, PropertyMap map1) {
        ...
        if (map0 != map1) {
            ...
            boolean found = false;
            for (Property p2 : map0.getProperties()) {
                Property p22 = map1.findProperty(p2.getKey());
                if (p22 == null) {
                    sb.append("FIRST ONLY : [").append((Object) p2).append("]");
                    found = true;
                } else if (p22 != p2) {
                    sb.append("DIFFERENT  : [").append((Object) p2).append("] != [").append((Object) p22).append("]");
                    found = true;
                }
            }
            for (Property p23 : map1.getProperties()) {
                Property p1 = map0.findProperty(p23.getKey());
                if (p1 == null) {
                    sb.append("SECOND ONLY: [").append((Object) p23).append("]");
                    found = true;
                }
            }
            if (!found) {
