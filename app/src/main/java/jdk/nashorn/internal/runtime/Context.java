...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context.class */
public final class Context {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$BuiltinSwitchPoint.class */
    public static final class BuiltinSwitchPoint extends SwitchPoint {
    }

    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$FieldMode.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$MultiGlobalCompiledScript.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$ContextCodeInstaller.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$ThrowErrorManager.class */
    ...
    public MultiGlobalCompiledScript compileScript(Source source) throws CompilationException {
    ...
    public Object eval(ScriptObject initialScope, String string, Object callThis, Object location, boolean strict, boolean evalCall) throws CompilationException {
        Object evalThis;
        ...
        try {
            ...
            e3.throwAsEcmaException(global);
            return null;
        }
    }

    private static ScriptObject newScope(ScriptObject callerScope) {
        return new Scope(callerScope, PropertyMap.newMap((Class<? extends ScriptObject>) Scope.class));
    }
        ...
        if (src instanceof String) {
            ...
            if (srcStr.startsWith(LOAD_CLASSPATH)) {
                ...
                if (srcStr.indexOf(58) != -1) {
                    Source sourceLoadInternal = loadInternal(srcStr, LOAD_NASHORN, "resources/");
                    source = sourceLoadInternal;
                    if (sourceLoadInternal == null) {
                        Source sourceLoadInternal2 = loadInternal(srcStr, LOAD_FX, "resources/fx/");
                        source = sourceLoadInternal2;
                        if (sourceLoadInternal2 == null) {
                            try {
                                url = new URL(srcStr);
    ...
    public Object loadWithNewGlobal(Object from, Object... args) throws IOException {
        ...
        try {
            Object objUnwrap = ScriptObjectMirror.unwrap(ScriptObjectMirror.wrap(load(newGlobal, from), newGlobal), oldGlobal);
            setGlobal(oldGlobal);
            return objUnwrap;
        } catch (Throwable th) {
            setGlobal(oldGlobal);
    ...
    public static void checkPackageAccess(Class<?> clazz) {
        ...
        if (sm != null) {
            ...
            while (true) {
                Class<?> bottomClazz = componentType;
                if (bottomClazz.isArray()) {
                    componentType = bottomClazz.getComponentType();
                } else {
    ...
    public static void printStackTrace(Throwable t2) {
        if (DEBUG) {
            t2.printStackTrace(getCurrentErr());
        }
    }
    ...
    private static MethodHandle getCreateProgramFunctionHandle(Class<?> script) {
        try {
            ...
            throw new AssertionError("Failed to retrieve a handle for the program function for " + script.getName(), e2);
        }
    }
    ...
    public static ScriptFunction invokeCreateProgramFunctionHandle(MethodHandle createProgramFunctionHandle, ScriptObject scope) {
        try {
            ...
            throw new AssertionError("Failed to create a program function", t2);
        }
    }
    ...
    private synchronized Class<?> compile(Source source, ErrorManager errMan, boolean strict) throws CompilationException {
        Class<?> script;
        errMan.reset();
        ...
        boolean useCodeStore = (this.codeStore == null || this.env._parse_only || (this.env._optimistic_types && !this.env._lazy_compilation)) ? false : true;
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$ClassCache.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/Context$ClassReference.class */
