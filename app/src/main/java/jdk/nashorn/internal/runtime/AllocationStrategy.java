...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/AllocationStrategy.class */
public final class AllocationStrategy implements Serializable {
    ...
    ScriptObject allocate(PropertyMap map) {
        try {
            ...
            return (ScriptObject) this.allocator.invokeExact(map);
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/AllocationStrategy$AllocatorMap.class */
