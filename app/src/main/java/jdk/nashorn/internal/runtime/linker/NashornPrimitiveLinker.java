...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/NashornPrimitiveLinker.class */
final class NashornPrimitiveLinker implements TypeBasedGuardingDynamicLinker, GuardingTypeConverterFactory, ConversionComparator {
    ...
    private static boolean isJavaScriptPrimitive(Object o2) {
        return JSType.isString(o2) || (o2 instanceof Boolean) || JSType.isNumber(o2) || o2 == null;
    }
