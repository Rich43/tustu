...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/JSONFunctions.class */
public final class JSONFunctions {
    ...
    public static Object parse(Object text, Object reviver) {
        ...
        try {
            ...
            throw ECMAErrors.syntaxError(e2, "invalid.json", e2.getMessage());
        }
    }
    ...
    private static Object walk(ScriptObject holder, Object name, Object reviver) {
        ...
        try {
            return (Object) getREVIVER_INVOKER().invokeExact(reviver, holder, JSType.toString(name), val);
