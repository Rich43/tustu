...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/GlobalFunctions.class */
public final class GlobalFunctions {
    ...
    private static double parseIntInternal(String str, int rad) {
        ...
        while (idx < length) {
            int i2 = idx;
            idx++;
            int digit = fastDigit(str.charAt(i2), radix);
            if (digit < 0) {
                break;
            }
            entered = true;
    ...
    */
    ...
    public static String unescape(Object self, Object string) {
        ...
        while (k2 < length) {
            ...
            if (ch != '%') {
                sb.append(ch);
            } else if (k2 < length - 5 && str.charAt(k2 + 1) == 'u') {
                try {
                    ch = (char) Integer.parseInt(str.substring(k2 + 2, k2 + 6), 16);
                    sb.append(ch);
                    k2 += 5;
                ...
                try {
                    ch = (char) Integer.parseInt(str.substring(k2 + 1, k2 + 3), 16);
                    sb.append(ch);
                    k2 += 2;
