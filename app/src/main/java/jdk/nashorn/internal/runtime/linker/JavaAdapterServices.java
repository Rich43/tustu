...
/* loaded from: nashorn.jar:jdk/nashorn/internal/runtime/linker/JavaAdapterServices.class */
public final class JavaAdapterServices {
    ...
    public static void invokeNoPermissions(MethodHandle method, Object arg) throws Throwable {
        (void) NO_PERMISSIONS_INVOKER.invokeExact(method, arg);
    }
    ...
    private static MethodHandle createNoPermissionsInvoker() {
        ...
        Type objectType = Type.getType((Class<?>) Object.class);
        Type methodHandleType = Type.getType((Class<?>) MethodHandle.class);
