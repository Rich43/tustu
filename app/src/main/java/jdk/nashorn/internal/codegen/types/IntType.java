...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/types/IntType.class */
class IntType extends BitwiseType {
    ...
    static {
        ...
        VALUE_OF = CompilerConstants.staticCallNoLookup(Integer.class, BeanAdapter.VALUE_OF_METHOD_NAME, Integer.class, Integer.TYPE);
    }
    ...
    public Type ldc(MethodVisitor method, Object c2) {
        if (!$assertionsDisabled && !(c2 instanceof Integer)) {
            throw new AssertionError();
        }
        int value = ((Integer) c2).intValue();
        switch (value) {
            case -1:
                method.visitInsn(2);
                break;
    ...
    public Type sub(MethodVisitor method, int programPoint) {
        if (programPoint == -1) {
            ...
            method.visitInvokeDynamicInsn("isub", "(II)I", MATHBOOTSTRAP, Integer.valueOf(programPoint));
        }
        return INT;
    }
    ...
    public Type mul(MethodVisitor method, int programPoint) {
        if (programPoint == -1) {
            ...
            method.visitInvokeDynamicInsn("imul", "(II)I", MATHBOOTSTRAP, Integer.valueOf(programPoint));
        }
        return INT;
    }
    ...
    public Type div(MethodVisitor method, int programPoint) {
        if (programPoint == -1) {
            ...
            method.visitInvokeDynamicInsn("idiv", "(II)I", MATHBOOTSTRAP, Integer.valueOf(programPoint));
        }
        return INT;
    }
    ...
    public Type rem(MethodVisitor method, int programPoint) {
        if (programPoint == -1) {
            ...
            method.visitInvokeDynamicInsn("irem", "(II)I", MATHBOOTSTRAP, Integer.valueOf(programPoint));
        }
        return INT;
    }
    ...
    public Type neg(MethodVisitor method, int programPoint) {
        if (programPoint == -1) {
            ...
            method.visitInvokeDynamicInsn("ineg", Constants.GET_PARENT_SIG, MATHBOOTSTRAP, Integer.valueOf(programPoint));
        }
        return INT;
    }
