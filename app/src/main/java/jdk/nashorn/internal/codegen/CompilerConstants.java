...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilerConstants.class */
public enum CompilerConstants {
    __FILE__,
    __DIR__,
    __LINE__,
    INIT(Constants.CONSTRUCTOR_NAME),
    CLINIT(Constants.STATIC_INITIALIZER_NAME),
    EVAL(com.sun.org.apache.xalan.internal.templates.Constants.ELEMNAME_EVAL_STRING),
    ...
    NESTED_FUNCTION_SEPARATOR(FXMLLoader.CONTROLLER_METHOD_PREFIX),
    ID_FUNCTION_SEPARATOR(LanguageTag.SEP),
    PROGRAM(":program"),
    ...
    static {
        ...
        for (CompilerConstants c2 : values()) {
            String symbolName = c2.symbolName();
            if (symbolName != null) {
                symbolName.intern();
            }
        }
    ...
    public final String descriptor() {
        ...
        throw new AssertionError((Object) " asking for descriptor of typeless constant");
    }
    ...
    public static Call staticCall(MethodHandles.Lookup lookup, Class<?> clazz, String name, Class<?> rtype, Class<?>... ptypes) {
        return new Call(Lookup.MH.findStatic(lookup, clazz, name, Lookup.MH.type(rtype, ptypes)), className(clazz), name, methodDescriptor(rtype, ptypes)) { // from class: jdk.nashorn.internal.codegen.CompilerConstants.7
            @Override // jdk.nashorn.internal.codegen.CompilerConstants.Call
            MethodEmitter invoke(MethodEmitter method) {
                return method.invokestatic(this.className, this.name, this.descriptor);
            }
    ...
    public static Call virtualCall(MethodHandles.Lookup lookup, Class<?> clazz, String name, Class<?> rtype, Class<?>... ptypes) {
        return new Call(Lookup.MH.findVirtual(lookup, clazz, name, Lookup.MH.type(rtype, ptypes)), className(clazz), name, methodDescriptor(rtype, ptypes)) { // from class: jdk.nashorn.internal.codegen.CompilerConstants.8
            @Override // jdk.nashorn.internal.codegen.CompilerConstants.Call
            MethodEmitter invoke(MethodEmitter method) {
                return method.invokevirtual(this.className, this.name, this.descriptor);
            }
    ...
    public static Call specialCall(MethodHandles.Lookup lookup, Class<?> clazz, String name, Class<?> rtype, Class<?>... ptypes) {
        return new Call(Lookup.MH.findSpecial(lookup, clazz, name, Lookup.MH.type(rtype, ptypes), clazz), className(clazz), name, methodDescriptor(rtype, ptypes)) { // from class: jdk.nashorn.internal.codegen.CompilerConstants.9
            @Override // jdk.nashorn.internal.codegen.CompilerConstants.Call
            MethodEmitter invoke(MethodEmitter method) {
                return method.invokespecial(this.className, this.name, this.descriptor);
            }
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilerConstants$Access.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilerConstants$FieldAccess.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilerConstants$Call.class */
