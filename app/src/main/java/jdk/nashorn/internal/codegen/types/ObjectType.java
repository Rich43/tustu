...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/types/ObjectType.class */
class ObjectType extends Type {
    ...
    public Type ldc(MethodVisitor method, Object c2) {
        ...
        if (c2 instanceof Handle) {
            method.visitLdcInsn(c2);
            return Type.typeFor((Class<?>) MethodHandle.class);
        }
        throw new UnsupportedOperationException("implementation missing for class " + ((Object) c2.getClass()) + " value=" + c2);
    }
    ...
    public Type convert(MethodVisitor method, Type to) {
        ...
        if (to.isInteger()) {
            ...
            throw new UnsupportedOperationException("Illegal conversion " + ((Object) this) + " -> " + ((Object) to) + " " + isString() + " " + toString);
        }
        return to;
    }
