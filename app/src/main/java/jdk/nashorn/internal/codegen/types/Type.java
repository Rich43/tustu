...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/types/Type.class */
public abstract class Type implements Comparable<Type>, BytecodeOps, Serializable {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/types/Type$Unknown.class */
    ...
    Type(String name, Class<?> clazz, int weight, int slots) {
        ...
        if (!$assertionsDisabled && (weight < -1 || weight > 20)) {
            throw new AssertionError((Object) ("illegal type weight: " + weight));
        }
        this.slots = slots;
    ...
    public static String getMethodDescriptor(Type returnType, Type... types) {
        ...
        for (int i2 = 0; i2 < types.length; i2++) {
            itypes[i2] = types[i2].getInternalType();
        }
    ...
    public static String getMethodDescriptor(Class<?> returnType, Class<?>... types) {
        jdk.internal.org.objectweb.asm.Type[] itypes = new jdk.internal.org.objectweb.asm.Type[types.length];
        for (int i2 = 0; i2 < types.length; i2++) {
            itypes[i2] = getInternalType(types[i2]);
        }
    ...
    static Type typeFor(jdk.internal.org.objectweb.asm.Type itype) {
        switch (itype.getSort()) {
            ...
            default:
                ...
                throw new AssertionError((Object) ("Unknown itype : " + ((Object) itype) + " sort " + itype.getSort()));
            case 5:
                return INT;
            case 7:
                return LONG;
    ...
    public static Type[] getMethodArguments(String methodDescriptor) {
        ...
        for (int i2 = 0; i2 < itypes.length; i2++) {
            types[i2] = typeFor(itypes[i2]);
        }
        return types;
    }
    ...
    public static void writeTypeMap(Map<Integer, Type> typeMap, DataOutput output) throws IOException {
        ...
        for (Map.Entry<Integer, Type> e2 : typeMap.entrySet()) {
            output.writeInt(e2.getKey().intValue());
            Type type = e2.getValue();
            if (type == OBJECT) {
                b2 = 76;
            } else if (type == NUMBER) {
                b2 = 68;
    ...
    private static jdk.internal.org.objectweb.asm.Type lookupInternalType(Class<?> type) {
        Map<Class<?>, jdk.internal.org.objectweb.asm.Type> c2 = INTERNAL_TYPE_CACHE;
        jdk.internal.org.objectweb.asm.Type itype = c2.get(type);
        if (itype != null) {
            return itype;
        }
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/types/Type$ValueLessType.class */
    private static abstract class ValueLessType extends Type {
        ...
        public Type ldc(MethodVisitor method, Object c2) {
            throw new UnsupportedOperationException("ldc " + c2);
        }
        ...
        public Type convert(MethodVisitor method, Type to) {
            throw new UnsupportedOperationException("convert => " + ((Object) to));
        }
