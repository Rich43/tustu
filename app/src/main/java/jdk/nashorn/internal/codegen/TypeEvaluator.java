...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/TypeEvaluator.class */
final class TypeEvaluator {
    ...
    void declareLocalSymbol(String symbolName) {
        if (!$assertionsDisabled && (!this.compiler.useOptimisticTypes() || !this.compiler.isOnDemandCompilation() || this.runtimeScope == null)) {
            throw new AssertionError((Object) ("useOptimistic=" + this.compiler.useOptimisticTypes() + " isOnDemand=" + this.compiler.isOnDemandCompilation() + " scope=" + ((Object) this.runtimeScope)));
        }
