...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/types/ArrayType.class */
public class ArrayType extends ObjectType implements BytecodeArrayOps {
    ...
    @Override // jdk.nashorn.internal.codegen.types.ObjectType, jdk.nashorn.internal.codegen.types.BytecodeOps
    public /* bridge */ /* synthetic */ void store(MethodVisitor methodVisitor, int i2) {
        super.store(methodVisitor, i2);
    }

    @Override // jdk.nashorn.internal.codegen.types.ObjectType, jdk.nashorn.internal.codegen.types.BytecodeOps
    public /* bridge */ /* synthetic */ Type add(MethodVisitor methodVisitor, int i2) {
        return super.add(methodVisitor, i2);
    }
