...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/FunctionSignature.class */
public final class FunctionSignature {
    ...
    private FunctionSignature(boolean hasSelf, boolean hasCallee, Type retType, Type... argTypes) {
        ...
        if (hasSelf) {
            int i2 = next;
            next++;
            this.paramTypes[i2] = Type.OBJECT;
        }
        if (isVarArg) {
            ...
            while (next < count) {
                int i3 = j2;
                j2++;
                Type type = argTypes[i3];
                int i4 = next;
                next++;
                this.paramTypes[i4] = type.isObject() ? Type.OBJECT : type;
            }
        } else if (!$assertionsDisabled) {
            throw new AssertionError((Object) "isVarArgs cannot be false when argTypes are null");
        }
