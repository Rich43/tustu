...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase.class */
abstract class CompilationPhase {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$ConstantFoldingPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$LoweringPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$ApplySpecializationPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$SplittingPhase.class */
    private static final class SplittingPhase extends CompilationPhase {
        ...
        FunctionNode transform(Compiler compiler, Compiler.CompilationPhases phases, FunctionNode fn) {
            ...
            if (!$assertionsDisabled && newFunctionNode2.getCompileUnit() != outermostCompileUnit) {
                throw new AssertionError((Object) ("fn=" + fn.getName() + ", fn.compileUnit (" + ((Object) newFunctionNode2.getCompileUnit()) + ") != " + ((Object) outermostCompileUnit)));
            }
            if ($assertionsDisabled || newFunctionNode2.isStrict() == compiler.isStrict()) {
                return newFunctionNode2;
            }
            throw new AssertionError((Object) ("functionNode.isStrict() != compiler.isStrict() for " + DebugLogger.quote(newFunctionNode2.getName())));
        }
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$ProgramPointPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$CacheAstPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$SymbolAssignmentPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$ScopeDepthComputationPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$DeclareLocalSymbolsPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$OptimisticTypeAssignmentPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$LocalVariableTypeCalculationPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$ReuseCompileUnitsPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$ReinitializeCachedPhase.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$BytecodeGenerationPhase.class */
    private static final class BytecodeGenerationPhase extends CompilationPhase {
        ...
        @Override // jdk.nashorn.internal.codegen.CompilationPhase
        FunctionNode transform(Compiler compiler, Compiler.CompilationPhases phases, FunctionNode fn) throws IOException {
            ScriptEnvironment senv = compiler.getScriptEnvironment();
            ...
            try {
                ...
                if (senv._verify_code || senv._print_code) {
                    senv.getErr().println(e2.getClass().getSimpleName() + ": " + e2.getMessage());
                    if (senv._dump_on_error) {
                        e2.printStackTrace(senv.getErr());
                    }
                } else {
                    throw e2;
                }
            } catch (Throwable e3) {
                throw new AssertionError("Failed generating bytecode for " + fn.getSourceName() + CallSiteDescriptor.TOKEN_DELIMITER + codegen.getLastLineNumber(), e3);
            }
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/CompilationPhase$InstallPhase.class */
