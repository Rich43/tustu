...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/SpillObjectCreator.class */
public final class SpillObjectCreator extends ObjectCreator<Expression> {
    ...
    public void createObject(MethodEmitter method) {
        ...
        method.invoke(CompilerConstants.constructorNoLookup(objectClass, (Class<?>[]) new Class[]{PropertyMap.class, long[].class, Object[].class}));
    ...
    public void populateRange(MethodEmitter method, Type objectType, int objectSlot, int start, int end) {
        ...
        for (int i2 = start; i2 < end; i2++) {
            MapTuple<Expression> tuple = (MapTuple) this.tuples.get(i2);
