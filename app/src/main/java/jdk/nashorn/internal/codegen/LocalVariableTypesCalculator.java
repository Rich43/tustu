...
/* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator.class */
final class LocalVariableTypesCalculator extends SimpleNodeVisitor {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$JumpOrigin.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$JumpTarget.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$LvarType.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$TypeHolderExpression.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$SymbolConversions.class */
    private static class SymbolConversions {
        ...
        private static void illegalConversion(LvarType from, LvarType to) {
            throw new AssertionError((Object) ("Invalid conversion from " + ((Object) from) + " to " + ((Object) to)));
        }
    ...
    public boolean enterBinaryNode(BinaryNode binaryNode) {
        ...
        if (!(expressionLhs instanceof IdentNode) || !binaryNode.isTokenType(TokenType.ASSIGN)) {
            lhsType = visitExpression(expressionLhs);
        } else {
        ...
        if (isLogical) {
            jumpToLabel((JoinPredecessor) expressionLhs, joinLabel);
        }
        Expression expressionRhs = binaryNode.rhs();
        LvarType rhsType = visitExpression(expressionRhs);
        if (isLogical) {
            jumpToLabel((JoinPredecessor) expressionRhs, joinLabel);
        }
        ...
        if (binaryNode.isAssignment() && (expressionLhs instanceof IdentNode)) {
            if (binaryNode.isSelfModifying()) {
                onSelfAssignment((IdentNode) expressionLhs, type);
            } else {
                onAssignment((IdentNode) expressionLhs, type);
            }
        }
    ...
    private boolean enterJumpStatement(JumpStatement jump) {
        ...
        assertTypeStackIsEmpty();
        jumpToLabel(jump, jump.getTargetLabel(this.lc), getBreakTargetTypes(jump.getPopScopeLimit(this.lc)));
    ...
    public boolean enterSwitchNode(SwitchNode switchNode) {
        ...
        Iterator<CaseNode> it = cases.iterator();
        while (it.hasNext()) {
    ...
    public boolean enterTernaryNode(TernaryNode ternaryNode) {
        ...
        if (!Expression.isAlwaysFalse(test)) {
            trueType = visitExpression(trueExpression);
        } else {
            trueType = null;
        }
        ...
        if (!Expression.isAlwaysTrue(test)) {
            falseType = visitExpression(falseExpression);
        } else {
            falseType = null;
        }
        ...
        setConversion(trueExpression, trueExitLvarTypes, this.localVariableTypes);
        setConversion(falseExpression, falseExitLvarTypes, this.localVariableTypes);
    ...
    private static <T> T assertNotNull(T t2) {
        ...
        SimpleNodeVisitor applyChangesVisitor = new SimpleNodeVisitor() { // from class: jdk.nashorn.internal.codegen.LocalVariableTypesCalculator.1
            ...
            public Node leaveBinaryNode(BinaryNode binaryNode) {
                if (binaryNode.isComparison()) {
                    ...
                    switch (AnonymousClass2.$SwitchMap$jdk$nashorn$internal$parser$TokenType[tt.ordinal()]) {
                        case 1:
                        case 2:
            ...
            protected Node leaveDefault(Node node) {
                if (node instanceof JoinPredecessor) {
                    ...
                    if (!$assertionsDisabled && original.getClass() != node.getClass()) {
                        throw new AssertionError((Object) (original.getClass().getName() + "!=" + node.getClass().getName()));
                    }
                    Object localVariableConversion = setLocalVariableConversion(original, (JoinPredecessor) node);
            ...
            private <T extends JoinPredecessor> T setLocalVariableConversion(JoinPredecessor joinPredecessor, T t2) {
                return (T) t2.setLocalVariableConversion(this.lc, (LocalVariableConversion) LocalVariableTypesCalculator.this.localVariableConversions.get(joinPredecessor));
            }
        };
        FunctionNode newFunction = functionNode.setBody(this.lc, (Block) functionNode.getBody().accept(applyChangesVisitor)).setReturnType(this.lc, this.returnType);
        return newFunction.setParameters(this.lc, newFunction.visitParameters(applyChangesVisitor));
    }

    /* renamed from: jdk.nashorn.internal.codegen.LocalVariableTypesCalculator$2, reason: invalid class name */
    /* loaded from: nashorn.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$2.class */
