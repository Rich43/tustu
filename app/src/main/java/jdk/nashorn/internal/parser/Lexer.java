...
/* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer.class */
public class Lexer extends Scanner {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer$LineInfoReceiver.class */
    protected interface LineInfoReceiver {
        void lineInfo(int i2, int i3);
    }
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer$State.class */
    ...
    private int hexSequence(int length, TokenType type) throws ParserException {
        int value = 0;
    ...
    private int octalSequence() {
        int digit;
        int value = 0;
        for (int i2 = 0; i2 < 3 && (digit = convertDigit(this.ch0, 8)) != -1; i2++) {
            value = digit | (value << 3);
            skip(1);
            if (i2 == 1 && value >= 32) {
                break;
    ...
    private void scanIdentifierOrKeyword() throws ParserException {
        int start = this.position;
    ...
    protected void scanString(boolean add) throws ParserException {
    ...
    protected void scanNumber() throws ParserException {
        int start = this.position;
    ...
    private boolean scanXMLLiteral() throws ParserException {
    ...
    private int scanIdentifier() throws ParserException {
        int start = this.position;
        if (this.ch0 == '\\' && this.ch1 == 'u') {
            skip(2);
            int ch = hexSequence(4, TokenType.IDENT);
    ...
    private boolean identifierEqual(int aStart, int aLength, int bStart, int bLength) {
        if (aLength == bLength) {
            for (int i2 = 0; i2 < aLength; i2++) {
                if (this.content[aStart + i2] != this.content[bStart + i2]) {
                    return false;
                }
            }
            return true;
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer$EditStringLexer.class */
    ...
    private boolean scanHereString(LineInfoReceiver lir) throws ParserException {
        int stringEnd;
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer$LexerToken.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer$RegexToken.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/parser/Lexer$XMLToken.class */
