...
@Immutable
/* loaded from: nashorn.jar:jdk/nashorn/internal/ir/FunctionNode.class */
public final class FunctionNode extends LexicalContextExpression implements Flags<FunctionNode>, CompileUnitHolder {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/ir/FunctionNode$Kind.class */
    public enum Kind {
        NORMAL,
        SCRIPT,
        GETTER,
    ...
    public void toString(StringBuilder sb, boolean printTypes) {
        ...
        sb.append(Constants.EXSLT_ELEMNAME_FUNCTION_STRING);
        if (this.ident != null) {
            sb.append(' ');
    ...
    @Override // jdk.nashorn.internal.ir.CompileUnitHolder
