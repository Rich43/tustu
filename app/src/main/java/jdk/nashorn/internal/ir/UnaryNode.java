...
@Immutable
/* loaded from: nashorn.jar:jdk/nashorn/internal/ir/UnaryNode.class */
public final class UnaryNode extends Expression implements Assignment<Expression>, Optimistic {
    ...
    @Override // jdk.nashorn.internal.ir.Assignment
    public UnaryNode setAssignmentDest(Expression n2) {
        return setExpression(n2);
    }
    ...
    public void toString(StringBuilder sb, Runnable rhsStringBuilder, boolean printType) {
        ...
        if (isOptimistic()) {
            sb.append(FXMLLoader.RESOURCE_KEY_PREFIX);
        }
