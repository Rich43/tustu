...
/* loaded from: nashorn.jar:jdk/nashorn/internal/ir/Symbol.class */
public final class Symbol implements Comparable<Symbol>, Cloneable, Serializable {
    ...
    void print(PrintWriter stream) {
        StringBuilder sb = new StringBuilder();
        sb.append(align(this.name, 20)).append(": ").append(", ").append(align(this.firstSlot == -1 ? Separation.COLORANT_NONE : "" + this.firstSlot, 10));
        switch (this.flags & 3) {
            case 1:
                sb.append(" global");
                break;
    ...
    public boolean isDead() {
        return (this.flags & Krb5Token.MIC_ID_v2) == 0;
    }
    ...
    public boolean isScope() {
        ...
        throw new AssertionError((Object) "global without scope flag");
    }
    ...
    public int getFieldIndex() {
        ...
        throw new AssertionError((Object) ("fieldIndex must be initialized " + this.fieldIndex));
    }
    ...
    public int getSlot(Type type) {
        ...
        throw new AssertionError((Object) this.name);
    }
