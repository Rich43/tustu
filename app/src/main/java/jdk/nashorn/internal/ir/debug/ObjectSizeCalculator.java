...
/* loaded from: nashorn.jar:jdk/nashorn/internal/ir/debug/ObjectSizeCalculator.class */
public final class ObjectSizeCalculator {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/ir/debug/ObjectSizeCalculator$MemoryLayoutSpecification.class */
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/ir/debug/ObjectSizeCalculator$CurrentLayout.class */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void visit(Object obj) throws IllegalArgumentException {
    ...
    private void visitArray(Object array) throws IllegalArgumentException {
    ...
    /* loaded from: nashorn.jar:jdk/nashorn/internal/ir/debug/ObjectSizeCalculator$ArrayElementsVisitor.class */
    private static class ArrayElementsVisitor {
        ...
        public void visit(ObjectSizeCalculator calc) throws IllegalArgumentException {
    ...
    static long roundTo(long x2, int multiple) {
        return (((x2 + multiple) - 1) / multiple) * multiple;
    }

    /* loaded from: nashorn.jar:jdk/nashorn/internal/ir/debug/ObjectSizeCalculator$ClassSizeInfo.class */
    private class ClassSizeInfo {
        private final long objectSize;
        private final long fieldsSize;
        private final Field[] referenceFields;

        public ClassSizeInfo(Class<?> clazz) throws SecurityException {
        ...
        public void enqueueReferencedObjects(Object obj, ObjectSizeCalculator calc) {
            for (Field f2 : this.referenceFields) {
                try {
                    calc.enqueue(f2.get(obj));
                } catch (IllegalAccessException e2) {
                    AssertionError ae2 = new AssertionError((Object) ("Unexpected denial of access to " + ((Object) f2)));
                    ae2.initCause(e2);
                    throw ae2;
                }
            }
    ...
    public static MemoryLayoutSpecification getEffectiveMemoryLayoutSpecification() throws NumberFormatException {
        ...
        if ("32".equals(dataModel)) {
            return new MemoryLayoutSpecification() { // from class: jdk.nashorn.internal.ir.debug.ObjectSizeCalculator.1
                @Override // jdk.nashorn.internal.ir.debug.ObjectSizeCalculator.MemoryLayoutSpecification
