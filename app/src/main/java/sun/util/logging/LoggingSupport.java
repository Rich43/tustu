...
/* loaded from: rt.jar:sun/util/logging/LoggingSupport.class */
public class LoggingSupport {
    private static final LoggingProxy proxy = (LoggingProxy) AccessController.doPrivileged(new PrivilegedAction<LoggingProxy>() { // from class: sun.util.logging.LoggingSupport.1
        ...
        /* renamed from: run */
        public LoggingProxy run2() throws SecurityException {
            try {
    ...
    static String getSimpleFormat(boolean z2) {
        String property = (String) AccessController.doPrivileged(new PrivilegedAction<String>() { // from class: sun.util.logging.LoggingSupport.2
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // java.security.PrivilegedAction
            /* renamed from: run */
            public String run2() {
        ...
        if (z2 && proxy != null && property == null) {
