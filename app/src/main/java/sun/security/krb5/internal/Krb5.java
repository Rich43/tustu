...
/* loaded from: rt.jar:sun/security/krb5/internal/Krb5.class */
public class Krb5 {
    ...
    private static Hashtable<Integer, String> errMsgList = new Hashtable<>();

    public static String getErrorMessage(int i2) {
        return errMsgList.get(Integer.valueOf(i2));
    }

    static {
        errMsgList.put(0, "No error");
        errMsgList.put(1, "Client's entry in database expired");
        errMsgList.put(2, "Server's entry in database has expired");
        errMsgList.put(3, "Requested protocol version number not supported");
        errMsgList.put(4, "Client's key encrypted in old master key");
        errMsgList.put(5, "Server's key encrypted in old master key");
        errMsgList.put(6, "Client not found in Kerberos database");
        errMsgList.put(7, "Server not found in Kerberos database");
        errMsgList.put(8, "Multiple principal entries in database");
        errMsgList.put(9, "The client or server has a null key");
        errMsgList.put(10, "Ticket not eligible for postdating");
        errMsgList.put(11, "Requested start time is later than end time");
        errMsgList.put(12, "KDC policy rejects request");
        errMsgList.put(13, "KDC cannot accommodate requested option");
        errMsgList.put(14, "KDC has no support for encryption type");
        errMsgList.put(15, "KDC has no support for checksum type");
        errMsgList.put(16, "KDC has no support for padata type");
        errMsgList.put(17, "KDC has no support for transited type");
        errMsgList.put(18, "Clients credentials have been revoked");
        errMsgList.put(19, "Credentials for server have been revoked");
        errMsgList.put(20, "TGT has been revoked");
        errMsgList.put(21, "Client not yet valid - try again later");
        errMsgList.put(22, "Server not yet valid - try again later");
        errMsgList.put(23, "Password has expired - change password to reset");
        errMsgList.put(24, "Pre-authentication information was invalid");
        errMsgList.put(25, "Additional pre-authentication required");
        errMsgList.put(31, "Integrity check on decrypted field failed");
        errMsgList.put(32, "Ticket expired");
        errMsgList.put(33, "Ticket not yet valid");
        errMsgList.put(34, "Request is a replay");
        errMsgList.put(35, "The ticket isn't for us");
        errMsgList.put(36, "Ticket and authenticator don't match");
        errMsgList.put(37, "Clock skew too great");
        errMsgList.put(38, "Incorrect net address");
        errMsgList.put(39, "Protocol version mismatch");
        errMsgList.put(40, "Invalid msg type");
        errMsgList.put(41, "Message stream modified");
        errMsgList.put(42, "Message out of order");
        errMsgList.put(44, "Specified version of key is not available");
        errMsgList.put(45, "Service key not available");
        errMsgList.put(46, "Mutual authentication failed");
        errMsgList.put(47, "Incorrect message direction");
        errMsgList.put(48, "Alternative authentication method required");
        errMsgList.put(49, "Incorrect sequence number in message");
        errMsgList.put(50, "Inappropriate type of checksum in message");
        errMsgList.put(52, "Response too big for UDP, retry with TCP");
        errMsgList.put(60, "Generic error (description in e-text)");
        errMsgList.put(61, "Field is too long for this implementation");
        errMsgList.put(62, "Realm name not available");
        errMsgList.put(400, "Invalid argument");
        errMsgList.put(500, "BitString size does not match input byte array");
        errMsgList.put(501, "BitString bit index does not fall within size");
        errMsgList.put(502, "BitString length is wrong for the expected type");
        errMsgList.put(600, "Illegal character in realm name; one of: '/', ':', '��'");
        errMsgList.put(601, "Null realm name");
        errMsgList.put(900, "Input not in GeneralizedTime format");
        errMsgList.put(Integer.valueOf(ASN1_MISSING_FIELD), "Structure is missing a required field");
        errMsgList.put(Integer.valueOf(ASN1_MISPLACED_FIELD), "Unexpected field number");
        errMsgList.put(Integer.valueOf(ASN1_TYPE_MISMATCH), "Type numbers are inconsistent");
        errMsgList.put(Integer.valueOf(ASN1_OVERFLOW), "Value too large");
        errMsgList.put(Integer.valueOf(ASN1_OVERRUN), "Encoding ended unexpectedly");
        errMsgList.put(Integer.valueOf(ASN1_BAD_ID), "Identifier doesn't match expected value");
        errMsgList.put(Integer.valueOf(ASN1_BAD_LENGTH), "Length doesn't match expected value");
        errMsgList.put(Integer.valueOf(ASN1_BAD_FORMAT), "Badly-formatted encoding");
        errMsgList.put(Integer.valueOf(ASN1_PARSE_ERROR), "Parse error");
        errMsgList.put(Integer.valueOf(ASN1_BAD_CLASS), "Bad class number");
        errMsgList.put(Integer.valueOf(ASN1_BAD_TYPE), "Bad type number");
        errMsgList.put(Integer.valueOf(ASN1_BAD_TAG), "Bad tag number");
        errMsgList.put(Integer.valueOf(ASN1_UNSUPPORTED_TYPE), "Unsupported ASN.1 type encountered");
        errMsgList.put(Integer.valueOf(ASN1_CANNOT_ENCODE), "Encoding failed due to invalid parameter(s)");
        errMsgList.put(100, "Client has no support for crypto type");
        errMsgList.put(101, "Invalid option setting in ticket request.");
        errMsgList.put(63, "Fail to create credential.");
    }
}
