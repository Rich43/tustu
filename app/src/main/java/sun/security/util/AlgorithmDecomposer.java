...
/* loaded from: rt.jar:sun/security/util/AlgorithmDecomposer.class */
public class AlgorithmDecomposer {
    ...
    public static Collection<String> getAliases(String str) {
        String[] strArr;
        if (str.equalsIgnoreCase("DH") || str.equalsIgnoreCase("DiffieHellman")) {
            strArr = new String[]{"DH", "DiffieHellman"};
        } else {
