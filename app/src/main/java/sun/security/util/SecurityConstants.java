...
/* loaded from: rt.jar:sun/security/util/SecurityConstants.class */
public final class SecurityConstants {
    ...
    public static final Double PROVIDER_VER = Double.valueOf(1.8d);

    private SecurityConstants() {
    }

    /* loaded from: rt.jar:sun/security/util/SecurityConstants$AWT.class */
    public static class AWT {
        ...
        private static PermissionFactory<?> permissionFactory() {
            try {
                try {
                    return (PermissionFactory) Class.forName(AWTFactory, false, AWT.class.getClassLoader()).newInstance();
        ...
        private static Permission newAWTPermission(String str) {
            if (factory == null) {
                return null;
            }
            return factory.newPermission(str);
        }
    }
}
