...
/* loaded from: rt.jar:sun/security/provider/certpath/X509CertificatePair.class */
public class X509CertificatePair {
    ...
    public String toString() {
        ...
        if (this.forward != null) {
            sb.append("  Forward: ").append((Object) this.forward).append("\n");
        }
        if (this.reverse != null) {
            sb.append("  Reverse: ").append((Object) this.reverse).append("\n");
        }
        sb.append("]");
        return sb.toString();
    }
