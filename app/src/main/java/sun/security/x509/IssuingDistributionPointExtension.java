...
/* loaded from: rt.jar:sun/security/x509/IssuingDistributionPointExtension.class */
public class IssuingDistributionPointExtension extends Extension implements CertAttrSet<String> {
    ...
    public IssuingDistributionPointExtension(DistributionPointName distributionPointName, ReasonFlags reasonFlags, boolean z2, boolean z3, boolean z4, boolean z5) throws IOException {
