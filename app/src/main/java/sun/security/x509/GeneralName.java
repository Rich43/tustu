...
/* loaded from: rt.jar:sun/security/x509/GeneralName.class */
public class GeneralName {
    ...
    public GeneralName(DerValue derValue, boolean z2) throws IOException {
        this.name = null;
        ...
        switch (s2) {
            ...
            case 3:
            default:
                throw new IOException("Unrecognized GeneralName tag, (" + ((int) s2) + ")");
            case 4:
                if (derValue.isContextSpecific() && derValue.isConstructed()) {
