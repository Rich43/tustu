...
/* loaded from: rt.jar:sun/security/x509/X509CertInfo.class */
public class X509CertInfo implements CertAttrSet<String> {
    ...
    public boolean equals(X509CertInfo x509CertInfo) {
        ...
        for (int i2 = 0; i2 < this.rawCertInfo.length; i2++) {
            if (this.rawCertInfo[i2] != x509CertInfo.rawCertInfo[i2]) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        int i2 = 0;
        for (int i3 = 1; i3 < this.rawCertInfo.length; i3++) {
            i2 += this.rawCertInfo[i3] * i3;
        }
        return i2;
    }
    ...
    public String toString() {
        ...
        sb.append("[\n");
        sb.append(Constants.INDENT + this.version.toString() + "\n");
        ...
        sb.append(Constants.INDENT + this.interval.toString() + "\n");
        sb.append("  Issuer: " + this.issuer.toString() + "\n");
        sb.append(Constants.INDENT + this.serialNum.toString() + "\n");
    ...
    private Object getX500Name(String str, boolean z2) throws IOException {
        if (str.equalsIgnoreCase("dname")) {
            return z2 ? this.issuer : this.subject;
        }
        if (str.equalsIgnoreCase("x500principal")) {
            return z2 ? this.issuer.asX500Principal() : this.subject.asX500Principal();
        }
    ...
    private void emit(DerOutputStream derOutputStream) throws IOException, CertificateException {
        ...
        if (this.issuerUniqueId != null) {
            this.issuerUniqueId.encode(derOutputStream2, DerValue.createTag(Byte.MIN_VALUE, false, (byte) 1));
        }
        if (this.subjectUniqueId != null) {
            this.subjectUniqueId.encode(derOutputStream2, DerValue.createTag(Byte.MIN_VALUE, false, (byte) 2));
        }
        if (this.extensions != null) {
