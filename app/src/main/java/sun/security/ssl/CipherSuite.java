...
/* loaded from: jsse.jar:sun/security/ssl/CipherSuite.class */
enum CipherSuite {
    ...
    TLS_KRB5_WITH_3DES_EDE_CBC_SHA(31, false, "TLS_KRB5_WITH_3DES_EDE_CBC_SHA", "", ProtocolVersion.PROTOCOLS_TO_12, KeyExchange.K_KRB5, SSLCipher.B_3DES, MacAlg.M_SHA, HashAlg.H_SHA256),
    TLS_KRB5_WITH_3DES_EDE_CBC_MD5(35, false, "TLS_KRB5_WITH_3DES_EDE_CBC_MD5", "", ProtocolVersion.PROTOCOLS_TO_12, KeyExchange.K_KRB5, SSLCipher.B_3DES, MacAlg.M_MD5, HashAlg.H_SHA256),
    TLS_KRB5_WITH_RC4_128_SHA(32, false, "TLS_KRB5_WITH_RC4_128_SHA", "", ProtocolVersion.PROTOCOLS_TO_12, KeyExchange.K_KRB5, SSLCipher.B_RC4_128, MacAlg.M_SHA, HashAlg.H_SHA256),
    TLS_KRB5_WITH_RC4_128_MD5(36, false, "TLS_KRB5_WITH_RC4_128_MD5", "", ProtocolVersion.PROTOCOLS_TO_12, KeyExchange.K_KRB5, SSLCipher.B_RC4_128, MacAlg.M_MD5, HashAlg.H_SHA256),
    TLS_KRB5_WITH_DES_CBC_SHA(30, false, "TLS_KRB5_WITH_DES_CBC_SHA", "", ProtocolVersion.PROTOCOLS_TO_11, KeyExchange.K_KRB5, SSLCipher.B_DES, MacAlg.M_SHA, HashAlg.H_SHA256),
    TLS_KRB5_WITH_DES_CBC_MD5(34, false, "TLS_KRB5_WITH_DES_CBC_MD5", "", ProtocolVersion.PROTOCOLS_TO_11, KeyExchange.K_KRB5, SSLCipher.B_DES, MacAlg.M_MD5, HashAlg.H_SHA256),
    TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA(38, false, "TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA", "", ProtocolVersion.PROTOCOLS_TO_10, KeyExchange.K_KRB5_EXPORT, SSLCipher.B_DES_40, MacAlg.M_SHA, HashAlg.H_SHA256),
    TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5(41, false, "TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5", "", ProtocolVersion.PROTOCOLS_TO_10, KeyExchange.K_KRB5_EXPORT, SSLCipher.B_DES_40, MacAlg.M_MD5, HashAlg.H_SHA256),
    TLS_KRB5_EXPORT_WITH_RC4_40_SHA(40, false, "TLS_KRB5_EXPORT_WITH_RC4_40_SHA", "", ProtocolVersion.PROTOCOLS_TO_10, KeyExchange.K_KRB5_EXPORT, SSLCipher.B_RC4_40, MacAlg.M_SHA, HashAlg.H_SHA256),
    TLS_KRB5_EXPORT_WITH_RC4_40_MD5(43, false, "TLS_KRB5_EXPORT_WITH_RC4_40_MD5", "", ProtocolVersion.PROTOCOLS_TO_10, KeyExchange.K_KRB5_EXPORT, SSLCipher.B_RC4_40, MacAlg.M_MD5, HashAlg.H_SHA256),
    ...
    static {
        ...
        for (CipherSuite cipherSuite : values()) {
            map.put(Integer.valueOf(cipherSuite.id), cipherSuite);
            map2.put(cipherSuite.name, cipherSuite);
            Iterator<String> it = cipherSuite.aliases.iterator();
            while (it.hasNext()) {
                map2.put(it.next(), cipherSuite);
            }
            if (!cipherSuite.supportedProtocols.isEmpty()) {
                arrayList.add(cipherSuite);
            }
            if (cipherSuite.isDefaultEnabled) {
                arrayList2.add(cipherSuite);
            }
        }
        cipherSuiteIds = Collections.unmodifiableMap(map);
        cipherSuiteNames = Collections.unmodifiableMap(map2);
        allowedCipherSuites = Collections.unmodifiableList(arrayList);
        defaultCipherSuites = Collections.unmodifiableList(arrayList2);
    }

    CipherSuite(String str, int i2) {
        this(i2, false, str, "", ProtocolVersion.PROTOCOLS_EMPTY, null, null, null, null);
    }

    CipherSuite(int i2, boolean z2, String str, ProtocolVersion[] protocolVersionArr, SSLCipher sSLCipher, HashAlg hashAlg) {
        this(i2, z2, str, "", protocolVersionArr, null, sSLCipher, MacAlg.M_NULL, hashAlg);
    }

    CipherSuite(int i2, boolean z2, String str, String str2, ProtocolVersion[] protocolVersionArr, KeyExchange keyExchange, SSLCipher sSLCipher, MacAlg macAlg, HashAlg hashAlg) {
        this.id = i2;
        this.isDefaultEnabled = z2;
        this.name = str;
        if (!str2.isEmpty()) {
            this.aliases = Arrays.asList(str2.split(","));
        } else {
            this.aliases = Collections.emptyList();
        }
        this.supportedProtocols = Arrays.asList(protocolVersionArr);
        this.keyExchange = keyExchange;
        this.bulkCipher = sSLCipher;
        this.macAlg = macAlg;
        this.hashAlg = hashAlg;
        this.exportable = sSLCipher == null ? false : sSLCipher.exportable;
    }

    static CipherSuite nameOf(String str) {
        return cipherSuiteNames.get(str);
    }

    static CipherSuite valueOf(int i2) {
        return cipherSuiteIds.get(Integer.valueOf(i2));
    }

    static String nameOf(int i2) {
        CipherSuite cipherSuite = cipherSuiteIds.get(Integer.valueOf(i2));
        if (cipherSuite != null) {
            return cipherSuite.name;
        }
        return "UNKNOWN-CIPHER-SUITE(" + Utilities.byte16HexString(i2) + ")";
    }
    ...
    static List<CipherSuite> validValuesOf(String[] strArr) {
        if (strArr == null) {
        ...
        for (String str : strArr) {
            ...
            boolean z2 = false;
            CipherSuite cipherSuite = cipherSuiteNames.get(str);
            if (cipherSuite != null && !cipherSuite.supportedProtocols.isEmpty()) {
                arrayList.add(cipherSuite);
                z2 = true;
            }
            if (!z2) {
    ...
    static String[] namesOf(List<CipherSuite> list) {
    ...
    int calculatePacketSize(int i2, ProtocolVersion protocolVersion) {
        int i3 = i2;
        if (this.bulkCipher != null && this.bulkCipher != SSLCipher.B_NULL) {
            int i4 = this.bulkCipher.ivSize;
            switch (this.bulkCipher.cipherType) {
                case BLOCK_CIPHER:
                    int i5 = i3 + this.macAlg.size + 1;
                    i3 = i5 + ((i4 - (i5 % i4)) % i4);
                ...
                case AEAD_CIPHER:
                    if (protocolVersion == ProtocolVersion.TLS12) {
                        i3 += this.bulkCipher.ivSize - this.bulkCipher.fixedIvSize;
                    }
    ...
    int calculateFragSize(int i2, ProtocolVersion protocolVersion) {
        int i3 = i2 - 5;
        if (this.bulkCipher != null && this.bulkCipher != SSLCipher.B_NULL) {
            int i4 = this.bulkCipher.ivSize;
            switch (this.bulkCipher.cipherType) {
                case BLOCK_CIPHER:
                    ...
                    i3 = ((i3 - (i3 % i4)) - 1) - this.macAlg.size;
                    break;
                case AEAD_CIPHER:
                    this.bulkCipher.getClass();
                    i3 = (i3 - 16) - (this.bulkCipher.ivSize - this.bulkCipher.fixedIvSize);
                    break;
                default:
                    i3 -= this.macAlg.size;
                    break;
    ...
    /* loaded from: jsse.jar:sun/security/ssl/CipherSuite$KeyExchange.class */
    enum KeyExchange {
        ...
        K_KRB5("KRB5", true, false, SupportedGroupsExtension.NamedGroupType.NAMED_GROUP_NONE),
        K_KRB5_EXPORT("KRB5_EXPORT", true, false, SupportedGroupsExtension.NamedGroupType.NAMED_GROUP_NONE),
        ...
        KeyExchange(String str, boolean z2, boolean z3, SupportedGroupsExtension.NamedGroupType namedGroupType) {
            this.name = str;
            ...
            this.groupType = namedGroupType;
            this.alwaysAvailable = z2 && !str.startsWith("EC");
            this.isAnonymous = z3;
        }
    ...
    /* loaded from: jsse.jar:sun/security/ssl/CipherSuite$MacAlg.class */
    enum MacAlg {
        M_NULL("NULL", 0, 0, 0),
        M_MD5("MD5", 16, 64, 9),
        M_SHA("SHA", 20, 64, 9),
        ...
        MacAlg(String str, int i2, int i3, int i4) {
            this.name = str;
            this.size = i2;
    ...
    /* loaded from: jsse.jar:sun/security/ssl/CipherSuite$HashAlg.class */
    enum HashAlg {
        H_NONE("NONE", 0, 0),
        ...
        HashAlg(String str, int i2, int i3) {
            this.name = str;
            this.hashLength = i2;
            this.blockSize = i3;
        }
