...
/* loaded from: rt.jar:sun/awt/SunHints.class */
public class SunHints {
    ...
    /* loaded from: rt.jar:sun/awt/SunHints$Key.class */
    ...
    /* loaded from: rt.jar:sun/awt/SunHints$Value.class */
    public static class Value {
        ...
        private static synchronized void register(Key key, Value value) {
            ...
            if (ValueObjects[index][index2] != null) {
                throw new InternalError("duplicate index: " + index2);
            }
            ValueObjects[index][index2] = value;
        }

        public static Value get(int i2, int i3) {
            return ValueObjects[i2][i3];
        }
    ...
    /* loaded from: rt.jar:sun/awt/SunHints$LCDContrastKey.class */
    public static class LCDContrastKey extends Key {
        public LCDContrastKey(int i2, String str) {
            super(i2, str);
        }

        @Override // sun.awt.SunHints.Key, java.awt.RenderingHints.Key
        public final boolean isCompatibleValue(Object obj) {
            int iIntValue;
            return (obj instanceof Integer) && (iIntValue = ((Integer) obj).intValue()) >= 100 && iIntValue <= 250;
        }
    }
}
