...
/* loaded from: rt.jar:sun/awt/ExtendedKeyCodes.class */
public class ExtendedKeyCodes {
    ...
    public static final int getExtendedKeyCodeForChar(int i2) {
        int upperCase = Character.toUpperCase(i2);
        int lowerCase = Character.toLowerCase(i2);
        if (regularKeyCodesMap.containsKey(Integer.valueOf(i2))) {
            if (regularKeyCodesMap.containsKey(Integer.valueOf(upperCase))) {
                return regularKeyCodesMap.get(Integer.valueOf(upperCase)).intValue();
            }
            return regularKeyCodesMap.get(Integer.valueOf(i2)).intValue();
        }
        int i3 = upperCase + 16777216;
        int i4 = lowerCase + 16777216;
        if (extendedKeyCodesSet.contains(Integer.valueOf(i3))) {
            return i3;
        }
        if (extendedKeyCodesSet.contains(Integer.valueOf(i4))) {
            return i4;
        }
        return 0;
    }
