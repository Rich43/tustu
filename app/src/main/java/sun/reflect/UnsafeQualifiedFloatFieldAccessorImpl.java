...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedFloatFieldAccessorImpl.class */
class UnsafeQualifiedFloatFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedFloatFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putFloatVolatile(obj, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putFloatVolatile(obj, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putFloatVolatile(obj, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putFloatVolatile(obj, this.fieldOffset, ((Integer) obj2).intValue());
            return;
        }
        if (obj2 instanceof Long) {
            unsafe.putFloatVolatile(obj, this.fieldOffset, ((Long) obj2).longValue());
        } else if (obj2 instanceof Float) {
            unsafe.putFloatVolatile(obj, this.fieldOffset, ((Float) obj2).floatValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setFloat(Object obj, float f2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putFloatVolatile(obj, this.fieldOffset, f2);
    }
