...
/* loaded from: rt.jar:sun/reflect/UnsafeByteFieldAccessorImpl.class */
class UnsafeByteFieldAccessorImpl extends UnsafeFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putByte(obj, this.fieldOffset, ((Byte) obj2).byteValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setByte(Object obj, byte b2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putByte(obj, this.fieldOffset, b2);
    }
