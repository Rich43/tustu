...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedCharacterFieldAccessorImpl.class */
class UnsafeQualifiedCharacterFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedCharacterFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Character) {
            unsafe.putCharVolatile(obj, this.fieldOffset, ((Character) obj2).charValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setChar(Object obj, char c2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putCharVolatile(obj, this.fieldOffset, c2);
    }
