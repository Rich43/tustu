...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticBooleanFieldAccessorImpl.class */
class UnsafeQualifiedStaticBooleanFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticBooleanFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Boolean) {
            unsafe.putBooleanVolatile(this.base, this.fieldOffset, ((Boolean) obj2).booleanValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setBoolean(Object obj, boolean z2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putBooleanVolatile(this.base, this.fieldOffset, z2);
    }
