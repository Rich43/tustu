...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticShortFieldAccessorImpl.class */
class UnsafeQualifiedStaticShortFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticShortFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putShortVolatile(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
        } else if (obj2 instanceof Short) {
            unsafe.putShortVolatile(this.base, this.fieldOffset, ((Short) obj2).shortValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setShort(Object obj, short s2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putShortVolatile(this.base, this.fieldOffset, s2);
    }
