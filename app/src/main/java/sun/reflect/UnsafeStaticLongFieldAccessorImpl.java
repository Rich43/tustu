...
/* loaded from: rt.jar:sun/reflect/UnsafeStaticLongFieldAccessorImpl.class */
class UnsafeStaticLongFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putLong(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putLong(this.base, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putLong(this.base, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putLong(this.base, this.fieldOffset, ((Integer) obj2).intValue());
        } else if (obj2 instanceof Long) {
            unsafe.putLong(this.base, this.fieldOffset, ((Long) obj2).longValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setLong(Object obj, long j2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putLong(this.base, this.fieldOffset, j2);
    }
