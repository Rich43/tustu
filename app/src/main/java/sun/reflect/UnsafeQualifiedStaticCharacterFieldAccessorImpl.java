...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticCharacterFieldAccessorImpl.class */
class UnsafeQualifiedStaticCharacterFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticCharacterFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Character) {
            unsafe.putCharVolatile(this.base, this.fieldOffset, ((Character) obj2).charValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setChar(Object obj, char c2) throws IllegalAccessException, IllegalArgumentException {
        if (this.isReadOnly) {
            throwFinalFieldIllegalAccessException(c2);
        }
        unsafe.putCharVolatile(this.base, this.fieldOffset, c2);
    }
