...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticByteFieldAccessorImpl.class */
class UnsafeQualifiedStaticByteFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticByteFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putByteVolatile(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setByte(Object obj, byte b2) throws IllegalAccessException, IllegalArgumentException {
        if (this.isReadOnly) {
            throwFinalFieldIllegalAccessException(b2);
        }
        unsafe.putByteVolatile(this.base, this.fieldOffset, b2);
    }
