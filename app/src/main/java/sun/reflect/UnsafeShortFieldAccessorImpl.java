...
/* loaded from: rt.jar:sun/reflect/UnsafeShortFieldAccessorImpl.class */
class UnsafeShortFieldAccessorImpl extends UnsafeFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putShort(obj, this.fieldOffset, ((Byte) obj2).byteValue());
        } else if (obj2 instanceof Short) {
            unsafe.putShort(obj, this.fieldOffset, ((Short) obj2).shortValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setShort(Object obj, short s2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putShort(obj, this.fieldOffset, s2);
    }
