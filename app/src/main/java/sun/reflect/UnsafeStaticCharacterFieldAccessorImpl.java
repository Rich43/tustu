...
/* loaded from: rt.jar:sun/reflect/UnsafeStaticCharacterFieldAccessorImpl.class */
class UnsafeStaticCharacterFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Character) {
            unsafe.putChar(this.base, this.fieldOffset, ((Character) obj2).charValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setChar(Object obj, char c2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putChar(this.base, this.fieldOffset, c2);
    }
