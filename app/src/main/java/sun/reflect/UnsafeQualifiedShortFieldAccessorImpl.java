...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedShortFieldAccessorImpl.class */
class UnsafeQualifiedShortFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedShortFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putShortVolatile(obj, this.fieldOffset, ((Byte) obj2).byteValue());
        } else if (obj2 instanceof Short) {
            unsafe.putShortVolatile(obj, this.fieldOffset, ((Short) obj2).shortValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setShort(Object obj, short s2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putShortVolatile(obj, this.fieldOffset, s2);
    }
