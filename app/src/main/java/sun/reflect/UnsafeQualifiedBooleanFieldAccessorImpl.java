...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedBooleanFieldAccessorImpl.class */
class UnsafeQualifiedBooleanFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedBooleanFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Boolean) {
            unsafe.putBooleanVolatile(obj, this.fieldOffset, ((Boolean) obj2).booleanValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setBoolean(Object obj, boolean z2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putBooleanVolatile(obj, this.fieldOffset, z2);
    }
