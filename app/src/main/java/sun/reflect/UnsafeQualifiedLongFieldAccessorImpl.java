...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedLongFieldAccessorImpl.class */
class UnsafeQualifiedLongFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedLongFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putLongVolatile(obj, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putLongVolatile(obj, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putLongVolatile(obj, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putLongVolatile(obj, this.fieldOffset, ((Integer) obj2).intValue());
        } else if (obj2 instanceof Long) {
            unsafe.putLongVolatile(obj, this.fieldOffset, ((Long) obj2).longValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setLong(Object obj, long j2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putLongVolatile(obj, this.fieldOffset, j2);
    }
