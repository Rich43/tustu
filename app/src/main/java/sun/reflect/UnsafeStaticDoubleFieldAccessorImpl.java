...
/* loaded from: rt.jar:sun/reflect/UnsafeStaticDoubleFieldAccessorImpl.class */
class UnsafeStaticDoubleFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Integer) obj2).intValue());
            return;
        }
        if (obj2 instanceof Long) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Long) obj2).longValue());
            return;
        }
        if (obj2 instanceof Float) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Float) obj2).floatValue());
        } else if (obj2 instanceof Double) {
            unsafe.putDouble(this.base, this.fieldOffset, ((Double) obj2).doubleValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setDouble(Object obj, double d2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putDouble(this.base, this.fieldOffset, d2);
    }
}
