...
/* loaded from: rt.jar:sun/reflect/UnsafeStaticByteFieldAccessorImpl.class */
class UnsafeStaticByteFieldAccessorImpl extends UnsafeStaticFieldAccessorImpl {
    ...
    public byte getByte(Object obj) throws IllegalArgumentException {
        return unsafe.getByte(this.base, this.fieldOffset);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putByte(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setByte(Object obj, byte b2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putByte(this.base, this.fieldOffset, b2);
    }
