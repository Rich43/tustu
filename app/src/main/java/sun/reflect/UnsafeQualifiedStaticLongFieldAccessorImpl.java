...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticLongFieldAccessorImpl.class */
class UnsafeQualifiedStaticLongFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticLongFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public long getLong(Object obj) throws IllegalArgumentException {
        return unsafe.getLongVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putLongVolatile(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putLongVolatile(this.base, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putLongVolatile(this.base, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putLongVolatile(this.base, this.fieldOffset, ((Integer) obj2).intValue());
        } else if (obj2 instanceof Long) {
            unsafe.putLongVolatile(this.base, this.fieldOffset, ((Long) obj2).longValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setLong(Object obj, long j2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putLongVolatile(this.base, this.fieldOffset, j2);
    }
