...
/* loaded from: rt.jar:sun/reflect/UnsafeFloatFieldAccessorImpl.class */
class UnsafeFloatFieldAccessorImpl extends UnsafeFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putFloat(obj, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putFloat(obj, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putFloat(obj, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putFloat(obj, this.fieldOffset, ((Integer) obj2).intValue());
            return;
        }
        if (obj2 instanceof Long) {
            unsafe.putFloat(obj, this.fieldOffset, ((Long) obj2).longValue());
        } else if (obj2 instanceof Float) {
            unsafe.putFloat(obj, this.fieldOffset, ((Float) obj2).floatValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setFloat(Object obj, float f2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putFloat(obj, this.fieldOffset, f2);
    }
