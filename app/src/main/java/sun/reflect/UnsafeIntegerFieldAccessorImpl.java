...
/* loaded from: rt.jar:sun/reflect/UnsafeIntegerFieldAccessorImpl.class */
class UnsafeIntegerFieldAccessorImpl extends UnsafeFieldAccessorImpl {
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putInt(obj, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putInt(obj, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putInt(obj, this.fieldOffset, ((Character) obj2).charValue());
        } else if (obj2 instanceof Integer) {
            unsafe.putInt(obj, this.fieldOffset, ((Integer) obj2).intValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setInt(Object obj, int i2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putInt(obj, this.fieldOffset, i2);
    }
