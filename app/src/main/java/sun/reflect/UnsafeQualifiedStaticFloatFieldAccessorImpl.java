...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticFloatFieldAccessorImpl.class */
class UnsafeQualifiedStaticFloatFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticFloatFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putFloatVolatile(this.base, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putFloatVolatile(this.base, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putFloatVolatile(this.base, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putFloatVolatile(this.base, this.fieldOffset, ((Integer) obj2).intValue());
            return;
        }
        if (obj2 instanceof Long) {
            unsafe.putFloatVolatile(this.base, this.fieldOffset, ((Long) obj2).longValue());
        } else if (obj2 instanceof Float) {
            unsafe.putFloatVolatile(this.base, this.fieldOffset, ((Float) obj2).floatValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setFloat(Object obj, float f2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putFloatVolatile(this.base, this.fieldOffset, f2);
    }
