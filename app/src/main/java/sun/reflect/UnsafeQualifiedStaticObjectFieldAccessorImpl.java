...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedStaticObjectFieldAccessorImpl.class */
class UnsafeQualifiedStaticObjectFieldAccessorImpl extends UnsafeQualifiedStaticFieldAccessorImpl {
    UnsafeQualifiedStaticObjectFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putObjectVolatile(this.base, this.fieldOffset, obj2);
    }
