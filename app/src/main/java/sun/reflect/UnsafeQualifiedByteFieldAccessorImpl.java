...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedByteFieldAccessorImpl.class */
class UnsafeQualifiedByteFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedByteFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putByteVolatile(obj, this.fieldOffset, ((Byte) obj2).byteValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setByte(Object obj, byte b2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putByteVolatile(obj, this.fieldOffset, b2);
    }
