...
/* loaded from: rt.jar:sun/reflect/UnsafeQualifiedDoubleFieldAccessorImpl.class */
class UnsafeQualifiedDoubleFieldAccessorImpl extends UnsafeQualifiedFieldAccessorImpl {
    UnsafeQualifiedDoubleFieldAccessorImpl(Field field, boolean z2) {
        super(field, z2);
    }
    ...
    public void set(Object obj, Object obj2) throws IllegalAccessException, IllegalArgumentException {
        ...
        if (obj2 instanceof Byte) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Byte) obj2).byteValue());
            return;
        }
        if (obj2 instanceof Short) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Short) obj2).shortValue());
            return;
        }
        if (obj2 instanceof Character) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Character) obj2).charValue());
            return;
        }
        if (obj2 instanceof Integer) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Integer) obj2).intValue());
            return;
        }
        if (obj2 instanceof Long) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Long) obj2).longValue());
            return;
        }
        if (obj2 instanceof Float) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Float) obj2).floatValue());
        } else if (obj2 instanceof Double) {
            unsafe.putDoubleVolatile(obj, this.fieldOffset, ((Double) obj2).doubleValue());
        } else {
            throwSetIllegalArgumentException(obj2);
        }
    }
    ...
    public void setDouble(Object obj, double d2) throws IllegalAccessException, IllegalArgumentException {
        ...
        unsafe.putDoubleVolatile(obj, this.fieldOffset, d2);
    }
}
