...
/* loaded from: rt.jar:sun/net/httpserver/HttpsServerImpl.class */
public class HttpsServerImpl extends HttpsServer {
    ...
    HttpsServerImpl(InetSocketAddress inetSocketAddress, int i2) throws IOException {
        this.server = new ServerImpl(this, "https", inetSocketAddress, i2);
    }
