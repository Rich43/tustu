...
/* loaded from: rt.jar:sun/net/www/protocol/https/HttpsURLConnectionImpl.class */
public class HttpsURLConnectionImpl extends HttpsURLConnection {
    ...
    HttpsURLConnectionImpl(URL url, Proxy proxy, Handler handler) throws IOException {
        super(checkURL(url));
        this.delegate = new DelegateHttpsURLConnection(this.url, proxy, handler, this);
    }

    protected HttpsURLConnectionImpl(URL url) throws IOException {
        super(url);
    }
