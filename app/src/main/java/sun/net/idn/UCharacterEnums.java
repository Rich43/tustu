...
@Deprecated
/* loaded from: rt.jar:sun/net/idn/UCharacterEnums.class */
class UCharacterEnums {

    @Deprecated
    /* loaded from: rt.jar:sun/net/idn/UCharacterEnums$ECharacterCategory.class */
    ...
    @Deprecated
    /* loaded from: rt.jar:sun/net/idn/UCharacterEnums$ECharacterDirection.class */
