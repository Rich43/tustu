...
/* loaded from: charsets.jar:sun/nio/cs/ext/IBM970.class */
public class IBM970 extends Charset implements HistoricallyNamedCharset {
    ...
    static char[] c2b = new char[37632];
    ...
    public boolean contains(Charset charset) {
        return charset.name().equals("US-ASCII") || (charset instanceof IBM970);
    }

    @Override // java.nio.charset.Charset
    public CharsetDecoder newDecoder() {
        initb2c();
        return new DoubleByte.Decoder_EUC_SIM(this, b2c, b2cSB, 161, 254);
    }
    ...
    static void initc2b() {
        ...
        synchronized (c2b) {
            ...
            DoubleByte.Encoder.initC2B(b2cStr, b2cSBStr, null, "ꆤ·ꆩ\u00adꆪ―ꆭ∼ꊦ～ꋁ⊙ꏜ₩ꆪ楐ꆩ蓱ꆭ콿", 161, 254, c2b, c2bIndex);
            c2bInitialized = true;
        }
    }
}
