...
/* loaded from: rt.jar:sun/rmi/transport/proxy/RMIHttpToCGISocketFactory.class */
public class RMIHttpToCGISocketFactory extends RMISocketFactory {
    ...
    public Socket createSocket(String str, int i2) throws IOException {
        return new HttpSendSocket(str, i2, new URL("http", str, "/cgi-bin/java-rmi.cgi?forward=" + i2));
    }
