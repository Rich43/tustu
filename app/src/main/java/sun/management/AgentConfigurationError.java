...
/* loaded from: rt.jar:sun/management/AgentConfigurationError.class */
public class AgentConfigurationError extends Error {
    ...
    public static final String INVALID_JMXREMOTE_LOCAL_PORT = "agent.err.invalid.jmxremote.local.port";
