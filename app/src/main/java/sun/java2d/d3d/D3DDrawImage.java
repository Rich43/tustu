...
/* loaded from: rt.jar:sun/java2d/d3d/D3DDrawImage.class */
public class D3DDrawImage extends DrawImage {
    ...
    protected void renderImageXform(SunGraphics2D sunGraphics2D, Image image, AffineTransform affineTransform, int i2, int i3, int i4, int i5, int i6, Color color) {
        ...
        if (i2 != 3 && (sourceSurfaceData = (surfaceData = sunGraphics2D.surfaceData).getSourceSurfaceData(image, 4, sunGraphics2D.imageComp, color)) != null && !isBgOperation(sourceSurfaceData, color)) {
    ...
    public void transformImage(SunGraphics2D sunGraphics2D, BufferedImage bufferedImage, BufferedImageOp bufferedImageOp, int i2, int i3) {
        if (bufferedImageOp != null) {
            if (bufferedImageOp instanceof AffineTransformOp) {
                ...
                return;
            } else if (D3DBufImgOps.renderImageWithOp(sunGraphics2D, bufferedImage, bufferedImageOp, i2, i3)) {
                return;
            } else {
