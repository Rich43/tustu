...
/* loaded from: rt.jar:sun/java2d/d3d/D3DRTTSurfaceToSurfaceTransform.class */
class D3DRTTSurfaceToSurfaceTransform extends TransformBlit {
    ...
    public void Transform(SurfaceData surfaceData, SurfaceData surfaceData2, Composite composite, Region region, AffineTransform affineTransform, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        D3DBlitLoops.IsoBlit(surfaceData, surfaceData2, null, null, composite, region, affineTransform, i2, i3, i4, i3 + i7, i4 + i8, i5, i6, i5 + i7, i6 + i8, true);
    }
}
