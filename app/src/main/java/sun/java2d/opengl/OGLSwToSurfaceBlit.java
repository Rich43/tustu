...
/* loaded from: rt.jar:sun/java2d/opengl/OGLSwToSurfaceBlit.class */
class OGLSwToSurfaceBlit extends Blit {
    private int typeval;

    OGLSwToSurfaceBlit(SurfaceType surfaceType, int i2) {
    ...
    public void Blit(SurfaceData surfaceData, SurfaceData surfaceData2, Composite composite, Region region, int i2, int i3, int i4, int i5, int i6, int i7) {
        OGLBlitLoops.Blit(surfaceData, surfaceData2, composite, region, null, 1, i2, i3, i2 + i6, i3 + i7, i4, i5, i4 + i6, i5 + i7, this.typeval, false);
    }
}
