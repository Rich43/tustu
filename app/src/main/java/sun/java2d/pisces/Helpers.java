...
/* loaded from: rt.jar:sun/java2d/pisces/Helpers.class */
final class Helpers {
    ...
    static float[] widenArray(float[] fArr, int i2, int i3) {
        if (fArr.length >= i2 + i3) {
            return fArr;
        }
        return Arrays.copyOf(fArr, 2 * (i2 + i3));
    }

    static int[] widenArray(int[] iArr, int i2, int i3) {
        if (iArr.length >= i2 + i3) {
            return iArr;
        }
        return Arrays.copyOf(iArr, 2 * (i2 + i3));
    }
