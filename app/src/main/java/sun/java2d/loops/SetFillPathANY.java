...
/* loaded from: rt.jar:sun/java2d/loops/SetFillPathANY.class */
class SetFillPathANY extends FillPath {
    ...
    public void FillPath(SunGraphics2D sunGraphics2D, SurfaceData surfaceData, int i2, int i3, Path2D.Float r12) {
        ProcessPath.fillPath(new PixelWriterDrawHandler(surfaceData, GeneralRenderer.createSolidPixelWriter(sunGraphics2D, surfaceData), sunGraphics2D.getCompClip(), sunGraphics2D.strokeHint), r12, i2, i3);
    }
}
