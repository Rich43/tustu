...
/* loaded from: rt.jar:sun/java2d/loops/SetDrawPathANY.class */
class SetDrawPathANY extends DrawPath {
    ...
    public void DrawPath(SunGraphics2D sunGraphics2D, SurfaceData surfaceData, int i2, int i3, Path2D.Float r12) {
        ProcessPath.drawPath(new PixelWriterDrawHandler(surfaceData, GeneralRenderer.createSolidPixelWriter(sunGraphics2D, surfaceData), sunGraphics2D.getCompClip(), sunGraphics2D.strokeHint), r12, i2, i3);
    }
}
