...
/* loaded from: rt.jar:sun/java2d/loops/XorDrawPolygonsANY.class */
class XorDrawPolygonsANY extends DrawPolygons {
    ...
    public void DrawPolygons(SunGraphics2D sunGraphics2D, SurfaceData surfaceData, int[] iArr, int[] iArr2, int[] iArr3, int i2, int i3, int i4, boolean z2) {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            int i7 = iArr3[i6];
            GeneralRenderer.doDrawPoly(surfaceData, pixelWriterCreateXorPixelWriter, iArr, iArr2, i5, i7, compClip, i3, i4, z2);
            i5 += i7;
        }
    }
}
