...
/* loaded from: jfxrt.jar:com/sun/webkit/LoadListenerClient.class */
public interface LoadListenerClient {
    ...
    public static final int PAGE_REPLACED = 3;
    ...
    void dispatchLoadEvent(long j2, int i2, String str, String str2, double d2, int i3);

    void dispatchResourceLoadEvent(long j2, int i2, String str, String str2, double d2, int i3);
}
