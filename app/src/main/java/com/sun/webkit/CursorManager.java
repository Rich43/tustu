...
/* loaded from: jfxrt.jar:com/sun/webkit/CursorManager.class */
public abstract class CursorManager<T> {
    ...
    protected abstract T getCustomCursor(WCImage wCImage, int i2, int i3);

    protected abstract T getPredefinedCursor(int i2);
    ...
    private long putCursor(T cursor) {
        ...
        this.map.put(Long.valueOf(id), cursor);
        return id;
    }
}
