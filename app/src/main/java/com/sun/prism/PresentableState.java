...
/* loaded from: jfxrt.jar:com/sun/prism/PresentableState.class */
public abstract class PresentableState {
    ...
    private int scale(int dim, float fromScale, float toScale) {
        return fromScale == toScale ? dim : (int) Math.ceil((dim * toScale) / fromScale);
    }
    ...
    protected void update(float viewScale, float renderScale, float outputScale) {
        ...
        if (renderScale == viewScale) {
            ...
            this.renderWidth = scale(this.viewWidth, viewScale, renderScale);
            this.renderHeight = scale(this.viewHeight, viewScale, renderScale);
        }
        if (outputScale == viewScale) {
            ...
            this.outputWidth = scale(this.viewWidth, viewScale, outputScale);
            this.outputHeight = scale(this.viewHeight, viewScale, outputScale);
        }
    }
