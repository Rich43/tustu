...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillRoundRect_LinearGradient_PAD_Loader.class */
public class FillRoundRect_LinearGradient_PAD_Loader {
    private FillRoundRect_LinearGradient_PAD_Loader() {
    }
