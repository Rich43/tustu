...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillCircle_LinearGradient_REPEAT_Loader.class */
public class FillCircle_LinearGradient_REPEAT_Loader {
    private FillCircle_LinearGradient_REPEAT_Loader() {
    }
