...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawCircle_LinearGradient_PAD_Loader.class */
public class DrawCircle_LinearGradient_PAD_Loader {
    private DrawCircle_LinearGradient_PAD_Loader() {
    }
