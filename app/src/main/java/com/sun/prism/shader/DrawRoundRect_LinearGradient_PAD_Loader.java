...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawRoundRect_LinearGradient_PAD_Loader.class */
public class DrawRoundRect_LinearGradient_PAD_Loader {
    private DrawRoundRect_LinearGradient_PAD_Loader() {
    }
