...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawCircle_Color_AlphaTest_Loader.class */
public class DrawCircle_Color_AlphaTest_Loader {
    private DrawCircle_Color_AlphaTest_Loader() {
    }
