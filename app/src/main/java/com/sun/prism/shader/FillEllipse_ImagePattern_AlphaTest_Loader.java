...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillEllipse_ImagePattern_AlphaTest_Loader.class */
public class FillEllipse_ImagePattern_AlphaTest_Loader {
    private FillEllipse_ImagePattern_AlphaTest_Loader() {
    }
