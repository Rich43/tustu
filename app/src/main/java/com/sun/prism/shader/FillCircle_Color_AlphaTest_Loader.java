...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillCircle_Color_AlphaTest_Loader.class */
public class FillCircle_Color_AlphaTest_Loader {
    private FillCircle_Color_AlphaTest_Loader() {
    }
