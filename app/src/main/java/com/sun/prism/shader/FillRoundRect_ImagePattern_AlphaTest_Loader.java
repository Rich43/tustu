...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillRoundRect_ImagePattern_AlphaTest_Loader.class */
public class FillRoundRect_ImagePattern_AlphaTest_Loader {
    private FillRoundRect_ImagePattern_AlphaTest_Loader() {
    }
