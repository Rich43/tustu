...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaOne_LinearGradient_Loader.class */
public class AlphaOne_LinearGradient_Loader {
    private AlphaOne_LinearGradient_Loader() {
    }
