...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawCircle_ImagePattern_AlphaTest_Loader.class */
public class DrawCircle_ImagePattern_AlphaTest_Loader {
    private DrawCircle_ImagePattern_AlphaTest_Loader() {
    }
