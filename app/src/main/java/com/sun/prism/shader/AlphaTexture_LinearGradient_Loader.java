...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaTexture_LinearGradient_Loader.class */
public class AlphaTexture_LinearGradient_Loader {
    private AlphaTexture_LinearGradient_Loader() {
    }
