...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawEllipse_RadialGradient_REFLECT_Loader.class */
public class DrawEllipse_RadialGradient_REFLECT_Loader {
    private DrawEllipse_RadialGradient_REFLECT_Loader() {
    }
