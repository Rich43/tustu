...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaTexture_LinearGradient_AlphaTest_Loader.class */
public class AlphaTexture_LinearGradient_AlphaTest_Loader {
    private AlphaTexture_LinearGradient_AlphaTest_Loader() {
    }
