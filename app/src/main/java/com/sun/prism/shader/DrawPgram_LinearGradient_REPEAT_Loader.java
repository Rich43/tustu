...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawPgram_LinearGradient_REPEAT_Loader.class */
public class DrawPgram_LinearGradient_REPEAT_Loader {
    private DrawPgram_LinearGradient_REPEAT_Loader() {
    }
