...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillEllipse_LinearGradient_REPEAT_Loader.class */
public class FillEllipse_LinearGradient_REPEAT_Loader {
    private FillEllipse_LinearGradient_REPEAT_Loader() {
    }
