...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaOne_RadialGradient_Loader.class */
public class AlphaOne_RadialGradient_Loader {
    private AlphaOne_RadialGradient_Loader() {
    }
