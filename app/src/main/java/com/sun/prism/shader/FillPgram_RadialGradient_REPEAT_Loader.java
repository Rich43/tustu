...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillPgram_RadialGradient_REPEAT_Loader.class */
public class FillPgram_RadialGradient_REPEAT_Loader {
    private FillPgram_RadialGradient_REPEAT_Loader() {
    }
