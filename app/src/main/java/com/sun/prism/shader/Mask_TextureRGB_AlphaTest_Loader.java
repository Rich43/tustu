...
/* loaded from: jfxrt.jar:com/sun/prism/shader/Mask_TextureRGB_AlphaTest_Loader.class */
public class Mask_TextureRGB_AlphaTest_Loader {
    private Mask_TextureRGB_AlphaTest_Loader() {
    }
