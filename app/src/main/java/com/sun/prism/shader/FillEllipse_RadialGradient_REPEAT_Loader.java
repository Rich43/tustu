...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillEllipse_RadialGradient_REPEAT_Loader.class */
public class FillEllipse_RadialGradient_REPEAT_Loader {
    private FillEllipse_RadialGradient_REPEAT_Loader() {
    }
