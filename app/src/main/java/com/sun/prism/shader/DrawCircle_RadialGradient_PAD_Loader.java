...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawCircle_RadialGradient_PAD_Loader.class */
public class DrawCircle_RadialGradient_PAD_Loader {
    private DrawCircle_RadialGradient_PAD_Loader() {
    }
