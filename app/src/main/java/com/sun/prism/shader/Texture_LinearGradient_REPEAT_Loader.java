...
/* loaded from: jfxrt.jar:com/sun/prism/shader/Texture_LinearGradient_REPEAT_Loader.class */
public class Texture_LinearGradient_REPEAT_Loader {
    private Texture_LinearGradient_REPEAT_Loader() {
    }
