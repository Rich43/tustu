...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawRoundRect_RadialGradient_REPEAT_Loader.class */
public class DrawRoundRect_RadialGradient_REPEAT_Loader {
    private DrawRoundRect_RadialGradient_REPEAT_Loader() {
    }
