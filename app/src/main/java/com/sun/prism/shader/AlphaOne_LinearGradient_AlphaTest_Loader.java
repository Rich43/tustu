...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaOne_LinearGradient_AlphaTest_Loader.class */
public class AlphaOne_LinearGradient_AlphaTest_Loader {
    private AlphaOne_LinearGradient_AlphaTest_Loader() {
    }
