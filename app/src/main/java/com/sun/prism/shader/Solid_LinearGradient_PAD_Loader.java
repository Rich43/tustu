...
/* loaded from: jfxrt.jar:com/sun/prism/shader/Solid_LinearGradient_PAD_Loader.class */
public class Solid_LinearGradient_PAD_Loader {
    private Solid_LinearGradient_PAD_Loader() {
    }
