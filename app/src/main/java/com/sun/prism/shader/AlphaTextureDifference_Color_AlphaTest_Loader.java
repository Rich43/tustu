...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaTextureDifference_Color_AlphaTest_Loader.class */
public class AlphaTextureDifference_Color_AlphaTest_Loader {
    private AlphaTextureDifference_Color_AlphaTest_Loader() {
    }
