...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawCircle_LinearGradient_REPEAT_Loader.class */
public class DrawCircle_LinearGradient_REPEAT_Loader {
    private DrawCircle_LinearGradient_REPEAT_Loader() {
    }
