...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawSemiRoundRect_RadialGradient_REFLECT_Loader.class */
public class DrawSemiRoundRect_RadialGradient_REFLECT_Loader {
    private DrawSemiRoundRect_RadialGradient_REFLECT_Loader() {
    }
