...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillCircle_ImagePattern_AlphaTest_Loader.class */
public class FillCircle_ImagePattern_AlphaTest_Loader {
    private FillCircle_ImagePattern_AlphaTest_Loader() {
    }
