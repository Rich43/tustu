...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawEllipse_ImagePattern_Loader.class */
public class DrawEllipse_ImagePattern_Loader {
    private DrawEllipse_ImagePattern_Loader() {
    }
