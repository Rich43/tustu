...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillEllipse_LinearGradient_REFLECT_Loader.class */
public class FillEllipse_LinearGradient_REFLECT_Loader {
    private FillEllipse_LinearGradient_REFLECT_Loader() {
    }
