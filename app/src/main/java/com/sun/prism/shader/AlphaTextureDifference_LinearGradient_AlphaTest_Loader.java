...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaTextureDifference_LinearGradient_AlphaTest_Loader.class */
public class AlphaTextureDifference_LinearGradient_AlphaTest_Loader {
    private AlphaTextureDifference_LinearGradient_AlphaTest_Loader() {
    }
