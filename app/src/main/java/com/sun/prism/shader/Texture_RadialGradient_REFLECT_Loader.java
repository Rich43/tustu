...
/* loaded from: jfxrt.jar:com/sun/prism/shader/Texture_RadialGradient_REFLECT_Loader.class */
public class Texture_RadialGradient_REFLECT_Loader {
    private Texture_RadialGradient_REFLECT_Loader() {
    }
