...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillEllipse_Color_AlphaTest_Loader.class */
public class FillEllipse_Color_AlphaTest_Loader {
    private FillEllipse_Color_AlphaTest_Loader() {
    }
