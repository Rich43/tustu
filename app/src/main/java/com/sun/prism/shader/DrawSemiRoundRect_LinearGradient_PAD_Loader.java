...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawSemiRoundRect_LinearGradient_PAD_Loader.class */
public class DrawSemiRoundRect_LinearGradient_PAD_Loader {
    private DrawSemiRoundRect_LinearGradient_PAD_Loader() {
    }
