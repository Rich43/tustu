...
/* loaded from: jfxrt.jar:com/sun/prism/shader/Solid_TextureFirstPassLCD_AlphaTest_Loader.class */
public class Solid_TextureFirstPassLCD_AlphaTest_Loader {
    private Solid_TextureFirstPassLCD_AlphaTest_Loader() {
    }
