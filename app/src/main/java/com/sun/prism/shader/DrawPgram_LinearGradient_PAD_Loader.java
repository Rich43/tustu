...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawPgram_LinearGradient_PAD_Loader.class */
public class DrawPgram_LinearGradient_PAD_Loader {
    private DrawPgram_LinearGradient_PAD_Loader() {
    }
