...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillPgram_Color_AlphaTest_Loader.class */
public class FillPgram_Color_AlphaTest_Loader {
    private FillPgram_Color_AlphaTest_Loader() {
    }
