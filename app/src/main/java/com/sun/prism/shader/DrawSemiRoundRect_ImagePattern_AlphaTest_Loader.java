...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawSemiRoundRect_ImagePattern_AlphaTest_Loader.class */
public class DrawSemiRoundRect_ImagePattern_AlphaTest_Loader {
    private DrawSemiRoundRect_ImagePattern_AlphaTest_Loader() {
    }
