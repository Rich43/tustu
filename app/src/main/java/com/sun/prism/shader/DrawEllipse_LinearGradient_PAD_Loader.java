...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawEllipse_LinearGradient_PAD_Loader.class */
public class DrawEllipse_LinearGradient_PAD_Loader {
    private DrawEllipse_LinearGradient_PAD_Loader() {
    }
