...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillPgram_LinearGradient_PAD_Loader.class */
public class FillPgram_LinearGradient_PAD_Loader {
    private FillPgram_LinearGradient_PAD_Loader() {
    }
