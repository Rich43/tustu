...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaTextureDifference_ImagePattern_AlphaTest_Loader.class */
public class AlphaTextureDifference_ImagePattern_AlphaTest_Loader {
    private AlphaTextureDifference_ImagePattern_AlphaTest_Loader() {
    }
