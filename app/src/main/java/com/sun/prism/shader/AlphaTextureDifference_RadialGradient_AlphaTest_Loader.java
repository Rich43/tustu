...
/* loaded from: jfxrt.jar:com/sun/prism/shader/AlphaTextureDifference_RadialGradient_AlphaTest_Loader.class */
public class AlphaTextureDifference_RadialGradient_AlphaTest_Loader {
    private AlphaTextureDifference_RadialGradient_AlphaTest_Loader() {
    }
