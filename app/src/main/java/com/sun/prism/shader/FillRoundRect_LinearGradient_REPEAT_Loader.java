...
/* loaded from: jfxrt.jar:com/sun/prism/shader/FillRoundRect_LinearGradient_REPEAT_Loader.class */
public class FillRoundRect_LinearGradient_REPEAT_Loader {
    private FillRoundRect_LinearGradient_REPEAT_Loader() {
    }
