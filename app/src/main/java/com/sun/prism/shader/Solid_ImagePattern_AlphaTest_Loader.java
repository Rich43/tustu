...
/* loaded from: jfxrt.jar:com/sun/prism/shader/Solid_ImagePattern_AlphaTest_Loader.class */
public class Solid_ImagePattern_AlphaTest_Loader {
    private Solid_ImagePattern_AlphaTest_Loader() {
    }
