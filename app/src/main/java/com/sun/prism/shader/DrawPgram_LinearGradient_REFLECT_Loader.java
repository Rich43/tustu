...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawPgram_LinearGradient_REFLECT_Loader.class */
public class DrawPgram_LinearGradient_REFLECT_Loader {
    private DrawPgram_LinearGradient_REFLECT_Loader() {
    }
