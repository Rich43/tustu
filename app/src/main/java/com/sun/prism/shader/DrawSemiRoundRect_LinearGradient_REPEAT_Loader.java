...
/* loaded from: jfxrt.jar:com/sun/prism/shader/DrawSemiRoundRect_LinearGradient_REPEAT_Loader.class */
public class DrawSemiRoundRect_LinearGradient_REPEAT_Loader {
    private DrawSemiRoundRect_LinearGradient_REPEAT_Loader() {
    }
