...
/* loaded from: rt.jar:com/sun/java/util/jar/pack/Constants.class */
class Constants {
    ...
    public static final String[] ATTR_CONTEXT_NAME = {com.sun.org.apache.xalan.internal.templates.Constants.ATTRNAME_CLASS, "field", "method", "code"};
