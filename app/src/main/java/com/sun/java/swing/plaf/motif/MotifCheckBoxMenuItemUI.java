...
/* loaded from: rt.jar:com/sun/java/swing/plaf/motif/MotifCheckBoxMenuItemUI.class */
public class MotifCheckBoxMenuItemUI extends BasicCheckBoxMenuItemUI {
    ...
    /* loaded from: rt.jar:com/sun/java/swing/plaf/motif/MotifCheckBoxMenuItemUI$ChangeHandler.class */
    protected class ChangeHandler implements ChangeListener {
        ...
        public void stateChanged(ChangeEvent changeEvent) {
            ...
            LookAndFeel.installProperty(jMenuItem, AbstractButton.BORDER_PAINTED_CHANGED_PROPERTY, Boolean.valueOf(jMenuItem.isArmed()));
        }
    }
    ...
    /* loaded from: rt.jar:com/sun/java/swing/plaf/motif/MotifCheckBoxMenuItemUI$MouseInputHandler.class */
    protected class MouseInputHandler implements MouseInputListener {
        ...
        public void mousePressed(MouseEvent mouseEvent) {
            MenuSelectionManager.defaultManager().setSelectedPath(MotifCheckBoxMenuItemUI.this.getPath());
        }
