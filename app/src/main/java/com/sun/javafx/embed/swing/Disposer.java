...
/* loaded from: jfxrt.jar:com/sun/javafx/embed/swing/Disposer.class */
public class Disposer implements Runnable {
    ...
    static {
        ...
        AccessController.doPrivileged(new PrivilegedAction() { // from class: com.sun.javafx.embed.swing.Disposer.1
            ...
            public Object run2() {
                ...
                while (true) {
                    ...
                    if (tgn != null) {
                        ...
                        Thread t2 = new Thread(tg, Disposer.disposerInstance, "SwingNode Disposer");
