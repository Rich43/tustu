...
/* loaded from: jfxrt.jar:com/sun/javafx/font/freetype/OSFreetype.class */
class OSFreetype {
    ...
    static final native Path2D FT_Outline_Decompose(long j2);

    static final native int FT_Init_FreeType(long[] jArr);

    static final native int FT_Done_FreeType(long j2);

    static final native void FT_Library_Version(long j2, int[] iArr, int[] iArr2, int[] iArr3);

    static final native int FT_Library_SetLcdFilter(long j2, int i2);

    static final native int FT_New_Face(long j2, byte[] bArr, long j3, long[] jArr);

    static final native int FT_Done_Face(long j2);

    static final native int FT_Get_Char_Index(long j2, long j3);

    static final native int FT_Set_Char_Size(long j2, long j3, long j4, int i2, int i3);

    static final native int FT_Load_Glyph(long j2, int i2, int i3);

    static final native void FT_Set_Transform(long j2, FT_Matrix fT_Matrix, long j3, long j4);

    static final native FT_GlyphSlotRec getGlyphSlot(long j2);

    static final native byte[] getBitmapData(long j2);
    ...
    static final int FT_LOAD_TARGET_MODE(int x2) {
        return (x2 >> 16) & 15;
    }
}
