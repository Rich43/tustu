...
/* loaded from: jfxrt.jar:com/sun/javafx/text/ScriptMapper.class */
public class ScriptMapper {
    ...
    public static synchronized int getScript(int codePoint) {
        ...
        if (codePoint < 0 || codePoint >= CHAR_LIMIT) {
            return 103;
        }
        int probe = 512;
        int index = 0;
