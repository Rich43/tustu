...
/* loaded from: jfxrt.jar:com/sun/javafx/image/impl/ByteRgba.class */
public class ByteRgba {
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/image/impl/ByteRgba$Accessor.class */
    static class Accessor implements BytePixelAccessor {
        ...
        public int getArgb(byte[] arr, int offset) {
            return (arr[offset + 2] & 255) | ((arr[offset + 1] & 255) << 8) | ((arr[offset] & 255) << 16) | (arr[offset + 3] << 24);
        }
        ...
        public int getArgb(ByteBuffer buf, int offset) {
            return (buf.get(offset + 2) & 255) | ((buf.get(offset + 1) & 255) << 8) | ((buf.get(offset) & 255) << 16) | (buf.get(offset + 3) << 24);
        }
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/image/impl/ByteRgba$ToByteBgraPreConv.class */
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/image/impl/ByteRgba$ToIntArgbSameConv.class */
    static class ToIntArgbSameConv extends BaseByteToIntConverter {
        ...
        private ToIntArgbSameConv(boolean isPremult) {
            super(isPremult ? ByteBgraPre.getter : ByteRgba.getter, isPremult ? IntArgbPre.setter : IntArgb.setter);
        }
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/image/impl/ByteRgba$ToIntArgbPreConv.class */
