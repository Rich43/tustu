...
/* loaded from: jfxrt.jar:com/sun/javafx/collections/ListListenerHelper.class */
public abstract class ListListenerHelper<E> extends ExpressionHelperBase {
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/collections/ListListenerHelper$SingleInvalidation.class */
    private static class SingleInvalidation<E> extends ListListenerHelper<E> {
        ...
        @Override // com.sun.javafx.collections.ListListenerHelper
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/collections/ListListenerHelper$SingleChange.class */
    ...
    /* loaded from: jfxrt.jar:com/sun/javafx/collections/ListListenerHelper$Generic.class */
        ...
        protected void fireValueChangedEvent(ListChangeListener.Change<? extends E> change) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < curInvalidationSize; i2++) {
                    try {
                        curInvalidationList[i2].invalidated(change.getList());
                    } catch (Exception e2) {
                        Thread.currentThread().getUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e2);
                    }
                }
