...
/* loaded from: jfxrt.jar:com/sun/javafx/scene/control/behavior/TextInputControlBindings.class */
public class TextInputControlBindings {
    ...
    static {
        ...
        BINDINGS.add(new KeyBinding(null, KeyEvent.KEY_TYPED, "InputCharacter").alt(OptionalBoolean.ANY).shift(OptionalBoolean.ANY).ctrl(OptionalBoolean.ANY).meta(OptionalBoolean.ANY));
