...
/* loaded from: jfxrt.jar:com/sun/javafx/scene/control/behavior/TwoLevelFocusListBehavior.class */
public class TwoLevelFocusListBehavior extends TwoLevelFocusBehavior {
    ...
    final ChangeListener<Boolean> focusListener = (observable, oldVal, newVal) -> {
        ...
        boolean b2 = true;
        if (this.tlNode != null && (p2 = this.tlNode.getParent()) != null && ComboBoxPopupControl.COMBO_BOX_STYLE_CLASS.equals(p2.getStyleClass().toString())) {
            b2 = false;
        }
        setExternalFocus(b2);
    };
