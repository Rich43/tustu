...
/* loaded from: rt.jar:com/sun/imageio/plugins/jpeg/JPEG.class */
public class JPEG {
    ...
    static final int[][] bandOffsets = {new int[]{0}, new int[]{0, 1}, new int[]{0, 1, 2}, new int[]{0, 1, 2, 3}};
    static final int[] bOffsRGB = {2, 1, 0};

    /* loaded from: rt.jar:com/sun/imageio/plugins/jpeg/JPEG$JCS.class */
    ...
    static boolean isNonStandardICC(ColorSpace colorSpace) {
        boolean z2 = false;
    ...
    static boolean isJFIFcompliant(ImageTypeSpecifier imageTypeSpecifier, boolean z2) {
        ...
        if (colorModel.getColorSpace().getType() == 3) {
            return true;
        }
        return false;
    }

    static int transformForType(ImageTypeSpecifier imageTypeSpecifier, boolean z2) {
        int i2 = -1;
    ...
    static float convertToLinearQuality(float f2) {
        float f3;
        if (f2 <= 0.0f) {
            f2 = 0.01f;
        }
    ...
    static JPEGHuffmanTable[] getDefaultHuffmanTables(boolean z2) {
