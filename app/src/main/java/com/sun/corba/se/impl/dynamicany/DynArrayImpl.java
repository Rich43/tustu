...
/* loaded from: rt.jar:com/sun/corba/se/impl/dynamicany/DynArrayImpl.class */
public class DynArrayImpl extends DynAnyCollectionImpl implements DynArray {
    ...
    protected DynArrayImpl(ORB orb, Any any, boolean z2) {
        super(orb, any, z2);
    }
    ...
    protected boolean initializeComponentsFromAny() {
        ...
        try {
            ...
            for (int i2 = 0; i2 < bound; i2++) {
                this.anys[i2] = DynAnyUtil.extractAnyFromStream(contentType, inputStreamCreate_input_stream, this.orb);
                try {
                    this.components[i2] = DynAnyUtil.createMostDerivedDynAny(this.anys[i2], this.orb, false);
