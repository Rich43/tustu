...
/* loaded from: rt.jar:com/sun/corba/se/impl/protocol/giopmsgheaders/Message.class */
public interface Message {
    ...
    void setSize(ByteBuffer byteBuffer, int i2);

    FragmentMessage createFragmentMessage();

    void callback(MessageHandler messageHandler) throws IOException;

    void setByteBuffer(ByteBuffer byteBuffer);

    void setEncodingVersion(byte b2);
}
