...
/* loaded from: rt.jar:com/sun/corba/se/impl/protocol/giopmsgheaders/CancelRequestMessage_1_2.class */
public final class CancelRequestMessage_1_2 extends Message_1_1 implements CancelRequestMessage {
    ...
    CancelRequestMessage_1_2(int i2) {
        super(Message.GIOPBigMagic, GIOPVersion.V1_2, (byte) 0, (byte) 2, 4);
        this.request_id = 0;
        this.request_id = i2;
    }
