...
/* loaded from: rt.jar:com/sun/corba/se/impl/protocol/FullServantCacheLocalCRDImpl.class */
public class FullServantCacheLocalCRDImpl extends ServantCacheLocalCRDBase {
    public FullServantCacheLocalCRDImpl(ORB orb, int i2, IOR ior) {
        super(orb, i2, ior);
    }
    ...
    public ServantObject servant_preinvoke(Object object, String str, Class cls) {
        ...
        try {
            ...
            throw this.wrapper.preinvokePoaDestroyed(e2);
        }
    }
