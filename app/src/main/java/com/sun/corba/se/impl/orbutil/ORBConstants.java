...
/* loaded from: rt.jar:com/sun/corba/se/impl/orbutil/ORBConstants.class */
public class ORBConstants {
    ...
    public static final String ALLOW_DESERIALIZE_OBJECT = "com.sun.CORBA.ORBAllowDeserializeObject";
    ...
    public static int makePersistent(int i2) {
        return i2 | 2;
    }
}
