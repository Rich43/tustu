...
/* loaded from: rt.jar:com/sun/corba/se/impl/dynamicany/DynValueBoxImpl.class */
public class DynValueBoxImpl extends DynValueCommonImpl implements DynValueBox {
    ...
    protected DynValueBoxImpl(ORB orb, Any any, boolean z2) {
        super(orb, any, z2);
    }
    ...
    @Override // com.sun.corba.se.impl.dynamicany.DynAnyComplexImpl, com.sun.corba.se.impl.dynamicany.DynAnyConstructedImpl
