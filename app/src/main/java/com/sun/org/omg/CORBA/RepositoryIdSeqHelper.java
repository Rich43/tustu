...
/* loaded from: rt.jar:com/sun/org/omg/CORBA/RepositoryIdSeqHelper.class */
public final class RepositoryIdSeqHelper {
    ...
    public static String[] read(InputStream inputStream) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            strArr[i2] = RepositoryIdHelper.read(inputStream);
        }
        return strArr;
    }
    ...
    public static void write(OutputStream outputStream, String[] strArr) {
        ...
        for (String str : strArr) {
            RepositoryIdHelper.write(outputStream, str);
        }
    }
}
