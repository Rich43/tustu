...
/* loaded from: rt.jar:com/sun/org/omg/SendingContext/CodeBasePackage/URLSeqHelper.class */
public final class URLSeqHelper {
    ...
    public static String[] read(InputStream inputStream) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            strArr[i2] = URLHelper.read(inputStream);
        }
        return strArr;
    }
    ...
    public static void write(OutputStream outputStream, String[] strArr) {
        ...
        for (String str : strArr) {
            URLHelper.write(outputStream, str);
        }
    }
}
