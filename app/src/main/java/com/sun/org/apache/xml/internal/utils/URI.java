...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/utils/URI.class */
public class URI implements Serializable {
    ...
    /* loaded from: rt.jar:com/sun/org/apache/xml/internal/utils/URI$MalformedURIException.class */
            ...
            if (this.m_host == null) {
                ...
                while (true) {
                    ...
                    if (segIndex2 != -1) {
                        ...
                        if (!tempString.substring(segIndex2).equals(com.sun.org.apache.xalan.internal.templates.Constants.ATTRVAL_PARENT)) {
    ...
    public int hashCode() {
        int hash = (59 * 7) + Objects.hashCode(this.m_scheme);
        return (59 * ((59 * ((59 * ((59 * ((59 * ((59 * hash) + Objects.hashCode(this.m_userinfo))) + Objects.hashCode(this.m_host))) + this.m_port)) + Objects.hashCode(this.m_path))) + Objects.hashCode(this.m_queryString))) + Objects.hashCode(this.m_fragment);
    }
