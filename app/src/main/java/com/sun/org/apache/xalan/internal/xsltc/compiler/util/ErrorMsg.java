...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/xsltc/compiler/util/ErrorMsg.class */
public final class ErrorMsg {
    ...
    public ErrorMsg(String code, Throwable e2) {
        this._message = null;
        this._url = null;
        this._params = null;
        this._code = code;
    ...
    public String toString() {
        ...
        if (this._params == null) {
            errorMessage = null != this._code ? getErrorMessage() : this._message;
        } else {
            errorMessage = MessageFormat.format(getErrorMessage(), this._params);
        }
        String suffix = errorMessage;
        return formatLine() + suffix;
    }

    public String toString(Object obj) {
        Object[] params = {obj.toString()};
        String suffix = MessageFormat.format(getErrorMessage(), params);
        return formatLine() + suffix;
    }

    public String toString(Object obj0, Object obj1) {
        Object[] params = {obj0.toString(), obj1.toString()};
        String suffix = MessageFormat.format(getErrorMessage(), params);
        return formatLine() + suffix;
    }
