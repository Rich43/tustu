...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/util/DOMErrorHandlerWrapper.class */
public class DOMErrorHandlerWrapper implements XMLErrorHandler, DOMErrorHandler {
    ...
    private void printError(DOMError error) {
        ...
        if (locator != null) {
            ...
            this.fOut.print(CallSiteDescriptor.TOKEN_DELIMITER);
    ...
    /* loaded from: rt.jar:com/sun/org/apache/xerces/internal/util/DOMErrorHandlerWrapper$DOMErrorTypeMap.class */
