...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/impl/xs/XSMessageFormatter.class */
public class XSMessageFormatter implements MessageFormatter {
    ...
    public String formatMessage(Locale locale, String key, Object[] arguments) throws MissingResourceException {
        ...
        if (msg == null) {
            throw new MissingResourceException(this.fResourceBundle.getString("BadMessageKey"), "com.sun.org.apache.xerces.internal.impl.msg.SchemaMessages", key);
        }
        return msg;
    }
}
