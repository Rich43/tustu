...
/* loaded from: rt.jar:com/sun/org/apache/bcel/internal/generic/CodeExceptionGen.class */
public final class CodeExceptionGen implements InstructionTargeter, Cloneable, Serializable {
    ...
    public void updateTarget(InstructionHandle old_ih, InstructionHandle new_ih) {
        ...
        if (!targeted) {
            throw new ClassGenException("Not targeting " + ((Object) old_ih) + ", but {" + ((Object) this.start_pc) + ", " + ((Object) this.end_pc) + ", " + ((Object) this.handler_pc) + "}");
        }
    }
    ...
    public String toString() {
        return "CodeExceptionGen(" + ((Object) this.start_pc) + ", " + ((Object) this.end_pc) + ", " + ((Object) this.handler_pc) + ")";
    }
