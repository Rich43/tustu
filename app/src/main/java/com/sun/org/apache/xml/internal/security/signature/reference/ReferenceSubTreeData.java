...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/security/signature/reference/ReferenceSubTreeData.class */
public class ReferenceSubTreeData implements ReferenceNodeSetData {
    private boolean excludeComments;
    private Node root;

    public ReferenceSubTreeData(Node node, boolean z2) {
        this.root = node;
    ...
    /* loaded from: rt.jar:com/sun/org/apache/xml/internal/security/signature/reference/ReferenceSubTreeData$DelayedNodeIterator.class */
