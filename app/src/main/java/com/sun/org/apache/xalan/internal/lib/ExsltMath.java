...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/lib/ExsltMath.class */
public class ExsltMath extends ExsltBase {
    ...
    private static String f12002E = "2.71828182845904523536028747135266249775724709369996";
    ...
    public static double max(NodeList nl) {
        ...
        double m2 = -1.7976931348623157E308d;
        for (int i2 = 0; i2 < nl.getLength(); i2++) {
            Node n2 = nl.item(i2);
            double d2 = toNumber(n2);
            if (!Double.isNaN(d2)) {
                if (d2 > m2) {
                    m2 = d2;
                }
