...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/security/keys/keyresolver/implementations/DSAKeyValueResolver.class */
public class DSAKeyValueResolver extends KeyResolverSpi {
    ...
    public PublicKey engineLookupAndResolvePublicKey(Element element, String str, StorageResolver storageResolver) {
        ...
        if (XMLUtils.elementIsInSignatureSpace(element, Constants._TAG_KEYVALUE)) {
            elementSelectDsNode = XMLUtils.selectDsNode(element.getFirstChild(), Constants._TAG_DSAKEYVALUE, 0);
        ...
        try {
            return new DSAKeyValue(elementSelectDsNode, str).getPublicKey();
