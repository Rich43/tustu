...
/* loaded from: rt.jar:com/sun/org/apache/xpath/internal/compiler/Keywords.class */
public class Keywords {
    ...
    static {
        ...
        axisnames.put(FROM_ANCESTORS_OR_SELF_STRING, 38);
        axisnames.put("attribute", 39);
        axisnames.put(FROM_CHILDREN_STRING, 40);
        axisnames.put(FROM_DESCENDANTS_STRING, 41);
        axisnames.put(FROM_DESCENDANTS_OR_SELF_STRING, 42);
        axisnames.put(FROM_FOLLOWING_STRING, 43);
        axisnames.put(FROM_FOLLOWING_SIBLINGS_STRING, 44);
        axisnames.put(FROM_PARENT_STRING, 45);
        axisnames.put(FROM_PRECEDING_STRING, 46);
        axisnames.put(FROM_PRECEDING_SIBLINGS_STRING, 47);
        axisnames.put(FROM_SELF_STRING, 48);
        axisnames.put("namespace", 49);
        m_axisnames = Collections.unmodifiableMap(axisnames);
        nodetypes.put("comment", Integer.valueOf(OpCodes.NODETYPE_COMMENT));
        nodetypes.put("text", Integer.valueOf(OpCodes.NODETYPE_TEXT));
        nodetypes.put("processing-instruction", Integer.valueOf(OpCodes.NODETYPE_PI));
        ...
        nodetests.put("comment", Integer.valueOf(OpCodes.NODETYPE_COMMENT));
        nodetests.put("text", Integer.valueOf(OpCodes.NODETYPE_TEXT));
        nodetests.put("processing-instruction", Integer.valueOf(OpCodes.NODETYPE_PI));
