...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/xsltc/compiler/util/Type.class */
public abstract class Type implements Constants {
    ...
    public static Type newObjectType(String javaClassName) throws AccessControlException {
        if (javaClassName == Constants.OBJECT_CLASS) {
            return Object;
        }
