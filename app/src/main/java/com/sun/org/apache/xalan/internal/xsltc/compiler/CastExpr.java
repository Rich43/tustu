...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/xsltc/compiler/CastExpr.class */
final class CastExpr extends Expression {
    ...
    public void translateDesynthesized(ClassGenerator classGen, MethodGenerator methodGen) {
        ...
        if (this._typeTest) {
            ...
            int idx = cpg.addInterfaceMethodref(Constants.DOM_INTF, "getExpandedTypeID", Constants.GET_PARENT_SIG);
