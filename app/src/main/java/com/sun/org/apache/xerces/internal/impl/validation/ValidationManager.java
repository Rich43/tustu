...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/impl/validation/ValidationManager.class */
public class ValidationManager {
    ...
    public final void setEntityState(EntityState state) {
        for (int i2 = this.fVSs.size() - 1; i2 >= 0; i2--) {
            ((ValidationState) this.fVSs.elementAt(i2)).setEntityState(state);
        }
    }
