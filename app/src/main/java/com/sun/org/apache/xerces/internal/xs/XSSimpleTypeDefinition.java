...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/xs/XSSimpleTypeDefinition.class */
public interface XSSimpleTypeDefinition extends XSTypeDefinition {
    ...
    boolean isDefinedFacet(short s2);

    short getFixedFacets();

    boolean isFixedFacet(short s2);

    String getLexicalFacetValue(short s2);
