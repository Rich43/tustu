...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/serializer/ElemDesc.class */
public final class ElemDesc {
    ...
    public boolean isAttrFlagSet(String name, int flags) {
        return (null == this.m_attrs || (this.m_attrs.getIgnoreCase(name) & flags) == 0) ? false : true;
    }
}
