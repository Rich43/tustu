...
/* loaded from: rt.jar:com/sun/org/apache/bcel/internal/classfile/Synthetic.class */
public final class Synthetic extends Attribute {
    private byte[] bytes;

    public Synthetic(Synthetic c2) {
