...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/utils/ElemDesc.class */
class ElemDesc {
    ...
    void setAttr(String name, int flags) {
        ...
        this.m_attrs.put(name, Integer.valueOf(flags));
    }

    boolean isAttrFlagSet(String name, int flags) {
        Integer _flags;
        return (null == this.m_attrs || null == (_flags = this.m_attrs.get(name)) || (_flags.intValue() & flags) == 0) ? false : true;
    }
}
