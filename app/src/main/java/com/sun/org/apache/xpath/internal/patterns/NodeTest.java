...
/* loaded from: rt.jar:com/sun/org/apache/xpath/internal/patterns/NodeTest.class */
public class NodeTest extends Expression {
    ...
    public boolean deepEquals(Expression expr) {
        ...
        if (null != nt.m_name) {
            if (null == this.m_name || !nt.m_name.equals(this.m_name)) {
                return false;
            }
        ...
        if (null != nt.m_namespace) {
            if (null == this.m_namespace || !nt.m_namespace.equals(this.m_namespace)) {
                return false;
            }
    ...
    private static final boolean subPartMatch(String p2, String t2) {
        return p2 == t2 || (null != p2 && (t2 == "*" || p2.equals(t2)));
    }

    private static final boolean subPartMatchNS(String p2, String t2) {
        return p2 == t2 || (null != p2 && (p2.length() <= 0 ? null == t2 : t2 == "*" || p2.equals(t2)));
    }
    ...
    public XObject execute(XPathContext xctxt, int context) throws TransformerException {
        ...
        switch (nodeBit) {
            case 1:
            case 2:
                return (this.m_isTotallyWild || (subPartMatchNS(dtm.getNamespaceURI(context), this.m_namespace) && subPartMatch(dtm.getLocalName(context), this.m_name))) ? this.m_score : SCORE_NONE;
            case 4:
            case 8:
                return this.m_score;
            case 64:
