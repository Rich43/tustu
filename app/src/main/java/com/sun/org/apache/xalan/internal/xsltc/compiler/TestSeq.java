...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/xsltc/compiler/TestSeq.class */
final class TestSeq {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < count; i2++) {
            LocationPathPattern pattern = (LocationPathPattern) this._patterns.elementAt(i2);
            if (i2 == 0) {
                result.append("Testseq for kernel ").append(this._kernelType).append('\n');
            }
            result.append("   pattern ").append(i2).append(": ").append(pattern.toString()).append('\n');
        }
    ...
    public InstructionHandle compile(ClassGenerator classGen, MethodGenerator methodGen, InstructionHandle continuation) {
        ...
        InstructionHandle fail = this._default == null ? continuation : getTemplateHandle(this._default);
        for (int n2 = count - 1; n2 >= 0; n2--) {
            LocationPathPattern pattern = getPattern(n2);
        ...
        InstructionHandle instructionHandle = fail;
