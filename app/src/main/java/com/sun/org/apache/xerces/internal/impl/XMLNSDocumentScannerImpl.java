...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/impl/XMLNSDocumentScannerImpl.class */
public class XMLNSDocumentScannerImpl extends XMLDocumentScannerImpl {
    ...
    protected boolean scanStartElement() throws IOException, XNIException {
        ...
        if (this.fSkip && !this.fAdd) {
            QName name2 = this.fElementStack.getNext();
            this.fSkip = this.fEntityScanner.skipString(name2.rawname);
            if (this.fSkip) {
                this.fElementStack.push();
                this.fElementQName = name2;
            } else {
        ...
        if (!this.fSkip || this.fAdd) {
            ...
            if (this.fNamespaces) {
                ...
                String name3 = this.fEntityScanner.scanName(XMLScanner.NameType.ELEMENTSTART);
                this.fElementQName.setValues(null, name3, name3, null);
            }
        }
        if (this.fAdd) {
    ...
    protected void scanAttribute(XMLAttributesImpl attributes) throws IOException, XNIException {
        ...
        scanAttributeValue(tmpStr, this.fTempString2, this.fAttributeQName.rawname, attributes, 0, isVC, this.fCurrentElement.rawname, isNSDecl);
        String value = null;
        if (this.fBindNamespaces && isNSDecl) {
            if (tmpStr.length > this.fXMLNameLimit) {
                this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "MaxXMLNameLimit", new Object[]{new String(tmpStr.ch, tmpStr.offset, tmpStr.length), Integer.valueOf(tmpStr.length), Integer.valueOf(this.fXMLNameLimit), this.fSecurityManager.getStateLiteral(XMLSecurityManager.Limit.MAX_NAME_LIMIT)}, (short) 2);
            }
            ...
            if (prefix2 == XMLSymbols.EMPTY_STRING && localpart == XMLSymbols.PREFIX_XMLNS) {
            ...
            boolean declared = this.fNamespaceContext.declarePrefix(prefix2, uri.length() != 0 ? uri : null);
            if (!declared) {
    ...
    /* loaded from: rt.jar:com/sun/org/apache/xerces/internal/impl/XMLNSDocumentScannerImpl$NSContentDriver.class */
    protected final class NSContentDriver extends XMLDocumentScannerImpl.ContentDriver {
        ...
        private void reconfigurePipeline() {
            ...
            if (XMLNSDocumentScannerImpl.this.fNamespaces && !XMLNSDocumentScannerImpl.this.fDTDValidator.hasGrammar()) {
                XMLNSDocumentScannerImpl.this.fBindNamespaces = true;
