...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo.class */
class XSDocumentInfo {
    ...
    private void initNamespaceSupport(Element schemaRoot) {
        ...
        Node parentNode = schemaRoot.getParentNode();
        while (true) {
            Node parent = parentNode;
            if (parent != null && parent.getNodeType() == 1 && !parent.getNodeName().equals("DOCUMENT_NODE")) {
