...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/xsltc/compiler/QName.class */
final class QName {
    ...
    public QName(String namespace, String prefix, String localname) {
        ...
        this._stringRep = (namespace == null || namespace.equals("")) ? localname : namespace + ':' + localname;
