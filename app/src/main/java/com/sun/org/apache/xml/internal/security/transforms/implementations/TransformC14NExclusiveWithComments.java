...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/security/transforms/implementations/TransformC14NExclusiveWithComments.class */
    ...
    protected XMLSignatureInput enginePerformTransform(XMLSignatureInput xMLSignatureInput, OutputStream outputStream, Transform transform) throws CanonicalizationException {
        try {
            ...
            if (outputStream != null) {
                canonicalizer20010315ExclWithComments.setWriter(outputStream);
            }
            XMLSignatureInput xMLSignatureInput2 = new XMLSignatureInput(canonicalizer20010315ExclWithComments.engineCanonicalize(xMLSignatureInput, inclusiveNamespaces));
