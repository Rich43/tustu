...
/* loaded from: rt.jar:com/sun/org/apache/xalan/internal/xsltc/compiler/XPathParser.class */
public class XPathParser extends lr_parser {
    private int grpLimit;
    private int opLimit;
    private int totalOpLimit;
    ...
    private XMLLimitAnalyzer _limitAnalyzer;
    ...
    public XPathParser() {
        ...
        this.totalOpLimit = 0;
        this._lineNumber = 0;
        this._limitAnalyzer = null;
    }

    public XPathParser(Scanner s2) {
        super(s2);
        this.grpLimit = 0;
        this.opLimit = 0;
        this.totalOpLimit = 0;
    ...
    protected void init_actions() {
        this.action_obj = new parser_actions(this);
    }

    @Override // com.sun.java_cup.internal.runtime.lr_parser
    public Symbol do_action(int act_num, lr_parser parser, Stack stack, int top) throws Exception {
        return this.action_obj.parser_do_action(act_num, parser, stack, top);
    }
    ...
    public XPathParser(Parser parser) {
        ...
        this._xmlSM = (XMLSecurityManager) this._xsltc.getProperty("http://apache.org/xml/properties/security-manager");
        this._limitAnalyzer = new XMLLimitAnalyzer();
        this.grpLimit = this._xmlSM != null ? this._xmlSM.getLimit(XMLSecurityManager.Limit.XPATH_GROUP_LIMIT) : 0;
        this.opLimit = this._xmlSM != null ? this._xmlSM.getLimit(XMLSecurityManager.Limit.XPATH_OP_LIMIT) : 0;
        this.totalOpLimit = this._xmlSM != null ? this._xmlSM.getLimit(XMLSecurityManager.Limit.XPATH_TOTALOP_LIMIT) : 0;
    }
    ...
    public StepPattern createStepPattern(int axis, Object test, Vector predicates) {
        int nodeType;
        if (test == null) {
            int nodeType2 = axis == 2 ? 2 : axis == 9 ? -1 : 1;
            return new StepPattern(axis, nodeType2, predicates);
        }
        if (test instanceof Integer) {
            int nodeType3 = ((Integer) test).intValue();
            return new StepPattern(axis, nodeType3, predicates);
        }
        ...
        if (axis == 9) {
            ...
            QName namespace_uri = this._parser.getQNameIgnoreDefaultNs(Keywords.FUNC_NAMESPACE_STRING);
    ...
    public int findNodeType(int axis, Object test) {
        ...
        if (axis == 9) {
            ...
            return this._xsltc.registerNamespacePrefix(name);
        }
    ...
    public Symbol parse(String expression, int lineNumber) throws Exception {
        try {
            ...
            Symbol s2 = super.parse();
            int grpCount = getCount(1);
            int opCount = getCount(2);
            int totalOpCount = getCount(3);
            String errCode = null;
            Object[] params = null;
            if (this.grpLimit > 0 && grpCount > this.grpLimit) {
                errCode = "XPATH_GROUP_LIMIT";
                params = new Object[]{Integer.valueOf(grpCount), Integer.valueOf(this.grpLimit), this._xmlSM.getStateLiteral(XMLSecurityManager.Limit.XPATH_GROUP_LIMIT)};
            } else if (this.opLimit > 0 && opCount > this.opLimit) {
                errCode = "XPATH_OPERATOR_LIMIT";
                params = new Object[]{Integer.valueOf(opCount), Integer.valueOf(this.opLimit), this._xmlSM.getStateLiteral(XMLSecurityManager.Limit.XPATH_OP_LIMIT)};
            } else if (this.totalOpLimit > 0 && totalOpCount > this.totalOpLimit) {
                errCode = ErrorMsg.XPATH_TOTAL_OPERATOR_LIMIT;
                params = new Object[]{Integer.valueOf(totalOpCount), Integer.valueOf(this.totalOpLimit), this._xmlSM.getStateLiteral(XMLSecurityManager.Limit.XPATH_TOTALOP_LIMIT)};
            }
            if (errCode != null) {
                this._parser.reportError(2, new ErrorMsg(errCode, lineNumber, params));
                throw new RuntimeException(ErrorMsg.XPATH_LIMIT);
            }
            return s2;
        } catch (IllegalCharException e2) {
            ErrorMsg err = new ErrorMsg(ErrorMsg.ILLEGAL_CHAR_ERR, lineNumber, e2.getMessage());
    ...
    final SyntaxTreeNode lookupName(QName name) {
        ...
        return this._symbolTable.lookupName(name);
    }
    ...
    public void report_error(String message, Object info) {
        ErrorMsg err = new ErrorMsg(ErrorMsg.SYNTAX_ERR, this._lineNumber, this._expression);
        this._parser.reportError(2, err);
    }
