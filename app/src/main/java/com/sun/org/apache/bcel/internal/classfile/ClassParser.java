...
/* loaded from: rt.jar:com/sun/org/apache/bcel/internal/classfile/ClassParser.class */
public final class ClassParser {
    ...
    private final void readAttributes() throws IOException, ClassFormatException {
        ...
        for (int i2 = 0; i2 < attributes_count; i2++) {
            this.attributes[i2] = Attribute.readAttribute(this.file, this.constant_pool);
        }
    }
    ...
    private final void readFields() throws IOException, ClassFormatException {
        ...
        for (int i2 = 0; i2 < fields_count; i2++) {
            this.fields[i2] = new Field(this.file, this.constant_pool);
        }
    }
    ...
    private final void readInterfaces() throws IOException, ClassFormatException {
        ...
        for (int i2 = 0; i2 < interfaces_count; i2++) {
            this.interfaces[i2] = this.file.readUnsignedShort();
        }
    }
    ...
    private final void readMethods() throws IOException, ClassFormatException {
        ...
        for (int i2 = 0; i2 < methods_count; i2++) {
            this.methods[i2] = new Method(this.file, this.constant_pool);
        }
    }
