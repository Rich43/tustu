...
/* loaded from: rt.jar:com/sun/org/apache/xml/internal/serializer/ExtendedContentHandler.class */
public interface ExtendedContentHandler extends ContentHandler {
    ...
    void addAttribute(String str, String str2, String str3, String str4, String str5, boolean z2) throws SAXException;
    ...
    boolean startPrefixMapping(String str, String str2, boolean z2) throws SAXException;
    ...
    String getNamespaceURI(String str, boolean z2);

    String getNamespaceURIFromPrefix(String str);

    void setSourceLocator(SourceLocator sourceLocator);

    void addUniqueAttribute(String str, String str2, int i2) throws SAXException;
