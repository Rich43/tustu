...
/* loaded from: rt.jar:com/sun/org/apache/xerces/internal/impl/xs/traversers/XSDGroupTraverser.class */
    ...
    XSParticleDecl traverseLocal(Element elmNode, XSDocumentInfo schemaDoc, SchemaGrammar grammar) {
        ...
        if (group != null && group.fModelGroup != null && (minOccurs != 0 || maxOccurs != 0)) {
            ...
            if (group.fModelGroup.fCompositor == 103) {
                ...
                particle = checkOccurrences(particle, SchemaSymbols.ELT_GROUP, (Element) elmNode.getParentNode(), 2, defaultVals.longValue());
            }
            if (refAttr != null) {
                if (annotation != null) {
    ...
    XSGroupDecl traverseGlobal(Element elmNode, XSDocumentInfo schemaDoc, SchemaGrammar grammar) {
        ...
        if (l_elmChild == null) {
            ...
            if (l_elmChild == null) {
                ...
                particle = traverseAll(l_elmChild, schemaDoc, grammar, 4, group);
                ...
                reportSchemaError("s4s-elt-must-match.1", new Object[]{"group (global)", "(annotation?, (all | choice | sequence))", DOMUtil.getLocalName(l_elmChild)}, l_elmChild);
            }
            if (l_elmChild != null && DOMUtil.getNextSiblingElement(l_elmChild) != null) {
                reportSchemaError("s4s-elt-must-match.1", new Object[]{"group (global)", "(annotation?, (all | choice | sequence))", DOMUtil.getLocalName(DOMUtil.getNextSiblingElement(l_elmChild))}, DOMUtil.getNextSiblingElement(l_elmChild));
            }
        }
        if (strNameAttr != null) {
