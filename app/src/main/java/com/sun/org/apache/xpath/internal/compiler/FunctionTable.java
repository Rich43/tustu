...
/* loaded from: rt.jar:com/sun/org/apache/xpath/internal/compiler/FunctionTable.class */
public class FunctionTable {
    ...
    private static Class[] m_functions = new Class[38];
    ...
    static {
        ...
        m_functionID.put(Keywords.FUNC_HERE_STRING, new Integer(37));
    }

    String getFunctionName(int funcID) {
        return funcID < 38 ? m_functions[funcID].getName() : this.m_functions_customer[funcID - 38].getName();
    }
    ...
    Function getFunction(int which) throws TransformerException {
        try {
            ...
            return (Function) this.m_functions_customer[which - 38].newInstance();
    ...
    public boolean functionAvailable(String methName) {
        ...
        Object tblEntry2 = this.m_functionID_customer.get(methName);
        return null != tblEntry2;
    }
}
