...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSBlend_SRC_OVERPeer.class */
public class PPSBlend_SRC_OVERPeer extends PPSTwoSamplerPeer {
    public PPSBlend_SRC_OVERPeer(FilterContext fctx, Renderer r2, String shaderName) {
