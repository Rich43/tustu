...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEPhongLighting_POINTPeer.class */
public class SSEPhongLighting_POINTPeer extends SSEEffectPeer {
    ...
    public SSEPhongLighting_POINTPeer(FilterContext fctx, Renderer r2, String uniqueName) {
