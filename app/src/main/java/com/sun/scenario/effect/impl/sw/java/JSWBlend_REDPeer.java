...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/java/JSWBlend_REDPeer.class */
public class JSWBlend_REDPeer extends JSWEffectPeer {
    public JSWBlend_REDPeer(FilterContext fctx, Renderer r2, String uniqueName) {
