...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_COLOR_DODGEPeer.class */
public class SSEBlend_COLOR_DODGEPeer extends SSEEffectPeer {
    ...
    public SSEBlend_COLOR_DODGEPeer(FilterContext fctx, Renderer r2, String uniqueName) {
