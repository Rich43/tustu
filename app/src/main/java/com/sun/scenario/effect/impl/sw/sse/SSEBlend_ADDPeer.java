...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_ADDPeer.class */
public class SSEBlend_ADDPeer extends SSEEffectPeer {
    ...
    public SSEBlend_ADDPeer(FilterContext fctx, Renderer r2, String uniqueName) {
