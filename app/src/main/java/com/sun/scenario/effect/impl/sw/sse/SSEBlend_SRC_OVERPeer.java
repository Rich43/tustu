...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_SRC_OVERPeer.class */
public class SSEBlend_SRC_OVERPeer extends SSEEffectPeer {
    ...
    public SSEBlend_SRC_OVERPeer(FilterContext fctx, Renderer r2, String uniqueName) {
