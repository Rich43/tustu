...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSBlend_SRC_ATOPPeer.class */
public class PPSBlend_SRC_ATOPPeer extends PPSTwoSamplerPeer {
    public PPSBlend_SRC_ATOPPeer(FilterContext fctx, Renderer r2, String shaderName) {
