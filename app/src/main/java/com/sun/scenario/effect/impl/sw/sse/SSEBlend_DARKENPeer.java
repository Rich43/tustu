...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_DARKENPeer.class */
public class SSEBlend_DARKENPeer extends SSEEffectPeer {
    ...
    public SSEBlend_DARKENPeer(FilterContext fctx, Renderer r2, String uniqueName) {
