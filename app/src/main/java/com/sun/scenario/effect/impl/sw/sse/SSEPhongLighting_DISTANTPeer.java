...
public class SSEPhongLighting_DISTANTPeer extends SSEEffectPeer {
    ...
    public ImageData filter(Effect effect, RenderState rstate, BaseTransform transform, Rectangle outputClip, ImageData... inputs) {
        ...
        filter(dstPixels, 0, 0, dstw, dsth, dstscan, bumpImg, src0Rect[0], src0Rect[1], src0Rect[2], src0Rect[3], src0w, src0h, src0scan, diffuseConstant, kvals_arr, lightColor_arr[0], lightColor_arr[1], lightColor_arr[2], normalizedLightPosition_arr[0], normalizedLightPosition_arr[1], normalizedLightPosition_arr[2], origImg, src1Rect[0], src1Rect[1], src1Rect[2], src1Rect[3], src1w, src1h, src1scan, specularConstant, specularExponent);
