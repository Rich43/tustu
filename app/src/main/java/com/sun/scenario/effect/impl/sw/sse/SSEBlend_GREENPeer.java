...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_GREENPeer.class */
public class SSEBlend_GREENPeer extends SSEEffectPeer {
    ...
    public SSEBlend_GREENPeer(FilterContext fctx, Renderer r2, String uniqueName) {
