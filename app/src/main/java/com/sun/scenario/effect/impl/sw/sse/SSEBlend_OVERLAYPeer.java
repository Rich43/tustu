...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_OVERLAYPeer.class */
public class SSEBlend_OVERLAYPeer extends SSEEffectPeer {
    ...
    public SSEBlend_OVERLAYPeer(FilterContext fctx, Renderer r2, String uniqueName) {
