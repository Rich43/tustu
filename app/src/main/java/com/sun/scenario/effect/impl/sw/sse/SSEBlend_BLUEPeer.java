...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_BLUEPeer.class */
public class SSEBlend_BLUEPeer extends SSEEffectPeer {
    ...
    public SSEBlend_BLUEPeer(FilterContext fctx, Renderer r2, String uniqueName) {
