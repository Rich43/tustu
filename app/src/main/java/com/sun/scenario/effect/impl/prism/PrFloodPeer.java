...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/PrFloodPeer.class */
public class PrFloodPeer extends EffectPeer {
    public PrFloodPeer(FilterContext fctx, Renderer r2, String uniqueName) {
    ...
    public ImageData filter(Effect effect, RenderState rstate, BaseTransform transform, Rectangle outputClip, ImageData... inputs) {
        ...
        if (dst != null) {
            ...
            gdst.translate(-tmp.f11913x, -tmp.f11914y);
