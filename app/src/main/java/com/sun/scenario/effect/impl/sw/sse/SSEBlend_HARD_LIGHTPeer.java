...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_HARD_LIGHTPeer.class */
public class SSEBlend_HARD_LIGHTPeer extends SSEEffectPeer {
    ...
    public SSEBlend_HARD_LIGHTPeer(FilterContext fctx, Renderer r2, String uniqueName) {
