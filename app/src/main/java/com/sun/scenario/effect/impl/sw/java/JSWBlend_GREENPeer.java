...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/java/JSWBlend_GREENPeer.class */
public class JSWBlend_GREENPeer extends JSWEffectPeer {
    public JSWBlend_GREENPeer(FilterContext fctx, Renderer r2, String uniqueName) {
