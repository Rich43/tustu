...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_SRC_INPeer.class */
public class SSEBlend_SRC_INPeer extends SSEEffectPeer {
    ...
    public SSEBlend_SRC_INPeer(FilterContext fctx, Renderer r2, String uniqueName) {
