...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSLinearConvolveShadowPeer.class */
public class PPSLinearConvolveShadowPeer extends PPSOneSamplerPeer<LinearConvolveRenderState> {
    public PPSLinearConvolveShadowPeer(FilterContext fctx, Renderer r2, String shaderName) {
