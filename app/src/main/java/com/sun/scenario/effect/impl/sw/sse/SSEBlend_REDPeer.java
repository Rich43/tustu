...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_REDPeer.class */
public class SSEBlend_REDPeer extends SSEEffectPeer {
    ...
    public SSEBlend_REDPeer(FilterContext fctx, Renderer r2, String uniqueName) {
