...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_SRC_ATOPPeer.class */
public class SSEBlend_SRC_ATOPPeer extends SSEEffectPeer {
    ...
    public SSEBlend_SRC_ATOPPeer(FilterContext fctx, Renderer r2, String uniqueName) {
