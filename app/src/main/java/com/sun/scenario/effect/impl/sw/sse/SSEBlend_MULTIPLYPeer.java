...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_MULTIPLYPeer.class */
public class SSEBlend_MULTIPLYPeer extends SSEEffectPeer {
    ...
    public SSEBlend_MULTIPLYPeer(FilterContext fctx, Renderer r2, String uniqueName) {
