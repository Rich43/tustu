...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_LIGHTENPeer.class */
public class SSEBlend_LIGHTENPeer extends SSEEffectPeer {
    ...
    public SSEBlend_LIGHTENPeer(FilterContext fctx, Renderer r2, String uniqueName) {
