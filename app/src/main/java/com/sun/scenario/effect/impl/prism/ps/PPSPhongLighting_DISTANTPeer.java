...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_DISTANTPeer.class */
public class PPSPhongLighting_DISTANTPeer extends PPSTwoSamplerPeer {
    private FloatBuffer kvals;

    public PPSPhongLighting_DISTANTPeer(FilterContext fctx, Renderer r2, String shaderName) {
