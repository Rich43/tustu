...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSBlend_DIFFERENCEPeer.class */
public class PPSBlend_DIFFERENCEPeer extends PPSTwoSamplerPeer {
    public PPSBlend_DIFFERENCEPeer(FilterContext fctx, Renderer r2, String shaderName) {
