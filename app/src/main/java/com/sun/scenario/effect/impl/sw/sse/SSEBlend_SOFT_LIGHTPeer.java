...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_SOFT_LIGHTPeer.class */
public class SSEBlend_SOFT_LIGHTPeer extends SSEEffectPeer {
    ...
    public SSEBlend_SOFT_LIGHTPeer(FilterContext fctx, Renderer r2, String uniqueName) {
