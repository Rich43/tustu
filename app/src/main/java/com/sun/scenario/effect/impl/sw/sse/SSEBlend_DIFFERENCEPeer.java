...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_DIFFERENCEPeer.class */
public class SSEBlend_DIFFERENCEPeer extends SSEEffectPeer {
    ...
    public SSEBlend_DIFFERENCEPeer(FilterContext fctx, Renderer r2, String uniqueName) {
