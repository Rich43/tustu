...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSPhongLighting_POINTPeer.class */
public class PPSPhongLighting_POINTPeer extends PPSTwoSamplerPeer {
    private FloatBuffer kvals;

    public PPSPhongLighting_POINTPeer(FilterContext fctx, Renderer r2, String shaderName) {
