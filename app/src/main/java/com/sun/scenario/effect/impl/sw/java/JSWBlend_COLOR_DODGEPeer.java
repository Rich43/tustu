...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/java/JSWBlend_COLOR_DODGEPeer.class */
public class JSWBlend_COLOR_DODGEPeer extends JSWEffectPeer {
    public JSWBlend_COLOR_DODGEPeer(FilterContext fctx, Renderer r2, String uniqueName) {
        ...
        for (int dy = 0; dy < 0 + dsth; dy++) {
            ...
            for (int dx = 0; dx < 0 + dstw; dx++) {
                ...
                if (sample_res_x == 0.0f) {
                    ...
                    tmp_x = ((top_w * top_w) * sample_res_x) / (top_w - top_x);
                    if (tmp_x > proda) {
                        tmp_x = proda;
                    }
                } else {
                ...
                if (sample_res_y == 0.0f) {
                    ...
                    tmp_y = ((top_w * top_w) * sample_res_y) / (top_w - top_y);
                    if (tmp_y > proda) {
                        tmp_y = proda;
                    }
                } else {
                ...
                if (sample_res_z == 0.0f) {
                    ...
                    tmp_z = ((top_w * top_w) * sample_res_z) / (top_w - top_z);
                    if (tmp_z > proda) {
                        tmp_z = proda;
                    }
                } else {
