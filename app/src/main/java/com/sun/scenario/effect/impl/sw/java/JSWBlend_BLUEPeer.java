...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/java/JSWBlend_BLUEPeer.class */
public class JSWBlend_BLUEPeer extends JSWEffectPeer {
    public JSWBlend_BLUEPeer(FilterContext fctx, Renderer r2, String uniqueName) {
    ...
    public ImageData filter(Effect effect, RenderState rstate, BaseTransform transform, Rectangle outputClip, ImageData... inputs) {
        ...
        for (int dy = 0; dy < 0 + dsth; dy++) {
            ...
            for (int dx = 0; dx < 0 + dstw; dx++) {
                ...
                float f5 = sample_res_y2 * opacity;
                ...
                float res_z = ((1.0f - top_w) * sample_res_z) + top_z;
