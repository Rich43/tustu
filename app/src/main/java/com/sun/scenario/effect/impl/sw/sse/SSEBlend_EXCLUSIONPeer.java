...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_EXCLUSIONPeer.class */
public class SSEBlend_EXCLUSIONPeer extends SSEEffectPeer {
    ...
    public SSEBlend_EXCLUSIONPeer(FilterContext fctx, Renderer r2, String uniqueName) {
