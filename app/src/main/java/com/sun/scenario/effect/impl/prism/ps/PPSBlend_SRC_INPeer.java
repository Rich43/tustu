...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/prism/ps/PPSBlend_SRC_INPeer.class */
public class PPSBlend_SRC_INPeer extends PPSTwoSamplerPeer {
    public PPSBlend_SRC_INPeer(FilterContext fctx, Renderer r2, String shaderName) {
