...
/* loaded from: jfxrt.jar:com/sun/scenario/effect/impl/sw/sse/SSEBlend_SCREENPeer.class */
public class SSEBlend_SCREENPeer extends SSEEffectPeer {
    ...
    public SSEBlend_SCREENPeer(FilterContext fctx, Renderer r2, String uniqueName) {
