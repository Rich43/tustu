...
/* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/policy/MtomPolicyMapConfigurator.class */
public class MtomPolicyMapConfigurator implements PolicyMapConfigurator {
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/policy/MtomPolicyMapConfigurator$MtomAssertion.class */
    ...
    public Collection<PolicySubject> update(PolicyMap policyMap, SEIModel model, WSBinding wsBinding) throws PolicyException {
        ...
        if (policyMap != null) {
            ...
            if (LOGGER.isLoggable(Level.FINEST)) {
                LOGGER.finest("mtomFeature = " + ((Object) mtomFeature));
            }
            if (mtomFeature != null && mtomFeature.isEnabled()) {
                ...
                Policy mtomPolicy = createMtomPolicy(bindingName);
                PolicySubject mtomPolicySubject = new PolicySubject(wsdlSubject, mtomPolicy);
                subjects.add(mtomPolicySubject);
                if (LOGGER.isLoggable(Level.FINEST)) {
                    LOGGER.fine("Added MTOM policy with ID \"" + mtomPolicy.getIdOrName() + "\" to binding element \"" + ((Object) bindingName) + PdfOps.DOUBLE_QUOTE__TOKEN);
                }
            }
        }
