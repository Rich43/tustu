...
/* loaded from: rt.jar:com/sun/xml/internal/bind/v2/runtime/reflect/opt/TransducedAccessor_method_Integer.class */
public final class TransducedAccessor_method_Integer extends DefaultTransducedAccessor {
    ...
    public void writeLeafElement(XMLSerializer w2, Name tagName, Object o2, String fieldName) throws AccessorException, XMLStreamException, SAXException, IOException {
        w2.leafElement(tagName, ((Bean) o2).get_int(), fieldName);
    }
}
