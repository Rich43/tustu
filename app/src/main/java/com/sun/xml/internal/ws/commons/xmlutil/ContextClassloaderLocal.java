...
/* loaded from: rt.jar:com/sun/xml/internal/ws/commons/xmlutil/ContextClassloaderLocal.class */
abstract class ContextClassloaderLocal<V> {
    ...
    private static ClassLoader getContextClassLoader() {
        return (ClassLoader) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.sun.xml.internal.ws.commons.xmlutil.ContextClassloaderLocal.1
