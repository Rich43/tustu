...
/* loaded from: rt.jar:com/sun/xml/internal/fastinfoset/org/apache/xerces/util/XMLChar.class */
public class XMLChar {
    ...
    static {
        ...
        Arrays.fill(CHARS, 319, EncodingConstants.OCTET_STRING_LENGTH_2ND_BIT_MEDIUM_LIMIT, (byte) 33);
        Arrays.fill(CHARS, EncodingConstants.OCTET_STRING_LENGTH_2ND_BIT_MEDIUM_LIMIT, 329, (byte) -19);
        CHARS[329] = 33;
        ...
        Arrays.fill(CHARS, 506, FTPReply.REQUESTED_PROT_LEVEL_NOT_SUPPORTED, (byte) -19);
        Arrays.fill(CHARS, FTPReply.REQUESTED_PROT_LEVEL_NOT_SUPPORTED, 592, (byte) 33);
        ...
        Arrays.fill(CHARS, 866, Krb5.ASN1_MISPLACED_FIELD, (byte) 33);
        CHARS[902] = -19;
        CHARS[903] = -87;
        Arrays.fill(CHARS, Krb5.ASN1_OVERFLOW, Krb5.ASN1_BAD_LENGTH, (byte) -19);
        CHARS[907] = 33;
        CHARS[908] = -19;
        CHARS[909] = 33;
        Arrays.fill(CHARS, Krb5.ASN1_BAD_CLASS, 930, (byte) -19);
        CHARS[930] = 33;
        ...
        CHARS[992] = -19;
        CHARS[993] = 33;
        Arrays.fill(CHARS, 994, Event.F5, (byte) -19);
        Arrays.fill(CHARS, Event.F5, Event.INSERT, (byte) 33);
        Arrays.fill(CHARS, Event.INSERT, 1037, (byte) -19);
        CHARS[1037] = 33;
        ...
        Arrays.fill(CHARS, 4343, NormalizerImpl.JAMO_L_BASE, (byte) 33);
        CHARS[4352] = -19;
        CHARS[4353] = 33;
        ...
        Arrays.fill(CHARS, 40870, NormalizerImpl.HANGUL_BASE, (byte) 33);
        Arrays.fill(CHARS, NormalizerImpl.HANGUL_BASE, 55204, (byte) -19);
        Arrays.fill(CHARS, 55204, 55296, (byte) 33);
        Arrays.fill(CHARS, 57344, CharToGlyphMapper.INVISIBLE_GLYPHS, (byte) 33);
    }
