...
/* loaded from: rt.jar:com/sun/xml/internal/messaging/saaj/soap/MessageFactoryImpl.class */
public class MessageFactoryImpl extends MessageFactory {
    ...
    public SOAPMessage createMessage(MimeHeaders headers, InputStream in) throws SOAPException, IOException {
        ...
        try {
            ...
            throw new SOAPExceptionImpl("Unable to parse content type: " + e2.getMessage());
        }
    }
