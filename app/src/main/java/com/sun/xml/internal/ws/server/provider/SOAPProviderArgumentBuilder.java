...
/* loaded from: rt.jar:com/sun/xml/internal/ws/server/provider/SOAPProviderArgumentBuilder.class */
abstract class SOAPProviderArgumentBuilder<T> extends ProviderArgumentsBuilder<T> {
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/server/provider/SOAPProviderArgumentBuilder$PayloadSource.class */
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/server/provider/SOAPProviderArgumentBuilder$MessageSource.class */
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/server/provider/SOAPProviderArgumentBuilder$SOAPMessageParameter.class */
    private static final class SOAPMessageParameter extends SOAPProviderArgumentBuilder<SOAPMessage> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // com.sun.xml.internal.ws.server.provider.ProviderArgumentsBuilder
        public Message getResponseMessage(SOAPMessage soapMsg) {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // com.sun.xml.internal.ws.server.provider.ProviderArgumentsBuilder
        public Packet getResponse(Packet request, @Nullable SOAPMessage returnValue, WSDLPort port, WSBinding binding) {
            Packet response = super.getResponse(request, (Packet) returnValue, port, binding);
            if (returnValue != null && response.supports(Packet.OUTBOUND_TRANSPORT_HEADERS)) {
                ...
                while (i2.hasNext()) {
                    MimeHeader header = (MimeHeader) i2.next();
