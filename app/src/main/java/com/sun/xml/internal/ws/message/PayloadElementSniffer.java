...
/* loaded from: rt.jar:com/sun/xml/internal/ws/message/PayloadElementSniffer.class */
public class PayloadElementSniffer extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (equalsQName(uri, localName, SOAPConstants.QNAME_SOAP_BODY) || equalsQName(uri, localName, SOAP12Constants.QNAME_SOAP_BODY)) {
