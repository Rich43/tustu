...
/* loaded from: rt.jar:com/sun/xml/internal/ws/model/Utils.class */
final class Utils {
    ...
    static {
        try {
            ...
            Method getInstance = (Method) AccessController.doPrivileged(new PrivilegedAction<Method>() { // from class: com.sun.xml.internal.ws.model.Utils.1
