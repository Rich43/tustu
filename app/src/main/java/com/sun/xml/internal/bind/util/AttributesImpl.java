...
/* loaded from: rt.jar:com/sun/xml/internal/bind/util/AttributesImpl.class */
public class AttributesImpl implements Attributes {
    ...
    public int getIndexFast(String uri, String localName) {
        for (int i2 = (this.length - 1) * 5; i2 >= 0; i2 -= 5) {
            if (this.data[i2 + 1] == localName && this.data[i2] == uri) {
                return i2 / 5;
            }
        }
        return -1;
