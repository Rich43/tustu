...
/* loaded from: rt.jar:com/sun/xml/internal/fastinfoset/EncodingConstants.class */
public final class EncodingConstants {
    ...
    static {
        ...
        OCTET_STRING_LENGTH_2ND_BIT_VALUES = new int[]{65, OCTET_STRING_LENGTH_2ND_BIT_MEDIUM_LIMIT, 64, 96};
        OCTET_STRING_LENGTH_5TH_BIT_VALUES = new int[]{9, 265, 8, 12};
        OCTET_STRING_LENGTH_7TH_BIT_VALUES = new int[]{3, 259, 2, 3};
        INTEGER_2ND_BIT_VALUES = new int[]{64, INTEGER_2ND_BIT_MEDIUM_LIMIT, 1048576, 64, 96, -1};
        INTEGER_3RD_BIT_VALUES = new int[]{32, INTEGER_3RD_BIT_MEDIUM_LIMIT, INTEGER_3RD_BIT_LARGE_LIMIT, 32, 40, 48};
        INTEGER_4TH_BIT_VALUES = new int[]{16, INTEGER_4TH_BIT_MEDIUM_LIMIT, INTEGER_4TH_BIT_LARGE_LIMIT, 16, 20, 24};
