...
/* loaded from: rt.jar:com/sun/xml/internal/ws/message/RootElementSniffer.class */
public final class RootElementSniffer extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes a2) throws SAXException {
        this.nsUri = uri;
        ...
        if (this.parseAttributes) {
            if (a2.getLength() == 0) {
                ...
                this.atts = new AttributesImpl(a2);
            }
        }
        throw aSAXException;
    }
