...
/* loaded from: rt.jar:com/sun/xml/internal/bind/v2/model/impl/Utils.class */
final class Utils {
    ...
    static {
        try {
            ...
            Method getInstance = (Method) AccessController.doPrivileged(new PrivilegedAction<Method>() { // from class: com.sun.xml.internal.bind.v2.model.impl.Utils.1
