...
/* loaded from: rt.jar:com/sun/xml/internal/ws/policy/sourcemodel/attach/ExternalAttachmentsUnmarshaller.class */
public class ExternalAttachmentsUnmarshaller {
    ...
    static {
        try {
            ...
            URI = new QName("http://www.w3.org/ns/ws-policy", Constants._ATT_URI);
            POLICIES = new QName(PolicyConstants.SUN_MANAGEMENT_NAMESPACE, "Policies");
            XML_INPUT_FACTORY = new ContextClassloaderLocal<XMLInputFactory>() { // from class: com.sun.xml.internal.ws.policy.sourcemodel.attach.ExternalAttachmentsUnmarshaller.1
                /* JADX INFO: Access modifiers changed from: protected */
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // com.sun.xml.internal.ws.policy.sourcemodel.attach.ContextClassloaderLocal
                public XMLInputFactory initialValue() throws Exception {
                    return XMLInputFactory.newInstance();
                }
            };
            POLICY_UNMARSHALLER = PolicyModelUnmarshaller.getXmlUnmarshaller();
        } catch (URISyntaxException e2) {
            throw ((IllegalArgumentException) LOGGER.logSevereException((PolicyLogger) new IllegalArgumentException(LocalizationMessages.WSP_0094_INVALID_URN()), (Throwable) e2));
        }
    }
    ...
    public static Map<URI, Policy> unmarshal(Reader source) throws PolicyException {
        ...
        try {
            ...
            throw ((PolicyException) LOGGER.logSevereException((PolicyLogger) new PolicyException(LocalizationMessages.WSP_0086_FAILED_CREATE_READER(source)), (Throwable) ex));
        }
    }
            ...
            try {
                ...
                switch (event.getEventType()) {
                    case 1:
                        ...
                        processStartTag(element, parentElement, reader, this.map);
                        break;
                    case 2:
                    ...
                    case 4:
                        processCharacters(event.asCharacters(), parentElement, this.map);
                        reader.nextEvent();
                        break;
                    case 5:
                    case 7:
                ...
                throw ((PolicyException) LOGGER.logSevereException((PolicyLogger) new PolicyException(LocalizationMessages.WSP_0088_FAILED_PARSE(location)), (Throwable) e2));
            }
        }
        return this.map;
    }
    ...
    private void processStartTag(StartElement element, StartElement parent, XMLEventReader reader, Map<URI, Policy> map) throws PolicyException {
        try {
            ...
            reader.nextEvent();
            unmarshal(reader, element);
        } catch (XMLStreamException e2) {
            throw ((PolicyException) LOGGER.logSevereException(new PolicyException(LocalizationMessages.WSP_0088_FAILED_PARSE(element.getLocation()), e2)));
        }
    }
    ...
    private void processUri(Characters chars, Map<URI, Policy> map) throws PolicyException {
        ...
        try {
            ...
            throw ((PolicyException) LOGGER.logSevereException((PolicyLogger) new PolicyException(LocalizationMessages.WSP_0093_INVALID_URI(data, chars.getLocation())), (Throwable) e2));
        }
    }
}
