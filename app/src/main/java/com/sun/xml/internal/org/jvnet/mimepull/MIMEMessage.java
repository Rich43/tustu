...
/* loaded from: rt.jar:com/sun/xml/internal/org/jvnet/mimepull/MIMEMessage.class */
public class MIMEMessage {
    ...
    public MIMEPart getPart(int index) {
        LOGGER.log(Level.FINE, "index={0}", Integer.valueOf(index));
        ...
        LOGGER.log(Level.FINE, "Got attachment at index={0} attachment={1}", new Object[]{Integer.valueOf(index), part});
        return part;
    }
    ...
    public synchronized boolean makeProgress() {
        ...
        switch (event.getEventType()) {
            ...
            default:
                throw new MIMEParsingException("Unknown Parser state = " + ((Object) event.getEventType()));
        }
    }
}
