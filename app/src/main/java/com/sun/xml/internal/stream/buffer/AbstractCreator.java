...
/* loaded from: rt.jar:com/sun/xml/internal/stream/buffer/AbstractCreator.class */
public class AbstractCreator extends AbstractCreatorProcessor {
    ...
    protected final void storeStructure(int b2) {
    ...
    protected final void storeStructureString(String s2) {
    ...
    protected final void storeContentString(String s2) {
        storeContentObject(s2);
    }
    ...
    protected final void storeContentObject(Object s2) {
