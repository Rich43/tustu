...
/* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/soap/SOAP12Constants.class */
public class SOAP12Constants {
    ...
    public static final QName QNAME_SOAP_RPC = new QName("http://www.w3.org/2002/06/soap-rpc", CORBALogDomains.RPC);
    ...
    public static final QName QNAME_SOAP_FAULT = new QName("http://www.w3.org/2003/05/soap-envelope", SOAPNamespaceConstants.TAG_FAULT);
    public static final QName QNAME_MUSTUNDERSTAND = new QName("http://www.w3.org/2003/05/soap-envelope", "mustUnderstand");
    public static final QName QNAME_ROLE = new QName("http://www.w3.org/2003/05/soap-envelope", SOAP12NamespaceConstants.ATTR_ACTOR);
    public static final QName QNAME_NOT_UNDERSTOOD = new QName("http://www.w3.org/2003/05/soap-envelope", SOAP12NamespaceConstants.TAG_NOT_UNDERSTOOD);
