...
@ManagedData
/* loaded from: rt.jar:com/sun/xml/internal/ws/developer/MemberSubmissionAddressingFeature.class */
public class MemberSubmissionAddressingFeature extends WebServiceFeature {
    ...
    @FeatureConstructor({Enabled.NAME, SchemaSymbols.ATTVAL_REQUIRED, Constants.VALIDATION_FEATURE})
