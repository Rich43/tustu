...
/* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/policy/FastInfosetFeatureConfigurator.class */
            ...
            while (assertions.hasNext()) {
                ...
                while (policyAssertion.hasNext()) {
                    ...
                    if (EncodingConstants.OPTIMIZED_FI_SERIALIZATION_ASSERTION.equals(assertion.getName())) {
                        ...
                        boolean isFastInfosetEnabled = Boolean.valueOf(value.trim()).booleanValue();
