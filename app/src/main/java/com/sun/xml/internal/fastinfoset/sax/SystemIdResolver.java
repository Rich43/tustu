...
/* loaded from: rt.jar:com/sun/xml/internal/fastinfoset/sax/SystemIdResolver.class */
public class SystemIdResolver {
    public static String getAbsoluteURIFromRelative(String localPath) {
        ...
        if (null != absolutePath) {
            urlString = absolutePath.startsWith(File.separator) ? BareBonesBrowserLaunch.FILE_PREFIX + absolutePath : "file:///" + absolutePath;
        } else {
