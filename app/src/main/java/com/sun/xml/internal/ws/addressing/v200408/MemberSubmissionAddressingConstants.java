...
/* loaded from: rt.jar:com/sun/xml/internal/ws/addressing/v200408/MemberSubmissionAddressingConstants.class */
public interface MemberSubmissionAddressingConstants {
    ...
    public static final QName MEX_METADATA = new QName("http://schemas.xmlsoap.org/ws/2004/09/mex", W3CAddressingConstants.WSA_METADATA_NAME, "mex");
