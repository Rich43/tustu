...
/* loaded from: rt.jar:com/sun/xml/internal/bind/api/JAXBRIContext.class */
public abstract class JAXBRIContext extends JAXBContext {
    ...
    public static JAXBRIContext newInstance(@NotNull Class[] classes, @Nullable Collection<TypeReference> typeRefs, @Nullable Map<Class, Class> subclassReplacements, @Nullable String defaultNamespaceRemap, boolean c14nSupport, @Nullable RuntimeAnnotationReader ar2) throws JAXBException {
        return newInstance(classes, typeRefs, subclassReplacements, defaultNamespaceRemap, c14nSupport, ar2, false, false, false, false);
    }

    public static JAXBRIContext newInstance(@NotNull Class[] classes, @Nullable Collection<TypeReference> typeRefs, @Nullable Map<Class, Class> subclassReplacements, @Nullable String defaultNamespaceRemap, boolean c14nSupport, @Nullable RuntimeAnnotationReader ar2, boolean xmlAccessorFactorySupport, boolean allNillable, boolean retainPropertyInfo, boolean supressAccessorWarnings) throws JAXBException {
        ...
        if (ar2 != null) {
            properties.put(ANNOTATION_READER, ar2);
        }
        properties.put("com.sun.xml.internal.bind.c14n", Boolean.valueOf(c14nSupport));
        properties.put("com.sun.xml.internal.bind.XmlAccessorFactory", Boolean.valueOf(xmlAccessorFactorySupport));
        properties.put("com.sun.xml.internal.bind.treatEverythingNillable", Boolean.valueOf(allNillable));
        properties.put("retainReferenceToInfo", Boolean.valueOf(retainPropertyInfo));
