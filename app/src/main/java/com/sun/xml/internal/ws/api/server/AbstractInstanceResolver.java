...
/* loaded from: rt.jar:com/sun/xml/internal/ws/api/server/AbstractInstanceResolver.class */
public abstract class AbstractInstanceResolver<T> extends InstanceResolver<T> {
    ...
    protected static void invokeMethod(@Nullable final Method method, final Object instance, final Object... args) {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() { // from class: com.sun.xml.internal.ws.api.server.AbstractInstanceResolver.1
    ...
    @Nullable
    protected final Method findAnnotatedMethod(Class clazz, Class<? extends Annotation> annType) throws SecurityException {
        boolean once = false;
        Method r2 = null;
