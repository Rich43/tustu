...
/* loaded from: rt.jar:com/sun/xml/internal/ws/api/policy/ModelTranslator.class */
    ...
    static {
        ...
        try {
            try {
                ...
                tempException = e2;
                LOGGER.warning(ManagementMessages.WSM_1007_FAILED_MODEL_TRANSLATOR_INSTANTIATION(), e2);
                translator = tempTranslator;
