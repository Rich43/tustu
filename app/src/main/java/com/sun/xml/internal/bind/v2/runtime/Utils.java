...
/* loaded from: rt.jar:com/sun/xml/internal/bind/v2/runtime/Utils.class */
final class Utils {
    ...
    static {
        try {
            ...
            Method getInstance = (Method) AccessController.doPrivileged(new PrivilegedAction<Method>() { // from class: com.sun.xml.internal.bind.v2.runtime.Utils.1
