...
/* loaded from: rt.jar:com/sun/xml/internal/bind/v2/runtime/property/Utils.class */
final class Utils {
    ...
    static {
        try {
            ...
            Method getInstance = (Method) AccessController.doPrivileged(new PrivilegedAction<Method>() { // from class: com.sun.xml.internal.bind.v2.runtime.property.Utils.1
