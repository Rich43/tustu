...
/* loaded from: rt.jar:com/sun/xml/internal/messaging/saaj/util/JaxmURI.class */
public class JaxmURI implements Serializable {
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/messaging/saaj/util/JaxmURI$MalformedURIException.class */
        ...
        if (p_base != null) {
            ...
            if (this.m_scheme == null) {
                ...
                if (this.m_host == null) {
                    ...
                    int index3 = 1;
                    while (true) {
                        int iIndexOf = path2.indexOf("/../", index3);
                        index3 = iIndexOf;
                        if (iIndexOf <= 0) {
                            break;
                        }
