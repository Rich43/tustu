...
/* loaded from: rt.jar:com/sun/xml/internal/messaging/saaj/soap/ImageDataContentHandler.class */
public class ImageDataContentHandler extends Component implements DataContentHandler {
    ...
    public Object getTransferData(DataFlavor df, DataSource ds) throws IOException {
        for (int i2 = 0; i2 < this.flavor.length; i2++) {
            if (this.flavor[i2].equals(df)) {
    ...
    public void writeTo(Object obj, String type, OutputStream os) throws IOException {
        ...
        try {
            ...
            Iterator i2 = ImageIO.getImageWritersByMIMEType(type);
            if (i2.hasNext()) {
                writer = i2.next();
            }
            if (writer != null) {
            ...
            log.log(Level.SEVERE, "SAAJ0526.soap.unsupported.mime.type", (Object[]) new String[]{type});
