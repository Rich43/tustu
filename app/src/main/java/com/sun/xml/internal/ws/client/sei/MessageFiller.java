...
/* loaded from: rt.jar:com/sun/xml/internal/ws/client/sei/MessageFiller.class */
abstract class MessageFiller {
    protected final int methodPos;

    abstract void fillIn(Object[] objArr, Message message);

    protected MessageFiller(int methodPos) {
        this.methodPos = methodPos;
    }

    /* loaded from: rt.jar:com/sun/xml/internal/ws/client/sei/MessageFiller$AttachmentFiller.class */
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/client/sei/MessageFiller$ByteArrayFiller.class */
    private static class ByteArrayFiller extends AttachmentFiller {
        ...
        @Override // com.sun.xml.internal.ws.client.sei.MessageFiller
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/client/sei/MessageFiller$DataHandlerFiller.class */
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/client/sei/MessageFiller$JAXBFiller.class */
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/client/sei/MessageFiller$Header.class */
