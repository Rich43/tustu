...
/* loaded from: rt.jar:com/sun/xml/internal/ws/message/source/PayloadSourceMessage.class */
public class PayloadSourceMessage extends PayloadStreamReaderMessage {
    ...
    public PayloadSourceMessage(Source s2, SOAPVersion soapVer) {
        this(null, s2, new AttachmentSetImpl(), soapVer);
    }
}
