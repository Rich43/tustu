...
/* loaded from: rt.jar:com/sun/xml/internal/ws/wsdl/writer/UsingAddressing.class */
public interface UsingAddressing extends TypedXmlWriter, StartWithExtensionsType {
    @XmlAttribute(value = SchemaSymbols.ATTVAL_REQUIRED, ns = "http://schemas.xmlsoap.org/wsdl/")
    void required(boolean z2);
}
