...
/* loaded from: rt.jar:com/sun/xml/internal/ws/transport/http/server/HttpEndpoint.class */
public final class HttpEndpoint extends com.sun.xml.internal.ws.api.server.HttpEndpoint {
    ...
    private String getEPRAddress() {
        ...
        try {
            URL u2 = new URL(this.address);
            if (u2.getPort() == 0) {
                return new URL(u2.getProtocol(), u2.getHost(), this.httpContext.getServer().getAddress().getPort(), u2.getFile()).toString();
            }
