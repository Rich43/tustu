...
/* loaded from: rt.jar:com/sun/xml/internal/ws/api/streaming/ContextClassloaderLocal.class */
abstract class ContextClassloaderLocal<V> {
    ...
    private static ClassLoader getContextClassLoader() {
        return (ClassLoader) AccessController.doPrivileged(new PrivilegedAction() { // from class: com.sun.xml.internal.ws.api.streaming.ContextClassloaderLocal.1
