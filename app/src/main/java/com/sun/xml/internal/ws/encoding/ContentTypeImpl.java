...
/* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/ContentTypeImpl.class */
public final class ContentTypeImpl implements com.sun.xml.internal.ws.api.pipe.ContentType {
    ...
    private String getQuotedSOAPAction(String soapAction) {
        ...
        if (soapAction.charAt(0) != '\"' && soapAction.charAt(soapAction.length() - 1) != '\"') {
            return PdfOps.DOUBLE_QUOTE__TOKEN + soapAction + PdfOps.DOUBLE_QUOTE__TOKEN;
        }
        return soapAction;
    }
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/ContentTypeImpl$Builder.class */
