...
/* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/HeaderTokenizer.class */
class HeaderTokenizer {
    ...
    /* loaded from: rt.jar:com/sun/xml/internal/ws/encoding/HeaderTokenizer$Token.class */
    static class Token {
        private int type;
