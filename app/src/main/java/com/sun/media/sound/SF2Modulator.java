...
/* loaded from: rt.jar:com/sun/media/sound/SF2Modulator.class */
public final class SF2Modulator {
    ...
    public void setAmount(short s2) {
        this.amount = s2;
    }
    ...
    public void setAmountSourceOperator(int i2) {
        this.amountSourceOperator = i2;
    }
    ...
    public void setTransportOperator(int i2) {
        this.transportOperator = i2;
    }
    ...
    public void setDestinationOperator(int i2) {
        this.destinationOperator = i2;
    }
    ...
    public void setSourceOperator(int i2) {
        this.sourceOperator = i2;
    }
}
