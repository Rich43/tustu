...
/* loaded from: rt.jar:com/sun/media/sound/AuFileFormat.class */
final class AuFileFormat extends AudioFileFormat {
    ...
    AuFileFormat(AudioFileFormat audioFileFormat) {
        this(audioFileFormat.getType(), audioFileFormat.getByteLength(), audioFileFormat.getFormat(), audioFileFormat.getFrameLength());
    }

    AuFileFormat(AudioFileFormat.Type type, int i2, AudioFormat audioFormat, int i3) {
