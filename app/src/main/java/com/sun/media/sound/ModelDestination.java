...
/* loaded from: rt.jar:com/sun/media/sound/ModelDestination.class */
public final class ModelDestination {
    ...
    public static final ModelIdentifier DESTINATION_EG1_RELEASE = new ModelIdentifier("eg", BasicRootPaneUI.Actions.RELEASE, 0);
    ...
    public static final ModelIdentifier DESTINATION_EG2_RELEASE = new ModelIdentifier("eg", BasicRootPaneUI.Actions.RELEASE, 1);
    ...
    public static final ModelIdentifier DESTINATION_FILTER_Q = new ModelIdentifier("filter", PdfOps.q_TOKEN, 0);
    ...
    public ModelDestination(ModelIdentifier modelIdentifier) {
        this.destination = DESTINATION_NONE;
        this.transform = new ModelStandardTransform();
        this.destination = modelIdentifier;
    }
