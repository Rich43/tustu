...
/* loaded from: jfxrt.jar:com/sun/media/jfxmedia/MediaError.class */
public enum MediaError {
    ...
    ERROR_BASE_SYSTEM(StackType.VOID),
    ...
    ERROR_MASK_BASE(WalkerFactory.BITS_RESERVED),
