...
/* loaded from: sunjce_provider.jar:com/sun/crypto/provider/SunJCE.class */
public final class SunJCE extends Provider {
    ...
    /* loaded from: sunjce_provider.jar:com/sun/crypto/provider/SunJCE$SecureRandomHolder.class */
    ...
    public SunJCE() {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: com.sun.crypto.provider.SunJCE.1
            @Override // java.security.PrivilegedAction
            public Object run() {
                SunJCE.this.put("Cipher.RSA", "com.sun.crypto.provider.RSACipher");
                SunJCE.this.put("Cipher.RSA SupportedModes", "ECB");
                SunJCE.this.put("Cipher.RSA SupportedPaddings", "NOPADDING|PKCS1PADDING|OAEPPADDING|OAEPWITHMD5ANDMGF1PADDING|OAEPWITHSHA1ANDMGF1PADDING|OAEPWITHSHA-1ANDMGF1PADDING|OAEPWITHSHA-224ANDMGF1PADDING|OAEPWITHSHA-256ANDMGF1PADDING|OAEPWITHSHA-384ANDMGF1PADDING|OAEPWITHSHA-512ANDMGF1PADDING|OAEPWITHSHA-512/224ANDMGF1PADDING|OAEPWITHSHA-512/256ANDMGF1PADDING");
                ...
                SunJCE.this.put("Mac.HmacPBESHA1", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA1");
                SunJCE.this.put("Mac.HmacPBESHA224", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA224");
                SunJCE.this.put("Mac.HmacPBESHA256", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA256");
                SunJCE.this.put("Mac.HmacPBESHA384", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA384");
                SunJCE.this.put("Mac.HmacPBESHA512", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA512");
                SunJCE.this.put("Mac.HmacPBESHA512/224", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA512_224");
                SunJCE.this.put("Mac.HmacPBESHA512/256", "com.sun.crypto.provider.HmacPKCS12PBECore$HmacPKCS12PBE_SHA512_256");
                ...
                SunJCE.this.put("Mac.HmacPBESHA224 SupportedKeyFormats", "RAW");
                SunJCE.this.put("Mac.HmacPBESHA256 SupportedKeyFormats", "RAW");
                SunJCE.this.put("Mac.HmacPBESHA384 SupportedKeyFormats", "RAW");
                SunJCE.this.put("Mac.HmacPBESHA512 SupportedKeyFormats", "RAW");
                SunJCE.this.put("Mac.HmacPBESHA512/224 SupportedKeyFormats", "RAW");
                SunJCE.this.put("Mac.HmacPBESHA512/256 SupportedKeyFormats", "RAW");
