...
/* loaded from: gson-2.9.0.jar:com/google/gson/JsonPrimitive.class */
public final class JsonPrimitive extends JsonElement {
    ...
    public JsonPrimitive(Character c2) {
        this.value = ((Character) C$Gson$Preconditions.checkNotNull(c2)).toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.value instanceof Number) && (other.value instanceof Number)) {
            double a2 = getAsNumber().doubleValue();
