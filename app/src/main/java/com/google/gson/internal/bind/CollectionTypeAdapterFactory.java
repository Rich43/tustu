...
/* loaded from: gson-2.9.0.jar:com/google/gson/internal/bind/CollectionTypeAdapterFactory.class */
public final class CollectionTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) throws SecurityException {
    ...
    /* loaded from: gson-2.9.0.jar:com/google/gson/internal/bind/CollectionTypeAdapterFactory$Adapter.class */
