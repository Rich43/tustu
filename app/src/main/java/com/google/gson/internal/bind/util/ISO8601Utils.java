...
/* loaded from: gson-2.9.0.jar:com/google/gson/internal/bind/util/ISO8601Utils.class */
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean millis, TimeZone tz) {
        ...
        StringBuilder formatted = new StringBuilder(capacity + (millis ? ".sss".length() : 0) + (tz.getRawOffset() == 0 ? Constants.HASIDCALL_INDEX_SIG.length() : "+hh:mm".length()));
    ...
    */
    ...
    private static int parseInt(String value, int beginIndex, int endIndex) throws NumberFormatException {
        ...
        while (i2 < endIndex) {
            int i3 = i2;
            i2++;
            int digit2 = Character.digit(value.charAt(i3), 10);
            if (digit2 < 0) {
                throw new NumberFormatException("Invalid number: " + value.substring(beginIndex, endIndex));
            }
