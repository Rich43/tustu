...
/* loaded from: gson-2.9.0.jar:com/google/gson/internal/sql/SqlDateTypeAdapter.class */
final class SqlDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public Date read2(JsonReader in) throws IOException {
        ...
        try {
            ...
            throw new JsonSyntaxException("Failed parsing '" + s2 + "' as SQL Date; at path " + in.getPreviousPath(), e2);
        }
    }
