...
/* loaded from: gson-2.9.0.jar:com/google/gson/internal/Excluder.class */
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private boolean excludeClassChecks(Class<?> clazz) {
        ...
        if ((!this.serializeInnerClasses && isInnerClass(clazz)) || isAnonymousOrNonStaticLocal(clazz)) {
            return true;
        }
        return false;
    }
