...
@XmlType(name = "approveProposedTranslation", propOrder = {"userId", "password", "baseText", "baseLangCode", "targetLangCode"})
/* loaded from: efiaServicesClient.jar:com/efianalytics/translation/ApproveProposedTranslation.class */
public class ApproveProposedTranslation {
