...
@XmlType(name = "addUpdateProposedStaticTranslation", propOrder = {"userId", "password", "appId", "uid", "regKey", "baseLangCode", "targetLangCode", "baseText", "translatedText"})
/* loaded from: efiaServicesClient.jar:com/efianalytics/translation/AddUpdateProposedStaticTranslation.class */
public class AddUpdateProposedStaticTranslation {
