...
@XmlType(name = "getTranslationProposal", propOrder = {"userId", "password", "baseText", "baseLangCode", "targetLangCode"})
/* loaded from: efiaServicesClient.jar:com/efianalytics/translation/GetTranslationProposal.class */
public class GetTranslationProposal {
